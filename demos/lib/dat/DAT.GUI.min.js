 ...
 */
var DAT=DAT||{};
DAT.GUI=function(a){a==void 0&&(a={});var b=!1;a.height==void 0?a.height=300:b=!0;var c=[],d=[],m=!0,f,h,i=this,g=!0,e=280;if(a.width!=void 0)e=a.width;var q=!1,j,p,n=0,r;this.domElement=document.createElement("div");this.domElement.setAttribute("class","guidat");this.domElement.style.width=e+"px";var k=a.height,l=document.createElement("div");l.setAttribute("class","guidat-controllers");l.style.height=k+"px";l.addEventListener("DOMMouseScroll",function(a){var b=this.scrollTop;a.wheelDelta?b+=a.wheelDelta:
a.detail&&(b+=a.detail);a.preventDefault&&a.preventDefault();a.returnValue=!1;l.scrollTop=b},!1);var o=document.createElement("a");o.setAttribute("class","guidat-toggle");o.setAttribute("href","#");o.innerHTML=g?"Close Controls":"Open Controls";var t=!1,C=0,x=0,u=!1,v,y,w,z,D=function(a){y=v;z=w;v=a.pageY;w=a.pageX;a=v-y;if(!g)if(a>0)g=!0,k=j=1,o.innerHTML=p||"Close Controls";else return;var b=z-w;if(a>0&&k>h){var c=DAT.GUI.map(k,h,h+100,1,0);a*=c}t=!0;C+=a;j+=a;k+=a;l.style.height=j+"px";x+=b;e+=
b;e=DAT.GUI.constrain(e,240,500);i.domElement.style.width=e+"px";A()};o.addEventListener("mousedown",function(a){y=v=a.pageY;z=w=a.pageX;u=!0;a.preventDefault();C=x=0;document.addEventListener("mousemove",D,!1);return!1},!1);o.addEventListener("click",function(a){a.preventDefault();return!1},!1);document.addEventListener("mouseup",function(a){u&&!t&&i.toggle();if(u&&t)if(x==0&&B(),j>h)clearTimeout(r),j=n=h,s();else if(l.children.length>=1){var b=l.children[0].offsetHeight;clearTimeout(r);n=Math.round(k/
b)*b-1;n<=0?(i.close(),j=b*2):(j=n,s())}document.removeEventListener("mousemove",D,!1);a.preventDefault();return u=t=!1},!1);this.domElement.appendChild(l);this.domElement.appendChild(o);if(a.domElement)a.domElement.appendChild(this.domElement);else if(DAT.GUI.autoPlace){if(DAT.GUI.autoPlaceContainer==null)DAT.GUI.autoPlaceContainer=document.createElement("div"),DAT.GUI.autoPlaceContainer.setAttribute("id","guidat"),document.body.appendChild(DAT.GUI.autoPlaceContainer);DAT.GUI.autoPlaceContainer.appendChild(this.domElement)}this.autoListenIntervalTime=
1E3/60;var E=function(){f=setInterval(function(){i.listen()},this.autoListenIntervalTime)};this.__defineSetter__("autoListen",function(a){(m=a)?d.length>0&&E():clearInterval(f)});this.__defineGetter__("autoListen",function(){return m});this.listenTo=function(a){d.length==0&&E();d.push(a)};this.unlistenTo=function(a){for(var b=0;b<d.length;b++)d[b]==a&&d.splice(b,1);d.length<=0&&clearInterval(f)};this.listen=function(a){var a=a||d,b;for(b in a)a[b].updateSelect()||a[b].updateDisplay()};this.listenAll=
function(){this.listen(c)};this.autoListen=!0;var F=function(a,b){function c(){return a.apply(this,b)}c.prototype=a.prototype;return new c};this.add=function(){if(arguments.length==1){var a=[],d;for(d in arguments[0])a.push(i.add(arguments[0],d));return a}a=arguments[0];d=arguments[1];a:for(var e in c)if(c[e].object==a&&c[e].propertyName==d)break a;e=a[d];e==void 0&&a.get&&(e=a.get(d));if(e==void 0)DAT.GUI.error(a+" either has no property '"+d+"', or the property is inaccessible.");else if(a=typeof e,
e=G[a],e==void 0)DAT.GUI.error("Cannot create controller for data type '"+a+"'");else{for(var f=[this],g=0;g<arguments.length;g++)f.push(arguments[g]);if(e=F(e,f)){l.appendChild(e.domElement);c.push(e);DAT.GUI.allControllers.push(e);a!="function"&&DAT.GUI.saveIndex<DAT.GUI.savedValues.length&&(e.setValue(DAT.GUI.savedValues[DAT.GUI.saveIndex]),DAT.GUI.saveIndex++);A();q||(j=h);if(!b)try{if(arguments.callee.caller==window.onload)k=n=j=h,l.style.height=k+"px"}catch(m){}return e}else DAT.GUI.error("Error creating controller for '"+
d+"'.")}};var A=function(){h=0;for(var a in c)h+=c[a].domElement.offsetHeight;l.style.overflowY=h-1>j?"auto":"hidden"},G={number:DAT.GUI.ControllerNumber,string:DAT.GUI.ControllerString,"boolean":DAT.GUI.ControllerBoolean,"function":DAT.GUI.ControllerFunction};this.reset=function(){for(var a=0,b=DAT.GUI.allControllers.length;a<b;a++)DAT.GUI.allControllers[a].reset()};this.toggle=function(){g?this.close():this.open()};this.open=function(){o.innerHTML=p||"Close Controls";n=j;clearTimeout(r);s();B();
g=!0};this.close=function(){o.innerHTML=p||"Open Controls";n=0;clearTimeout(r);s();B();g=!1};this.name=function(a){p=a;o.innerHTML=a};this.appearanceVars=function(){return[g,e,j,l.scrollTop]};var s=function(){k=l.offsetHeight;k+=(n-k)*0.6;Math.abs(k-n)<1?k=n:r=setTimeout(s,1E3/30);l.style.height=Math.round(k)+"px";A()},B=function(){i.domElement.style.width=e-1+"px";setTimeout(function(){i.domElement.style.width=e+"px"},1)};if(DAT.GUI.guiIndex<DAT.GUI.savedAppearanceVars.length){e=parseInt(DAT.GUI.savedAppearanceVars[DAT.GUI.guiIndex][1]);
i.domElement.style.width=e+"px";j=parseInt(DAT.GUI.savedAppearanceVars[DAT.GUI.guiIndex][2]);q=!0;if(eval(DAT.GUI.savedAppearanceVars[DAT.GUI.guiIndex][0])==!0){var k=j,H=DAT.GUI.savedAppearanceVars[DAT.GUI.guiIndex][3];setTimeout(function(){l.scrollTop=H},0);if(DAT.GUI.scrollTop>-1)document.body.scrollTop=DAT.GUI.scrollTop;n=j;this.open()}DAT.GUI.guiIndex++}DAT.GUI.allGuis.push(this);if(DAT.GUI.allGuis.length==1&&(window.addEventListener("keyup",function(a){!DAT.GUI.supressHotKeys&&a.keyCode==72&&
DAT.GUI.toggleHide()},!1),DAT.GUI.inlineCSS))a=document.createElement("style"),a.setAttribute("type","text/css"),a.innerHTML=DAT.GUI.inlineCSS,document.head.insertBefore(a,document.head.firstChild)};DAT.GUI.hidden=!1;DAT.GUI.autoPlace=!0;DAT.GUI.autoPlaceContainer=null;DAT.GUI.allControllers=[];DAT.GUI.allGuis=[];DAT.GUI.supressHotKeys=!1;DAT.GUI.toggleHide=function(){DAT.GUI.hidden?DAT.GUI.open():DAT.GUI.close()};
...
DAT.GUI.load=function(a){var a=a.split(","),b=parseInt(a[0]);DAT.GUI.scrollTop=parseInt(a[1]);for(var c=0;c<b;c++){var d=a.splice(2,4);DAT.GUI.savedAppearanceVars.push(d)}DAT.GUI.savedValues=a.splice(2,a.length)};DAT.GUI.savedValues=[];DAT.GUI.savedAppearanceVars=[];
...
DAT.GUI.replaceGetVar=function(a,b){for(var c,d=window.location.href,m=window.location.href.slice(window.location.href.indexOf("?")+1).split("&"),f=0;f<m.length;f++)if(c=m[f].split("="),c!=void 0&&c[0]==a)return d.replace(c[1],b);if(window.location.href.indexOf("?")!=-1)return d+"&"+a+"="+b;return d+"?"+a+"="+b};DAT.GUI.saveIndex=0;DAT.GUI.guiIndex=0;DAT.GUI.showSaveString=function(){alert(DAT.GUI.getSaveString())};
...
DAT.GUI.Controller.prototype.setValue=function(a){if(this.object[this.propertyName]!=void 0)this.object[this.propertyName]=a;else{var b={};b[this.propertyName]=a;this.object.set(b)}this.changeFunction!=null&&this.changeFunction.call(this,a);this.updateSelect()||this.updateDisplay();return this};DAT.GUI.Controller.prototype.getValue=function(){var a=this.object[this.propertyName];a==void 0&&(a=this.object.get(this.propertyName));return a};DAT.GUI.Controller.prototype.updateDisplay=function(){};
DAT.GUI.Controller.prototype.updateSelect=function(){if(this.select)this.select.value=this.getValue();return this.select};DAT.GUI.Controller.prototype.onChange=function(a){this.changeFunction=a;return this};DAT.GUI.Controller.prototype.onFinishChange=function(a){this.finishChangeFunction=a;return this};
DAT.GUI.Controller.prototype.options=function(){var a,b,c=this;c.select=document.createElement("select");if(arguments.length==1){var d=arguments[0];for(a in d){b=document.createElement("option");b.innerHTML=a;b.setAttribute("value",d[a]);if(arguments[a]==this.getValue())b.selected=!0;c.select.appendChild(b)}}else for(a=0;a<arguments.length;a++){b=document.createElement("option");b.innerHTML=arguments[a];b.setAttribute("value",arguments[a]);if(arguments[a]==this.getValue())b.selected=!0;c.select.appendChild(b)}c.select.addEventListener("change",
function(){c.setValue(this.value);c.finishChangeFunction!=null&&c.finishChangeFunction.call(this,c.getValue())},!1);c.domElement.appendChild(c.select);return this};
...
DAT.GUI.ControllerNumber=function(){this.type="number";DAT.GUI.Controller.apply(this,arguments);var a=this,b=!1,c=!1,d=0,m=0,f=arguments[3],h=arguments[4],i=arguments[5];this.min=function(){var b=!1;f==void 0&&h!=void 0&&(b=!0);if(arguments.length==0)return f;else f=arguments[0];b&&(q(),i==void 0&&(i=(h-f)*0.01));return a};this.max=function(){var b=!1;f!=void 0&&h==void 0&&(b=!0);if(arguments.length==0)return h;else h=arguments[0];b&&(q(),i==void 0&&(i=(h-f)*0.01));return a};this.step=function(){if(arguments.length==
0)return i;else i=arguments[0];return a};this.getMin=function(){return f};this.getMax=function(){return h};this.getStep=function(){return i==void 0?h!=void 0&&f!=void 0?(h-f)/100:1:i};var g=document.createElement("input");g.setAttribute("id",this.propertyName);g.setAttribute("type","text");g.setAttribute("value",this.getValue());i&&g.setAttribute("step",i);this.domElement.appendChild(g);var e,q=function(){e=new DAT.GUI.ControllerNumberSlider(a,f,h,i,a.getValue());a.domElement.appendChild(e.domElement)};
f!=void 0&&h!=void 0&&q();g.addEventListener("blur",function(){var b=parseFloat(this.value);e&&DAT.GUI.removeClass(a.domElement,"active");isNaN(b)||a.setValue(b)},!1);g.addEventListener("mousewheel",function(b){b.preventDefault();a.setValue(a.getValue()+Math.abs(b.wheelDeltaY)/b.wheelDeltaY*a.getStep());return!1},!1);g.addEventListener("mousedown",function(a){m=d=a.pageY;DAT.GUI.makeSelectable(g);document.addEventListener("mousemove",p,!1);document.addEventListener("mouseup",j,!1)},!1);g.addEventListener("keydown",
function(b){switch(b.keyCode){case 13:b=parseFloat(this.value);a.setValue(b);break;case 38:b=a.getValue()+a.getStep();a.setValue(b);break;case 40:b=a.getValue()-a.getStep(),a.setValue(b)}},!1);var j=function(){document.removeEventListener("mousemove",p,!1);DAT.GUI.makeSelectable(g);a.finishChangeFunction!=null&&a.finishChangeFunction.call(this,a.getValue());c=b=!1;document.removeEventListener("mouseup",j,!1)},p=function(e){m=d;d=e.pageY;var f=m-d;!b&&!c&&(f==0?b=!0:c=!0);if(b)return!0;DAT.GUI.addClass(a.domElement,
...
DAT.GUI.ControllerNumberSlider=function(a,b,c,d,m){var f=!1,h=this;this.domElement=document.createElement("div");this.domElement.setAttribute("class","guidat-slider-bg");this.fg=document.createElement("div");this.fg.setAttribute("class","guidat-slider-fg");this.domElement.appendChild(this.fg);var i=function(b){if(f){var c;c=h.domElement;var d=0,g=0;if(c.offsetParent){do d+=c.offsetLeft,g+=c.offsetTop;while(c=c.offsetParent);c=[d,g]}else c=void 0;b=DAT.GUI.map(b.pageX,c[0],c[0]+h.domElement.offsetWidth,
a.getMin(),a.getMax());b=Math.round(b/a.getStep())*a.getStep();a.setValue(b)}};this.domElement.addEventListener("mousedown",function(b){f=!0;DAT.GUI.addClass(a.domElement,"active");i(b);document.addEventListener("mouseup",g,!1)},!1);var g=function(){DAT.GUI.removeClass(a.domElement,"active");f=!1;a.finishChangeFunction!=null&&a.finishChangeFunction.call(this,a.getValue());document.removeEventListener("mouseup",g,!1)};this.__defineSetter__("value",function(b){this.fg.style.width=DAT.GUI.map(b,a.getMin(),
a.getMax(),0,100)+"%"});document.addEventListener("mousemove",i,!1);this.value=m};
