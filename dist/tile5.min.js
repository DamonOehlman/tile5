...
(function(){function t(n){return n<10?"0"+n:n}function q(n){g.lastIndex=0;return g.test(n)?'"'+n.replace(g,function(e){var b=h[e];return typeof b==="string"?b:"\\u"+("0000"+e.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+n+'"'}function m(n,e){var b,k,o,r,s=d,p,u=e[n];if(u&&typeof u==="object"&&typeof u.toJSON==="function")u=u.toJSON(n);if(typeof l==="function")u=l.call(e,n,u);switch(typeof u){case "string":return q(u);case "number":return isFinite(u)?String(u):"null";case "boolean":case "null":return String(u);
case "object":if(!u)return"null";d+=f;p=[];if(Object.prototype.toString.apply(u)==="[object Array]"){r=u.length;for(b=0;b<r;b+=1)p[b]=m(b,u)||"null";o=p.length===0?"[]":d?"[\n"+d+p.join(",\n"+d)+"\n"+s+"]":"["+p.join(",")+"]";d=s;return o}if(l&&typeof l==="object"){r=l.length;for(b=0;b<r;b+=1){k=l[b];if(typeof k==="string")if(o=m(k,u))p.push(q(k)+(d?": ":":")+o)}}else for(k in u)if(Object.hasOwnProperty.call(u,k))if(o=m(k,u))p.push(q(k)+(d?": ":":")+o);o=p.length===0?"{}":d?"{\n"+d+p.join(",\n"+d)+
...
{"":n})};if(typeof JSON.parse!=="function")JSON.parse=function(n,e){function b(o,r){var s,p,u=o[r];if(u&&typeof u==="object")for(s in u)if(Object.hasOwnProperty.call(u,s)){p=b(u,s);if(p!==undefined)u[s]=p;else delete u[s]}return e.call(o,r,u)}var k;n=String(n);a.lastIndex=0;if(a.test(n))n=n.replace(a,function(o){return"\\u"+("0000"+o.charCodeAt(0).toString(16)).slice(-4)});if(/^[\],:{}\s]*$/.test(n.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
...
TILE5.Device=function(){function t(){for(;e.length>0;){var k=e.shift();document.location=k}n=0}function q(k){for(var o=true,r=b.length;r--;)o=o&&k!=b[r];return o}function m(k,o){var r=[];for(var s in o)s&&r.push(s+"="+escape(o[s]));return"tile5://"+k+"/"+(r.length>0?"?"+r.join("&"):"")}function a(k,o){q(k)&&GRUNT.Log.info("would push url: "+m(k,o))}function g(k,o){if(q(k)){e.push(m(k,o));n||(n=setTimeout(t,100))}}function d(){f={base:{name:"Unknown",eventTarget:document,supportsTouch:"createTouch"in
...
TILE5.Touch=function(){function t(e,b){var k=e&&e.length>0?e[0]:null;if(k&&b&&b.length>0)return TILE5.V.diff(k,b[0]);return null}function q(e){e.preventDefault();e.stopPropagation()}function m(e){for(var b=Array(e.length),k=e.length;k--;)b[k]=new TILE5.Vector(e[k].pageX,e[k].pageY);return b}function a(e){return[new TILE5.Vector(e.pageX,e.pageY)]}var g={TAP:0,MOVE:1,PINCHZOOM:2},d=7,f=0,h=0,l={TouchHelper:function(e){function b(z){for(var E=[],M=e.element?-e.element.offsetLeft:0,T=e.element?-e.element.offsetTop:
0,K=z.length;K--;)E.push(TILE5.V.offset(z[K],M,T));return E}function k(){e.observable&&e.observable.trigger.apply(null,arguments)}function o(z){if(z.target&&z.target===e.element){x=w?m(z.touches):a(z);C=new TILE5.Vector;G=new TILE5.Vector;Q=true;u=false;w&&q(z);L.current=TILE5.Clock.getTime();if(z=x.length>0?x[0]:null){k("touchStart",z.x,z.y);if(L.current-L.last<P.THRESHOLD_DOUBLETAP)if((z=B?TILE5.V.diff(x[0],B[0]):null)&&Math.abs(z.x)<e.maxDistDoubleTap&&Math.abs(z.y)<e.maxDistDoubleTap)u=true;J=
g.TAP;B=[].concat(x)}else GRUNT.Log.warn("Touch start fired, but no touch vector found")}}function r(z){if(z.target&&z.target===e.element){w||(R=a(z)[0]);if(Q)try{w&&q(z);var E=w?m(z.touches):a(z);z=0;if(E.length>1){if(x.length===1)x=[].concat(E);z=TILE5.V.distance(x)-TILE5.V.distance(B)}if(J===g.TAP){var M=t(E,x);if(M&&(Math.abs(M.x)>=d||Math.abs(M.y)>=d))J=g.MOVE}if(J!==g.TAP)if(!z||Math.abs(z)<e.pinchZoomThreshold){if(C=t(E,B)){G.x-=C.x;G.y-=C.y;D.x-=C.x;D.y-=C.y}if(TILE5.V.absSize(D)>e.panEventThreshhold){k("move",
...
b(x),b(B))}catch(E){GRUNT.Log.exception(E)}Q=false}function p(z){z=new TILE5.Vector(z.wheelDeltaX,z.wheelDeltaY);var E=z.y!==0?Math.max(Math.abs(z.y/360),1):0;if(R&&E!==0){var M=TILE5.V.offset(R,-e.element.offsetLeft,-e.element.offsetTop);k("wheelZoom",M,z.y>0?E+0.5:0.5/E)}}e=GRUNT.extend({element:null,observable:null,inertiaTrigger:20,maxDistDoubleTap:20,panEventThreshhold:0,pinchZoomThreshold:5,touchStartHandler:null,moveHandler:null,moveEndHandler:null,pinchZoomHandler:null,pinchZoomEndHandler:null,
tapHandler:null,doubleTapHandler:null,wheelZoomHandler:null},e);var u=false,v=0,w=TILE5.Device.getConfig().supportsTouch,x=null,B=null,C=null,G=null,D=new TILE5.Vector,J=null,Q=false,N=[],R=null,L={current:0,last:0},I=TILE5.Device.getConfig(),P={supportsTouch:w,THRESHOLD_DOUBLETAP:300,addListeners:function(z){N.push(z)},decoupleListeners:function(z){for(var E=0;z&&E<N.length;E++)if(N[E].listenerId===z){N.splice(E,1);GRUNT.Log.info("successfully decoupled touch listener: "+z);break}},release:function(){I.eventTarget.removeEventListener(I.supportsTouch?
"touchstart":"mousedown",o,false);I.eventTarget.removeEventListener(I.supportsTouch?"touchmove":"mousemove",r,false);I.eventTarget.removeEventListener(I.supportsTouch?"touchend":"mouseup",s,false);I.supportsTouch||I.eventTarget.removeEventListener("mousewheel",p,false)}};I.eventTarget.addEventListener(I.supportsTouch?"touchstart":"mousedown",o,false);I.eventTarget.addEventListener(I.supportsTouch?"touchmove":"mousemove",r,false);I.eventTarget.addEventListener(I.supportsTouch?"touchend":"mouseup",
s,false);I.supportsTouch||I.eventTarget.addEventListener("mousewheel",p,false);return P}},n=[];return{captureTouch:function(e,b){try{if(!e)throw Error("Unable to capture touch of null element");if(!e.id)e.id="touchable_"+f++;var k=n[e.id];if(!k){k=l.TouchHelper(GRUNT.extend({element:e},b));n[e.id]=k;GRUNT.Log.info("CREATED TOUCH HELPER. SUPPORTS TOUCH = "+k.supportsTouch)}b.listenerId&&k.decoupleListeners(b.listenerId);b.listenerId=++h;k.addListeners(b)}catch(o){GRUNT.Log.exception(o)}},resetTouch:function(e){if(e&&
...
var F=TILE5.D.getSize(M.dimensions),O=TILE5.D.getSize(T.dimensions);X=TILE5.R.getCenter(M);D=TILE5.R.getCenter(T);K=M&&F!==0?O/F:1}function d(y){GRUNT.WaterCooler.say("view.scale",{id:H.id});E=false;H.trigger("scale",K,D,y);U=m.DisplayState.ACTIVE;K=1;e()}function f(y,A){A.setId(y);A.setParent(H);b.push(A);b.sort(function(F,O){var S=O.zindex-F.zindex;if(S===0)S=O.created-F.created;return S})}function h(){GRUNT.WaterCooler.say("view.idle",{id:H.id});J=true;N=0}function l(y,A){var F=0,O=H.getDisplayState(),
S=(new Date).getTime(),W=(O&t.PINCHZOOM)!==0,V=0;if(s||W){y.clearRect(0,0,k.width,k.height);s=false}if(W){TILE5.D.getCenter(x);var aa=(Y?Y:1)/2,Z=TILE5.V.diff(X,D);if(L=M?new TILE5.Vector(D.x+Z.x,D.y+Z.y):new TILE5.Vector(D.x-Z.x*aa,D.y-Z.y*aa))A=TILE5.V.offset(A,L.x,L.y)}y.save();try{if(w!==1)y.scale(w,w);else if(W){y.translate(D.x,D.y);y.scale(K,K)}for(V=b.length;V--;)if(b[V].shouldDraw(O)){var ba=b[V].draw(y,A,x,O,H);F+=ba?ba:0}}finally{y.restore()}GRUNT.Log.trace("draw complete",S);return F}function n(){var y=
0,A=U===t.PINCHZOOM||U===t.PAN;I=(new Date).getTime();r.x=Math.floor(r.x);r.y=Math.floor(r.y);G&&p&&G.delays.push(I-p);if(A){TILE5.Animation.cancel(function(O){return O.cancelOnInteract});J=false;if(N!==0){clearTimeout(N);N=0}}for(A=b.length;A--;){var F=b[A].cycle(I,r,U);y+=F?F:0}if(p+z<I){y+=l(o,r);p=I}Q=0;if(C+y>0)e();else if(!J&&N===0)N=setTimeout(h,500);GRUNT.Log.trace("Completed draw cycle",I)}function e(){C++;if(!(v||Q!==0)){C=0;Q=setTimeout(n,0)}}a=GRUNT.extend({id:"view_"+q++,container:"",
clearOnDraw:false,displayFPS:false,displayResourceStats:false,scaleDamping:false,fastDraw:false,fillStyle:"rgb(200, 200, 200)",initialDrawMode:"source-over",bufferRefresh:100,defaultFreezeDelay:500,autoSize:false},a);var b=[],k=document.getElementById(a.container),o=null,r=new TILE5.Vector,s=false,p=null,u=0,v=false,w=1,x=null,B=null,C=0,G=null,D=null,J=false,Q=0,N=0,R=0,L=null,I=0,P=TILE5.Device.getConfig().targetFps,z=0,E=false,M=null,T=null,K=1,Y=null,$=null,X=null,U=m.DisplayState.ACTIVE;GRUNT.Log.info("Creating a new view instance, attached to container: "+
a.container+", canvas = ",k);if(k){TILE5.Touch.resetTouch(k);if(a.autoSize){GRUNT.Log.info("autosizing view: window.height = "+window.innerHeight+", width = "+window.innerWidth);k.height=window.innerHeight-k.offsetTop;k.width=window.innerWidth-k.offsetLeft}try{o=k.getContext("2d");o.globalCompositeOperation=a.initialDrawMode;o.clearRect(0,0,k.width,k.height)}catch(ca){GRUNT.Log.exception(ca);throw Error("Could not initialise canvas on specified view element");}}var H=GRUNT.extend({},a,new GRUNT.Observable,
{id:a.id,deviceScaling:w,fastDraw:a.fastDraw||TILE5.Device.getConfig().requireFastDraw,animate:function(y,A,F,O,S){function W(){S&&S();d();K=1;Y=null}E=true;X=TILE5.V.copy(A);D=TILE5.V.copy(F);M=null;if(O){$=K;TILE5.Animation.tweenValue(0,y-$,O,W,1E3).requestUpdates(function(V){Y=V/(y-$);K=$+V;U=m.DisplayState.PINCHZOOM;e();H.trigger("animate")})}else{K=y;W()}},centerOn:function(y){H.setOffset(y.x-k.width/2,y.y-k.height/2)},getDimensions:function(){if(k)return new TILE5.Dimensions(k.width,k.height)},
...
A,F,O,S){O||(O=TILE5.D.getCenter(x));S||(S=TILE5.D.getCenter(x));H.animate(y,O,S,A,F);return H},removeLayer:function(y){a:{for(var A=b.length;A--;)if(b[A].getId()==y){y=A;break a}y=-1}if(y>=0&&y<b.length){GRUNT.WaterCooler.say("layer.removed",{layer:b[y]});b.splice(y,1)}},getOffset:function(){return TILE5.V.copy(r)},setOffset:function(y,A){r.x=y;r.y=A},updateOffset:function(y,A,F){if(F){y=new TILE5.Vector(y,A);animating=true;F=TILE5.Animation.tweenVector(r,y.x,y.y,F,function(){animating=false;H.panEnd(0,
0)});for(y=F.length;y--;){F[y].cancelOnInteract=true;F[y].requestUpdates(function(){a.onAnimate&&a.onAnimate(r.x,r.y)})}}else H.setOffset(y,A)},zoom:function(y,A){K=y;E=K!==1;X=TILE5.D.getCenter(H.getDimensions());D=TILE5.D.getCenter(H.getDimensions());M=null;clearTimeout(R);if(E){u=TILE5.Clock.getTime(true);U=m.DisplayState.PINCHZOOM;e();if(A)R=setTimeout(d,parseInt(A,10))}}});x=H.getDimensions();B=TILE5.D.getCenter(x);if(P)z=Math.ceil(1E3/P);GRUNT.Log.info("redraw interval calaculated @ "+z);GRUNT.WaterCooler.listen("layer.remove",
function(y){y.id&&H.removeLayer(y.id)});GRUNT.WaterCooler.listen("view.wake",function(y){if(!y.id||y.id===H.id)e()});w=TILE5.Device.getConfig().getScaling();if(a.displayFPS){G=new m.FPSLayer;H.setLayer("fps",G)}a.displayResourceStats&&H.setLayer("resourceStats",new m.ResourceStatsLayer);TILE5.Touch.captureTouch(k,{observable:H});H.bind("move",function(y,A,F){H.updateOffset(r.x+y,r.y+A,F);u=TILE5.Clock.getTime(true);e();U=t.PAN});H.bind("moveEnd",function(){U=t.ACTIVE;setTimeout(e,50)});H.bind("pinchZoom",
function(y,A){g(y,A);if(E=K!==1){u=TILE5.Clock.getTime(true);U=m.DisplayState.PINCHZOOM;e()}});H.bind("pinchZoomEnd",function(y,A){g(y,A);d(true);K=1});H.bind("wheelZoom",function(y,A){H.zoom(Math.min(Math.max(A,0.25),4),500)});e();return H}};return m}();
...
n)},getTileShift:function(){return TILE5.V.copy(n)},getTile:function(k,o){return k>=0&&k<d.gridSize?f[o*d.gridSize+k]:null},setTile:function(k,o,r){f[o*d.gridSize+k]=r},populate:function(k,o){var r=GRUNT.Log.getTraceTicks(),s=0,p=d.gridSize,u=d.tileSize;new TILE5.Vector(p/2,p/2);if(k)for(var v=0;v<p;v++)for(var w=0;w<p;w++){if(!f[s]){var x=k(w,v,h,p);x.gridX=w*u-n.x;x.gridY=v*u-n.y;f[s]=x}s++}l=k;e=o;GRUNT.Log.trace("tile grid populated",r);d.onPopulate&&d.onPopulate()},getShiftDelta:function(k,o,
r,s){var p=Math.floor(d.gridSize*0.2),u=new TILE5.Vector;if(k<0||k+r>d.gridSize)u.x=k<0?-p:p;if(o<0||o+s>d.gridSize)u.y=o<0?-p:p;return u},shift:function(k,o){if(!(k.x===0&&k.y===0)){var r=GRUNT.Log.getTraceTicks();GRUNT.Log.info("need to shift tile store grid, "+k.x+" cols and "+k.y+" rows.");var s=Array(f.length);s.length=f.length;for(var p=0;p<d.gridSize;p++)for(var u=0;u<d.gridSize;u++)s[u*d.gridSize+p]=b.getTile(p+k.x,u+k.y);f=s;h=o?o(h,k):TILE5.V.add(h,k);n.x+=-k.x*d.tileSize;n.y+=-k.y*d.tileSize;
GRUNT.Log.trace("tile storage shifted",r);b.populate(l,e)}},setOrigin:function(k,o){if(tileOrigin)shiftOrigin(k,o);else h=TILE5.V.offset(new TILE5.Vector(k,o),-tileHalfWidth)}};GRUNT.WaterCooler.listen("imagecache.cleared",function(){for(var k=f.length;k--;)if(f[k])f[k].loaded=false});GRUNT.WaterCooler.listen("tiler.repaint",function(){for(var k=f.length;k--;)if(f[k]){f[k].x=null;f[k].y=null}});return b};var m=null,a=null,g={Config:{TILESIZE:256,TILEBUFFER:1,TILEBUFFER_LOADNEW:0.2},Tile:function(d){return d=
GRUNT.extend({x:0,y:0,gridX:0,gridY:0,size:256},d)},ImageTile:function(d){d=GRUNT.extend({url:"",sessionParamRegex:null,loaded:false},d);return new g.Tile(d)},TileGrid:function(d){function f(C,G){if(x){var D,J=[],Q=new TILE5.Vector(Math.floor((C.x+p.x)*n),Math.floor((C.y+p.y)*n));tilesNeeded=false;for(var N=w;N--;)for(var R=v;R--;){D=h.getTile(R+Q.x,N+Q.y);var L=new TILE5.Vector(R-x.x,N-x.y);D||(s=h.getShiftDelta(Q.x,Q.y,v,w));J.push({tile:D,centerness:TILE5.V.absSize(L)})}J.sort(function(I,P){return P.centerness-
I.centerness});k||(k=Array(J.length));for(D=J.length;D--;){k[D]=J[D].tile;B.prepTile(k[D],G)}}}d=GRUNT.extend({tileSize:TILE5.Tiling.Config.TILESIZE,drawGrid:false,center:new TILE5.Vector,shiftOrigin:null,supportFastDraw:true},d);var h=new TileStore(GRUNT.extend({tileSize:d.tileSize,onPopulate:function(){e=true;B.wakeParent()}},d)),l=Math.round(d.tileSize/2),n=d.tileSize?1/d.tileSize:0,e=false,b=true,k=null,o=false,r=false;new TILE5.Vector;var s=new TILE5.Vector,p=new TILE5.Vector;TILE5.Device.getConfig();
var u=h.getGridSize()*d.tileSize,v,w,x,B=GRUNT.extend(new TILE5.Graphics.ViewLayer(d),{gridDimensions:new TILE5.Dimensions(u,u),cycle:function(C,G,D){C=0;if(s.x+s.y!==0){h.shift(s,d.shiftOrigin);p=h.getTileShift();s=new TILE5.Vector;C++}D!==TILE5.Graphics.DisplayState.PINCHZOOM&&f(G,D);return C+e?1:0},deactivate:function(){b=false},prepTile:function(){},drawTile:function(){return false},draw:function(C,G,D,J,Q){if(b){var N=(new Date).getTime(),R=G.x;G=G.y;var L=true,I=o||J===TILE5.Graphics.DisplayState.PINCHZOOM||
TILE5.Animation.isTweening();if(!x){v=Math.ceil(D.width*n)+1;w=Math.ceil(D.height*n)+1;x=new TILE5.Vector(Math.floor((v-1)/2),Math.floor((w-1)/2))}if(k){if(d.drawGrid)C.strokeStyle="rgba(50, 50, 50, 0.3)";C.beginPath();for(D=k.length;D--;){var P=k[D];if(P){var z=P.gridX-R,E=P.gridY-G;L=((I?false:P.x===z&&P.y===E)?true:B.drawTile(C,P,z,E,J))&&L}else L=false;d.drawGrid&&C.rect(z,E,d.tileSize,d.tileSize)}C.stroke();GRUNT.Log.trace("drawn tiles",N);L&&!r&&Q.trigger("tileDrawComplete");r=L;o=e=false}}},
getTileVirtualXY:function(C,G,D){C=h.getNormalizedPos(C,G);C=new TILE5.Vector(C.x*d.tileSize,C.y*d.tileSize);if(D){C.x+=l;C.y+=l}return C},populate:function(C){h.populate(C,function(){})}});GRUNT.WaterCooler.listen("tile.loaded",function(){e=true;B.wakeParent()});GRUNT.WaterCooler.listen("grid.invalidate",function(){o=true});return B},ImageTileGrid:function(d){function f(){GRUNT.WaterCooler.say("tile.loaded")}d=GRUNT.extend({},d);var h=t(),l=q(),n=TILE5.Graphics.DisplayState.ACTIVE,e=TILE5.Graphics.DisplayState.PAN,
b=TILE5.Device.getConfig().requireFastDraw;return GRUNT.extend(new g.TileGrid(d),{drawTile:function(k,o,r,s,p){var u=TILE5.Resources.getImage(o.url),v=false;if(u&&u.complete&&u.width>0){k.drawImage(u,r,s);v=true;o.x=r;o.y=s}else p===e?k.drawImage(l,r,s):k.drawImage(h,r,s);return v},prepTile:function(k,o){if(k&&(!b||o===n))TILE5.Resources.getImage(k.url)||TILE5.Resources.loadImage(k.url,f)}})},Tiler:function(d){d=GRUNT.extend({container:"",drawCenter:false,datasources:{},tileLoadThreshold:"first"},
...
return f}};return g}();
TILE5.Geo=function(){function t(n,e){var b=null;for(var k in h)if(e){if(k==e&&h[k][n]){b=h[k];break}}else if(h[k][n]){b=h[k];break}return b}function q(n,e,b,k){var o=0;n=n.toUpperCase();for(var r in k){var s=e[r];if(s){var p=b[r];s=p?p(n,s):n.containsWord(s)?1:0;o+=s*k[r]}}return o}var m=[1.406245461070741,1.321415085624082,1.077179995861952,0.703119412486786,0.488332580888611],a=Math.PI/180,g=180/Math.PI,d=null,f={RD:"ROAD",ST:"STREET",CR:"CRESCENT",CRES:"CRESCENT",CT:"COURT",LN:"LANE",HWY:"HIGHWAY",
...
-e*b),o=n.mercatorUnproject(k),r=n.findRadPhi(o,k),s=0;s<12&&Math.abs(o-r)>1.0E-7;){o=r;r=n.findRadPhi(o,k);s++}return r*180/Math.PI},mercatorUnproject:function(e){return Math.PI/2-2*Math.atan(e)},findRadPhi:function(e,b){var k=0.08181919084262157*Math.sin(e);return Math.PI/2-2*Math.atan(b*Math.pow((1-k)/(1+k),0.040909595421310785))},normalizeLon:function(e){for(;e<-180;)e+=360;for(;e>180;)e-=360;return e}};return n}(),GeoSearchResult:function(n){n=GRUNT.extend({id:null,caption:"",resultType:"",data:null,
pos:null,matchWeight:0},n);return GRUNT.extend(n,{toString:function(){return n.caption+(n.matchWeight?" ("+n.matchWeight+")":"")}})},GeoSearchAgent:function(n){return TILE5.Dispatcher.createAgent(n)},GeocodingAgent:function(n){n=GRUNT.extend({name:"Geocoding Search Agent",paramTranslator:null,execute:function(e,b){try{if(!e.reverse&&!e.freeform)address=new l.Address(e);var k=l.getEngine("geocode");if(k)k.geocode({addresses:[e.freeform?e.freeform:address],complete:function(r,s){if(b){var p=s;if(e.freeform)p=
...
[];for(var v in o)for(var w=0;w<o[v].length;w++)if(!p||p(o[v][w]))u.push(o[v][w]);return u}function k(){GRUNT.WaterCooler.say("geo.pois-updated",{srcID:s.id,pois:s.getPOIs()})}n=GRUNT.extend({visibilityChange:null,onPOIDeleted:null,onPOIAdded:null},n);var o={},r=true,s={id:GRUNT.generateObjectID(),getPOIs:function(){return b()},getOldPOIs:function(p,u){return b(function(v){return v.group==p&&v.retrieved<u})},getVisible:function(){return r},setVisible:function(p){if(p!=r){r=p;n.visibilityChange&&n.visibilityChange()}},
...
G=0;G<C.length;G++)if(C[G].id==B.id){B=C[G];break a}B=null}if(B){B.retrieved=x;B.isNew=false}else u.push(p[v])}p=s.getOldPOIs(w,x);s.addPOIs(u);for(v=0;n.onPOIAdded&&v<u.length;v++)n.onPOIAdded(u[v]);for(v=0;v<p.length;v++){n.onPOIDeleted&&n.onPOIDeleted(p[v]);w=p[v];x=e(w.group);for(B=0;B<x.length;B++)if(x[B].id==w.id){x.splice(B,1);break}}u.length+p.length>0&&k()}};return s},MapProvider:function(){return{zoomLevel:0,checkZoomLevel:function(n){return n},getCopyright:function(){},getLogoUrl:function(){},
...
-(Math.PI/2),e=Math.PI/2,b=-Math.PI*2,k=Math.PI*2,o={calcSize:function(r,s,p){var u=new TILE5.Vector(0,s.lat-r.lat);if(typeof p==="undefined")p=true;u.x=p&&r.lon>s.lon?360-r.lon+s.lon:s.lon-r.lon;return u},createBoundsFromCenter:function(r,s){var p=s/6371,u=r.lat*a,v=r.lon*a,w=u-p,x=u+p;if(w>n&&x<e){u=Math.asin(Math.sin(p)/Math.cos(u));p=v-u;if(p<b)p+=2*Math.PI;v=v+u;if(v>k)v-=2*Math.PI}else{w=Math.max(w,n);x=Math.min(x,e);p=b;v=k}return new l.BoundingBox(new l.Position(w*g,p*g),new l.Position(x*
g,v*g))},expand:function(r,s){return new l.BoundingBox(new l.Position(r.min.lat-s,r.min.lon-l.Utilities.normalizeLon(s)),new l.Position(r.max.lat+s,r.max.lon+l.Utilities.normalizeLon(s)))},forPositions:function(r,s){var p=null,u=TILE5.Clock.getTime();s||(s="auto");for(var v=r.length;v--;)if(p){var w=o.calcSize(p.min,r[v],false),x=o.calcSize(r[v],p.max,false);if(w.x<0)p.min.lon=r[v].lon;if(w.y<0)p.min.lat=r[v].lat;if(x.x<0)p.max.lon=r[v].lon;if(x.y<0)p.max.lat=r[v].lat}else p=new TILE5.Geo.BoundingBox(r[v],
r[v]);if(s){if(s=="auto"){v=o.calcSize(p.min,p.max);s=Math.max(v.x,v.y)*0.3}p=o.expand(p,s)}GRUNT.Log.trace("calculated bounds for "+r.length+" positions",u);return p},getCenter:function(r){var s=l.B.calcSize(r.min,r.max);return new TILE5.Geo.Position(r.min.lat+s.y/2,r.min.lon+s.x/2)},getGeoHash:function(r){var s=TILE5.Geo.GeoHash.encode(r.min.lat,r.min.lon);r=TILE5.Geo.GeoHash.encode(r.max.lat,r.max.lon);GRUNT.Log.info("min hash = "+s+", max hash = "+r)},getZoomLevel:function(r,s){var p=o.getCenter(r),
u=m[Math.min(Math.round(Math.abs(p.lat)*0.05),m.length)],v=o.calcSize(r.min,r.max);p=Math.ceil(Math.log(m[3]*s.height/v.y)/Math.log(2));u=Math.ceil(Math.log(u*s.width/v.x)/Math.log(2));return Math.min(isNaN(p)?1E3:p,isNaN(u)?1E3:u)},isEmpty:function(r){return!r||l.P.empty(r.min)||l.P.empty(r.max)},toString:function(r){return"min: "+l.P.toString(r.min)+", max: "+l.P.toString(r.max)}};return o}(),A:function(){var n=/^(\d+).*$/,e=/(\d+)\s?\-\s?(\d+)/;return{buildingMatch:function(b,k){n.lastIndex=-1;
if(n.test(b))for(var o=b.replace(n,"$1"),r=k.split(","),s=0;s<r.length;s++){e.lastIndex=-1;if(e.test(r[s])){var p=e.exec(r[s]);if(o>=parseInt(p[1],10)&&o<=parseInt(p[2],10))return true}else if(o==r[s])return true}return false},normalize:function(b){if(!b)return"";b=b.toUpperCase();if(!d){var k=[];for(var o in f)k.push(o);d=RegExp("(\\s)("+k.join("|")+")(\\s|$)","i")}d.lastIndex=-1;if(k=d.exec(b))b=b.replace(d,"$1"+f[k[2]]);return b},toString:function(b){return b.streetDetails+" "+b.location}}}(),
getEngine:function(n){for(var e=null,b=1;!e&&b<arguments.length;b++)e=t(n,arguments[b]);e=e?e:t(n);if(!e)throw Error("Unable to find GEO engine with "+n+" capability");return e},rankGeocodeResponses:function(n,e,b){var k=[],o=l.AddressCompareFns;if(b&&b.compareFns)o=GRUNT.extend({},o,b.compareFns);for(b=0;b<e.length;b++)k.push(new l.GeoSearchResult({caption:l.A.toString(e[b]),data:e[b],pos:e[b].pos,matchWeight:q(n,e[b],o,l.GeocodeFieldWeights)}));k.sort(function(r,s){return s.matchWeight-r.matchWeight});
return k}};return l}();
...
a);var g=new TILE5.Vector,d=false,f=[],h=0,l=null,n=null,e=a.zoomLevel;if(!a.provider)a.provider=new TILE5.Geo.MapProvider;var b=GRUNT.extend({},new TILE5.Tiling.Tiler(a),{pois:a.pois,annotations:null,getBoundingBox:function(){var o=b.getTileLayer(),r=b.getOffset(),s=b.getDimensions();if(o)return o.getBoundingBox(r.x,r.y,s.width,s.height);return null},getCenterPosition:function(){return b.getXYPosition(TILE5.D.getCenter(b.gridDimensions))},getXYPosition:function(o){return b.getTileLayer().pixelsToPos(b.viewPixToGridPix(o))},
...
a.tapExtent,-a.tapExtent));GRUNT.Log.info("grid tapped @ "+TILE5.Geo.P.toString(s.pixelsToPos(p)));p=new TILE5.Geo.BoundingBox(v,w);f=b.pois.findByBounds(p);b.trigger("geotap",o,r,u,p);a.tapPOI&&a.tapPOI(f)}});b.bind("doubleTap",function(o,r){b.animate(2,TILE5.D.getCenter(b.getDimensions()),new TILE5.Vector(r.x,r.y),a.zoomAnimation)});b.bind("scale",function(o,r){var s=0;o=Math.sqrt(o);if(o<1)s=-(0.5/o);else if(o>1)s=o;b.gotoPosition(b.getXYPosition(r),e+Math.floor(s))});var k=new TILE5.Geo.UI.AnnotationsOverlay({pois:b.pois,
