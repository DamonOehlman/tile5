...
0,h=arguments.length;h--;){var e=yb[arguments[h].toUpperCase()];if(e)a|=e}return a}function s(a){a=a?a:(new Date).getTime();if(a-mb>zb){for(var h=eb.splice(0),e=h.length;e--;)h[e](a);mb=a}eb.length&&animFrame(s)}function C(a){var h=eb.length==0;eb[eb.length]=a;h&&animFrame(s)}function U(a,h,e,c,f){f=COG.extend({easing:"sine.out",duration:1E3,progress:null,complete:null,autoInvalidate:true},f);var m=(new Date).getTime(),v=a[h],G=h=="translate",A=f.autoInvalidate,q=e.length&&c.length&&e.length==c.length?
e.length:0,Q=Array(q),S=Array(q),$=COG.easing(f.easing),aa=f.duration,La=f.progress,Ta=function(Ga){var J=Ga-m;Ga=m+aa<=Ga;for(var R=a.layer?a.layer.view:null,ha,ba=q;ba--;){ha=$(J,e[ba],Q[ba],aa);S[ba]=G?ha|0:ha}v.apply(a,S);if(A&&R)R.redraw=true;if(La){J=[].concat(Ga?c:S);J.unshift(Ga);La.apply(a,J)}if(Ga){a.animations--;v.apply(a,c);f.complete&&f.complete.apply(a,c)}else C(Ta)};if(v&&v.apply&&q>0){aa=aa?aa:DEFAULT_DURATION;for(h=q;h--;)Q[h]=c[h]-e[h];a.animations++;C(Ta)}}function n(a,h){var e,
c;if(h&&h.width>0){if(!a.imageOffset)a.imageOffset=Y.init(-h.width>>1,-h.height>>1);if(!a.bounds){e=a.xy.x+a.imageOffset.x;c=a.xy.y+a.imageOffset.y;a.bounds=Ka.init(e,c,e+h.width,c+h.height)}}}function E(a){Pa.call(this,a)}function x(a,h){h=COG.extend({simplify:false,typeName:"Poly"},h);var e=h.simplify;Pa.call(this,h);COG.extend(this,{resync:function(c){var f,m,v,G,A,q;c.syncXY(a);q=this.points=Y.floor(e?Y.simplify(a):a);for(var Q=q.length;Q--;){c=q[Q].x;f=q[Q].y;G=y(G,L)||c<G?c:G;A=y(A,L)||f<A?
f:A;m=y(m,L)||c>m?c:m;v=y(v,L)||f>v?f:v}this.updateBounds(Ka.init(G,A,m,v),true)}});this.haveData=a&&a.length>=2}function I(a,h){h.fill=false;x.call(this,a,h)}function t(a){function h(A){(this.imageUrl=A)&&nb(this.imageUrl,function(q,Q){v=q;if(Q){var S=G.layer?G.layer.view:null;if(S)S.redraw=true}})}a=COG.extend({image:null,imageUrl:null,imageOffset:null,typeName:"Image"},a);var e=null,c=Pa.prototype.updateBounds,f=0,m=0,v=a.image;Pa.call(this,a);var G=COG.extend(this,{changeImage:h,drag:function(A,
q,Q,S){e||(e=Y.init(A.startX-this.xy.x,A.startY-this.xy.y));this.xy.x=q-e.x;this.xy.y=Q-e.y;if(S){e=null;if(this.layer)(A=this.layer.view)&&A.syncXY([this.xy],true);this.trigger("dragDrop")}return true},getProps:function(){this.bounds||n(this,v);return{image:v,x:this.xy.x+f,y:this.xy.y+m}},updateBounds:function(A,q){c.call(this,A,q);n(this,v)}});v||h(this.imageUrl);if(this.imageOffset){f=this.imageOffset.x;m=this.imageOffset.y}}function u(a){a=COG.extend({imageAnchor:null},a);if(a.imageAnchor)a.imageOffset=
...
T)||q.drawImage(ba,R,ha)})}function m(J,R,ha){var ba=false;if(J)ba=q.isPointInPath(La?J.x-S:J.relXY.x,La?J.y-$:J.relXY.y);return{draw:ha||Ga,state:R,hit:ba,vpX:S,vpY:$,context:q}}e=COG.extend({},e);var v,G,A,q,Q,S=0,$=0,aa=null,La=CANI.canvas.pipTransformed,Ta={},Ga=function(){this.fill&&q.fill();this.stroke&&q.stroke()};(function(){if(h){var J=h.tagName=="CANVAS",R=J?h.parentNode:h;v=a.width=R.offsetWidth;G=a.height=R.offsetHeight;if(J){A=h;A.width=v;A.height=G;Ia&&FlashCanvas.initElement(A)}else{A=
Cb(v,G);A.style.cssText="position: absolute; z-index: 1;";h.appendChild(A)}q=null}})();return COG.extend(c,{interactTarget:A,applyStyle:function(J){var R=Eb(J),ha=R&&q&&q.canvas?Ta[q.canvas.id]:null;if(R){Ta[q.canvas.id]=J;R.applyToContext(q);return ha}},applyTransform:function(J){if(J.translateX||J.translateY||J.scaling!==1||J.rotatation){q.save();aa={undo:function(){q.restore();aa=null},x:J.xy.x,y:J.xy.y};q.translate(J.xy.x-S+J.translateX,J.xy.y-$+J.translateY);J.rotation!==0&&q.rotate(J.rotation);
J.scaling!==1&&q.scale(J.scaling,J.scaling)}return aa},drawTiles:function(J){for(var R,ha,ba=S-256,T=$-256,Ca=Q.x2,Ja=Q.y2,fa=J.length;fa--;){R=J[fa];(ha=R.x>=ba&&R.x<=Ca&&R.y>=T&&R.y<=Ja)&&f(R,R.x-S,R.y-$)}},hitTest:function(J,R,ha){return q.isPointInPath(R,ha)},prepare:function(J){var R,ha=false;R=a.getOffset();var ba=a.getScaleFactor(),T=R.x,Ca=R.y;if(q)q.restore();else q=A.getContext("2d");for(R=J.length;R--;)ha=ha||J[R].clip;Q=Ka.init(T,Ca,T+v,Ca+G);Q.scaleFactor=ba;if(ba!==1)Q=Ka.fromCenter(Q.x1+
(v>>1),Q.y1+(G>>1),v/ba|0,G/ba|0);S=Q.x1;$=Q.y1;if(q){ha||q.clearRect(0,0,v,G);q.save();q.scale(ba,ba)}q.globalCompositeOperation="source-over";return q},prepArc:function(J,R,ha){q.beginPath();q.arc(J.xy.x-(aa?aa.x:S),J.xy.y-(aa?aa.y:$),J.size>>1,J.startAngle,J.endAngle,false);return m(R,ha)},prepImage:function(J,R,ha,ba){var T=(ba.x||J.xy.x)-(aa?aa.x:S),Ca=(ba.y||J.xy.y)-(aa?aa.y:$),Ja=ba.image||J.image;if(Ja){q.beginPath();q.rect(T,Ca,ba.width||Ja.width,ba.height||Ja.height);return m(R,ha,function(){q.drawImage(Ja,
T,Ca,ba.width||Ja.width,ba.height||Ja.height)})}},prepPoly:function(J,R,ha,ba){var T=true;J=ba.points||J.points;ba=aa?aa.x:S;var Ca=aa?aa.y:$;q.beginPath();for(var Ja=J.length;Ja--;){var fa=J[Ja].x-ba,Da=J[Ja].y-Ca;if(T){q.moveTo(fa,Da);T=false}else q.lineTo(fa,Da)}return m(R,ha)},getContext:function(){return q},getDimensions:function(){return{width:v,height:G}},getOffset:function(){return Y.init(S,$)},getViewport:function(){return Q}})});qb("dom",function(a,h,e,c){var f=typeof h.style["-webkit-transform"]!=
"undefined",m=null;m=document.createElement("div");m.id=COG.objId("domImages");m.style.cssText=COG.formatStr("position: absolute; overflow: hidden; width: {0}px; height: {1}px;",h.offsetWidth,h.offsetHeight);h.insertBefore(m,c.interactTarget);var v=COG.extend(c,{drawTiles:function(G){var A,q;A=v.getOffset();v.getViewport();for(var Q=A.x,S=A.y,$,aa,La=G.length;La--;){A=G[La];q=A.image;$=A.x-Q;aa=A.y-S;if(!q){q=A.image=new Image;q.src=A.url;m.appendChild(q);q.style.cssText="-webkit-user-select: none; -webkit-box-shadow: none; -moz-box-shadow: none; box-shadow: none; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-style: initial; border-color: initial; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; position: absolute;"}if(f)q.style["-webkit-transform"]=
"translate3d("+$+"px, "+aa+"px, 0px)";else{q.style.left=$+"px";q.style.top=aa+"px"}q.style.display="block"}},reset:function(){m.innerHTML=""}});return v});var sb={},Fb=M.defineStyle=function(a,h){sb[a]=l(h);return a},tb=M.defineStyles=function(a){for(var h in a)Fb(h,a[h])},Eb=M.getStyle=function(a){return sb[a]};M.loadStyles=function(a){COG.jsonp(a,function(h){tb(h)})};tb({basic:{lineWidth:1,strokeStyle:"#000",fillStyle:"#fff"},waypoints:{lineWidth:4,strokeStyle:"rgba(0, 51, 119, 0.9)",fillStyle:"#FFF"},
...
a.zoomDuration)}function v(r,w,K){Na=null;Ga("down",w,K)}function G(r,w,K){Ga("hover",w,K)}function A(r,w,K){La(w,K,false)}function q(r,w,K){La(w,K,true)}function Q(){clearTimeout(pa);pa=setTimeout(function(){renderer.checkSize()},250)}function S(r,w,K){Ga("tap",w,K);T("tap",w,K,f(K.x,K.y,true))}function $(r,w){w.id=r;w.added=ja();w.view=ma;w.trigger("parentChange",ma,cb,hb);fa.push(w);fa.sort(function(K,ra){var va=ra.zindex-K.zindex;if(va===0)va=ra.added-K.added;return va});Da=fa.length;return w}
function aa(){O&&O.unbind();if(renderer){O=INTERACT.watch(renderer.interactTarget);a.pannable&&O.pannable().bind("pan",h);if(a.scalable){O.bind("zoom",e);O.bind("doubleTap",m)}O.bind("pointerDown",v);O.bind("pointerMove",A);O.bind("pointerUp",q);a.captureHover&&O.bind("pointerHover",G);O.bind("tap",S)}}function La(r,w,K){if(Na){r=f(w.x,w.y);if(Na.drag.call(Na.target,Na,r.x,r.y,K))ma.redraw=true;if(K)Na=null}}function Ta(r){var w;w=false;r=r?r:(new Date).getTime();if(w=r-Ha>P){ma.trigger("enterFrame",
...
p)if(r){var w=b?Ea+(r.width>>1):Ea,K=d?Fa+(r.height>>1):Fa,ra=r.width,va=r.height;if(o&&o>ra)if(w+ra>o)Ea=b?Ea:o-ra;else if(w<0)Ea=b?Ea:0;if(p&&p>va)if(K+va>p)Fa=d?Fa:p-va;else if(K<0)Fa=d?Fa:0}H=(new Date).getTime();T("refresh",ma,r);ma.redraw=true}}function ha(r,w,K,ra,va){if(K)COG.tweenValue(la,r,K,va,function(Ua,Xa){la=Ua;if(Xa){var Va=wa(da(la)/Math.LN2);la=Aa(2,Va);ra&&ra()}c()});else{la=r;c()}return ma}function ba(r,w,K){r=ya(a.minZoom,ta(a.maxZoom,r));if(r!==Ba){var ra=Aa(2,r-Ba),va=ma.width>>
...
getScaleFactor:function(){return la},setMaxOffset:function(r,w,K,ra){o=r;p=w;b=K;d=ra},getViewport:function(){var r;if(renderer){r=renderer.getViewport();if(!r){r=renderer.getDimensions();r=Ka.init(Ea,Fa,Ea+r.width,Fa+r.height)}}return r},updateOffset:Ca,pan:function(r,w,K,ra,va){Ca(Ea+r,Fa+w,K,ra,va)}};COG.observable(ma);ma.bind("resync",function(){});COG.configurable(ma,["container","captureHover","captureDrag","scalable","pannable","inertia","minZoom","maxZoom","zoom"],COG.paramTweaker(a,null,
...
D.prototype=COG.extend(Pa.prototype,{constructor:D});sa.prototype={constructor:sa,clip:null,cycle:function(){},draw:function(){},hitGuess:null};var wb=function(a){a=COG.extend({zindex:10},a);var h=[],e=COG.extend(new sa(a),{draw:function(c,f,m,v,G){m={};for(v=h.length;v--;){var A=h[v],q=A.style||e.style,Q,S=c.applyTransform(A),$=A.getProps?A.getProps(c,f):m;if($=(Q=c["prep"+A.typeName])?Q.call(c,A,G,f,$):null){if($.hit){G.elements.push(Hits.initHit(A.type,A,A.draggable?A.drag:null));Q=G.type+"Style";
q=A[Q]||e[Q]||q}q=q?c.applyStyle(q):null;(Q=A.draw||$.draw)&&Q.call(A,$);q&&c.applyStyle(q)}S&&S.undo&&S.undo()}},getDrawables:function(){return[]},hitGuess:function(c,f){for(var m=false,v=h.length;!m&&v--;){var G=h[v];if(!(m=m))m=(G=G.bounds)&&c>=G.x1&&c<=G.x2&&f>=G.y1&&f<=G.y2;m=m}return m}});e.bind("refresh",function(c,f,m){h=e.getDrawables(f,m)});return e},gb=function(a){function h(m){for(var v=c.length;v--;)c[v].resync(m);c.sort(function(G,A){var q=A.xy.y-G.xy.y;return q!=0?q:A.xy.x-G.xy.y});
...
Hits:Hits,Generator:ob,tweenValue:COG.tweenValue,easing:COG.easing,viewState:j,View:vb,ViewLayer:sa,ImageLayer:function(a,h){function e(q,Q){if(ya(qa(Q.x1-m),qa(Q.y1-v))>=128&&c&&!f){f=true;var S=(new Date).getTime();c(q,Q,function($){m=Q.x1;v=Q.y1;G=[].concat($);f=false;q.redraw=true;COG.info("GEN COMPLETED IN "+((new Date).getTime()-S)+" ms")})}}h=COG.extend({imageLoadArgs:{}},h);var c=a?ob.init(a,h).run:null,f=false,m=0,v=0,G=[],A=COG.extend(new sa(h),{draw:function(q){q.drawTiles(G)}});A.bind("refresh",
function(q,Q,S){e(Q,S)});return A},ImageGenerator:function(a){a=COG.extend({relative:false,padding:2},a);a={run:function(){COG.warn("running base generator - this should be overriden")}};COG.observable(a);return a},Drawable:Pa,Marker:E,Poly:x,Line:I,Arc:D,ImageDrawable:t,ImageMarker:u,DrawLayer:wb,ShapeLayer:gb});COG.observable(M);var Sa=M.Geo=function(){function a(i){for(var k=null,o=1;!k&&o<arguments.length;o++)k=m(i,arguments[o]);k=k?k:m(i);if(!k)throw Error("Unable to find GEO engine with "+i+
" capability");return k}function h(i){i=parseFloat(i)*S;i=ka(i);var k=Ga*i;return da((1+i)/(1-i)*Aa((1-k)/(1+k),Ga))/2}function e(i){return parseFloat(i)*S}function c(i){i=Aa(Math.E,-i);for(var k=ga-2*za(i),o=v(k,i),p=0;p<R&&qa(k-o)>J;){k=o;o=v(k,i);p++}return o*$}function f(i){return i%360*$}function m(i,k){var o=null;for(var p in Da)if(k){if(p==k&&Da[p][i]){o=Da[p];break}}else if(Da[p][i]){o=Da[p];break}return o}function v(i,k){var o=Ga*ka(i);return ga-2*za(k*Aa((1-o)/(1+o),Ga/2))}function G(i,
k,o,p){k=A(k);i.add(p(k,o));return k.length}function A(i){var k=i?i.length:0,o=Array(k);for(k=k;k--;)o[k]=Sa.Position.init(i[k][1],i[k][0]);return Sa.Position.vectorize(o,db)}function q(i,k,o){return new Fa(i,k,o)}var Q=[1.406245461070741,1.321415085624082,1.077179995861952,0.703119412486786,0.488332580888611],S=Math.PI/180,$=180/Math.PI,aa=ga,La=-aa,Ta=-ca,Ga=0.08181919084262157,J=1.0E-7,R=12,ha=null,ba={RD:"ROAD",ST:"STREET",CR:"CRESCENT",CRES:"CRESCENT",CT:"COURT",LN:"LANE",HWY:"HIGHWAY",MWY:"MOTORWAY"},
T=function(){function i(b){return b?o(b.lat,b.lon):null}function k(b){return!b||b.lat===0&&b.lon===0}function o(b,d){return{lat:parseFloat(b?b:0),lon:parseFloat(d?d:0)}}function p(b){if(b)if(y(b.lat,oa))return i(b);else{if(b.split)for(var d=[" ",","],g=0;g<d.length;g++){var z=b.split(d[g]);if(z.length===2)return o(z[0],z[1])}}else return o();return null}return{calcDistance:function(b,d){if(k(b)||k(d))return 0;var g=(d.lat-b.lat)*S>>1,z=(d.lon-b.lon)*S>>1;g=ka(g)*ka(g)+Z(b.lat*S)*Z(d.lat*S)*ka(z)*
...
d,g){var z=T5.XY.init(0,d.lat-b.lat);z.x=(g||y(g,L))&&b.lon>d.lon?360-b.lon+d.lon:d.lon-b.lon;return z}function k(b,d){return Ca.init(T.init(b.min.lat-d,b.min.lon-d%360),T.init(b.max.lat+d,b.max.lon+d%360))}function o(b){var d=i(b.min,b.max);return T.init(b.min.lat+(d.y>>1),b.min.lon+(d.x>>1))}function p(b,d){return{min:T.parse(b),max:T.parse(d)}}return{calcSize:i,createBoundsFromCenter:function(b,d){var g=d/6371,z=b.lat*S,H=b.lon*S,X=z-g,pa=z+g;if(X>La&&pa<aa){z=V(ka(g)/Z(z));g=(H-z)%ca;H=(H+z)%
ca}else{X=ya(X,La);pa=ta(pa,aa);g=Ta;H=ca}return Ca.init(T.init(X*$,g*$),T.init(pa*$,H*$))},expand:k,forPositions:function(b,d){var g=null,z=T5.ticks();d||(d="auto");for(var H=b.length;H--;)if(g){var X=i(g.min,b[H],false),pa=i(b[H],g.max,false);if(X.x<0)g.min.lon=b[H].lon;if(X.y<0)g.min.lat=b[H].lat;if(pa.x<0)g.max.lon=b[H].lon;if(pa.y<0)g.max.lat=b[H].lat}else g=p(b[H],b[H]);if(d){if(d=="auto"){H=i(g.min,g.max);d=ya(H.x,H.y)*0.3}g=k(g,d)}COG.trace("calculated bounds for "+b.length+" positions",z);
return g},getCenter:o,getGeoHash:function(b){var d=T5.Geo.GeoHash.encode(b.min.lat,b.min.lon);b=T5.Geo.GeoHash.encode(b.max.lat,b.max.lon);COG.info("min hash = "+d+", max hash = "+b)},getZoomLevel:function(b,d){var g=o(b);g=ta(wa(qa(g.lat)*0.05),Q.length);var z=Q[g],H=i(b.min,b.max);g=na(da(Q[3]*d.height/H.y)/da(2));z=na(da(z*d.width/H.x)/da(2));return ta(isNaN(g)?1E3:g,isNaN(z)?1E3:z)},init:p,isEmpty:function(b){return!b||T.empty(b.min)||T.empty(b.max)},toString:function(b){return"min: "+T.toString(b.min)+
", max: "+T.toString(b.max)}}}(),Ja=function(){var i=/^(\d+).*$/,k=/(\d+)\s?\-\s?(\d+)/;return{buildingMatch:function(o,p){i.lastIndex=-1;if(i.test(o))for(var b=o.replace(i,"$1"),d=p.split(","),g=0;g<d.length;g++){k.lastIndex=-1;if(k.test(d[g])){var z=k.exec(d[g]);if(b>=parseInt(z[1],10)&&b<=parseInt(z[2],10))return true}else if(b==d[g])return true}return false},normalize:function(o){if(!o)return"";o=o.toUpperCase();if(!ha){var p=[];for(var b in ba)p.push(b);ha=RegExp("(\\s)("+p.join("|")+")(\\s|$)",
"i")}ha.lastIndex=-1;if(p=ha.exec(o))o=o.replace(ha,"$1"+ba[p[2]]);return o},toString:function(o){return o.streetDetails+" "+o.location}}}(),fa=M.GeoXY=function(){function i(p,b){if(p.length){for(var d,g,z,H,X=p.length;X--;){i(p[X],b);d=y(d,L)||p.x<d?p.x:d;g=y(g,L)||p.y<g?p.y:g;z=y(z,L)||p.x>z?p.x:z;H=y(H,L)||p.y>H?p.y:H}return Ka.init(d,g,H,H)}else if(p.mercXY){d=p.mercXY;p.x=(d.x+Math.PI)/b|0;p.y=(Math.PI-d.y)/b|0;p.rpp=b}else COG.warn("Attempted to sync an XY composite, not a GeoXY");return p}
function k(p,b){if(p.length)for(var d=p.length;d--;)k(p[d],b);else{p.mercXY=Y.init(p.x*b-Math.PI,Math.PI-p.y*b);p.pos=T.fromMercatorPixels(p.mercXY.x,p.mercXY.y)}return p}function o(p,b,d){p.pos=b;p.mercXY=T.toMercatorPixels(b);(d=y(d,oa)?d:p.rpp)&&i(p,d)}return{init:function(p,b){var d=Y.init();o(d,p,b);return d},sync:i,syncPos:k,toPos:function(p,b){b=b||p.rpp;return T.fromMercatorPixels(p.x*b-Math.PI,Math.PI-p.y*b)},updatePos:o}}(),Da={},cb=function(){return{bestResults:function(i,k){k||(k=20);
for(var o=i.length>0?i[0]:null,p=[],b=0;b<i.length;b++)if(o&&i[b]&&o.matchWeight-i[b].matchWeight<=k)p.push(i[b]);else break;return p}}}(),Na=function(i){i=COG.extend({id:null,caption:"",resultType:"",data:null,pos:null,matchWeight:0},i);return COG.extend(i,{toString:function(){return i.caption+(i.matchWeight?" ("+i.matchWeight+")":"")}})},ib=function(){function i(b,d){var g=new T5.ShapeLayer;d.geometry&&T.vectorize(d.geometry,{callback:function(z){g.add(new T5.Line(z,{style:"waypoints",simplify:true}));
b.setLayer("route",g)}})}function k(b){for(var d=o.Unknown,g=p,z=0;z<g.length;z++){g[z].regex.lastIndex=-1;var H=g[z].regex.exec(b);if(H){d=g[z].customCheck?g[z].customCheck(b,H):g[z].turnType;break}}return d}var o={Unknown:"turn-unknown",Start:"turn-none-start",Continue:"turn-none",Arrive:"turn-none-arrive",TurnLeft:"turn-left",TurnLeftSlight:"turn-left-slight",TurnLeftSharp:"turn-left-sharp",TurnRight:"turn-right",TurnRightSlight:"turn-right-slight",TurnRightSharp:"turn-right-sharp",Merge:"merge",
UTurnLeft:"uturn-left",UTurnRight:"uturn-right",EnterRoundabout:"roundabout-enter",Ramp:"ramp",RampExit:"ramp-exit"},p=function(){var b=[];b.push({regex:/continue/i,turnType:o.Continue});b.push({regex:/(take|bear|turn)(.*?)left/i,customCheck:function(d,g){return/bear/i.test(g[1])?o.TurnLeftSlight:o.TurnLeft}});b.push({regex:/(take|bear|turn)(.*?)right/i,customCheck:function(d,g){return/bear/i.test(g[1])?o.TurnRightSlight:o.TurnRight}});b.push({regex:/enter\s(roundabout|rotaty)/i,turnType:o.EnterRoundabout});
...
return b},RouteData:function(b){b=COG.extend({geometry:[],instructions:[],boundingBox:null},b);if(!b.boundingBox)b.boundingBox=Ca.forPositions(b.geometry);return COG.extend({getInstructionPositions:function(){for(var d=[],g=0;g<b.instructions.length;g++)b.instructions[g].position&&d.push(b.instructions[g].position);return d}},b)}}}(),hb="featurecollection",kb="feature",db={async:false},ab={processor:null,group:"shapes",layerClass:gb},Ea={point:COG.extend({},ab,{processor:function(i,k,o,p){k=A([k.coordinates],
db);if(k.length>0)if(o=p.marker(k[0],o)){i.add(o);return k.length}},group:"markers",layerClass:gb}),linestring:COG.extend({},ab,{processor:function(i,k,o,p){k=A(k&&k.coordinates?k.coordinates:[]);return G(i,k,o,p.line)}}),multilinestring:COG.extend({},ab,{processor:function(i,k,o,p){k=k&&k.coordinates?k.coordinates:[];for(var b=0,d=k.length;d--;)b+=G(i,k[d],o,p.line);return b}}),polygon:COG.extend({},ab,{processor:function(i,k,o,p){k=k&&k.coordinates?k.coordinates:[];if(k.length>0)return G(i,k[0],
o,p.poly);return 0}}),multipolygon:COG.extend({},ab,{processor:function(i,k,o,p){k=k&&k.coordinates?k.coordinates:[];for(var b=0,d=0;d<k.length;d++)b+=G(i,k[d][0],o,p.poly);return b}})},Fa=function(i,k,o,p){function b(P,ia){var ua=P.processor,Ba=X+P.group,Wa=COG.extend({},P,o,{properties:ia.properties});if(ua){var Ra=N[Ba];if(!Ra){Ra=new P.layerClass({id:Ba});N[Ba]=Ra}globalLayers=N;return ua(Ra,ia.data,Wa,p)}return 0}function d(P,ia){var ua=P&&P.type?P.type.toLowerCase():null;return ua&&ua===kb?
d(P.geometry,P.properties):{type:ua,isCollection:ua?ua===hb:false,definition:Ea[ua],data:P,properties:ia?ia:P.properties}}function g(P){var ia=0,ua=COG.extend({},o),Ba=pa;P=P?P:(new Date).getTime();if(!Ha){for(;Ba<la;Ba++){P=d(H?H(i[Ba]):i[Ba]);var Wa=null;if(P.isCollection){ua.layerPrefix=X+O++ +"-";Ha=q(P.data.features,function(Ra){Ha=null;for(var fb in Ra)N[fb]=Ra[fb]},ua);Wa+=1}else if(P.definition)Wa=b(P.definition,P);ia+=Wa?Wa:1;if(ia>=z)break}pa=Ba+1;if(Ha||pa<la)animFrame(g);else k&&k(N)}}
o=COG.extend({vectorsPerCycle:Sa.VECTORIZE_PER_CYCLE,rowPreParse:null,simplify:false,layerPrefix:"geojson-"},o);p=COG.extend({marker:function(P){return new E({xy:P})},line:function(P,ia){return new x(P,COG.extend({},o,ia))},poly:function(P,ia){return new x(P,COG.extend({fill:true},o,ia))}},p);var z=o.vectorsPerCycle,H=o.rowPreParse,X=o.layerPrefix,pa=0,la=0,Ha=null,O=0,N={};if(i){y(i,"array")||(i=[i]);la=i.length;animFrame(g)}};M.GeoJSON={parse:q};M.Map=function(i){function k(N){try{var P=Sa.Position.init(N.coords.latitude,
N.coords.longitude),ia=N.coords.accuracy/1E3;O.trigger("locationUpdate",N,ia);if(pa){if(!H){H=new Sa.UI.LocationOverlay({pos:P,accuracy:ia});H.update(O.getTileLayer());O.setLayer("location",H)}var ua=Sa.BoundingBox.createBoundsFromCenter(P,Math.max(ia,1));O.gotoBounds(ua)}else{H.pos=P;H.accuracy=ia;H.update(O.getTileLayer());b(P,null,COG.easing("sine.out"))}pa=false}catch(Ba){COG.exception(Ba)}}function o(N){COG.info("caught location tracking error:",N)}function p(N,P,ia){O.setZoomLevel(P);b(N,ia)}
...
O.resetScale();O.triggerAll("resync",O);O.refresh()});return O};M.GeoShape=function(i,k){k=COG.extend({autoParse:true},k);for(var o=Array(i.length),p=k.autoParse,b=T5.Geo.Position.parse,d=i.length;d--;)o[d]=T5.GeoXY.init(p?b(i[d]):i[d]);return new T5.Poly(o,k)};M.LocationOverlay=function(i){i=COG.extend({pos:null,accuracy:null,zindex:90},i);var k=new Image,o=T5.XY.init(),p=T5.XY.init(),b=null;k.src="data:image/png;base64,%3D%3D";
k.onload=function(){o=T5.XY.init(k.width>>1,k.height>>1)};var d=COG.extend(new T5.ViewLayer(i),{pos:i.pos,accuracy:i.accuracy,drawAccuracyIndicator:false,draw:function(g,z){var H=p.x-z.x,X=p.y-z.y;if(b){g.fillStyle="rgba(30, 30, 30, 0.2)";g.beginPath();g.arc(H,X,b,0,Math.PI*2,false);g.fill()}k.complete&&k.width>0&&g.drawImage(k,H-o.x,X-o.y,k.width,k.height)},update:function(g){if(g){b=g.getPixelDistance(d.accuracy)>>1;p=g.getGridXYForPosition(d.pos)}}});d.bind("gridUpdate",function(g,z){d.update(z)});
...
AddressCompareFns:{},Engine:function(i){if(!i.id)throw Error("A GEO.Engine cannot be registered without providing an id.");var k=COG.extend({remove:function(){delete Da[k.id]}},i);return Da[k.id]=k},Search:cb,GeoSearchResult:Na,LocationSearch:function(i){function k(g,z){navigator.geolocation.clearWatch(p);p=0;if(b){clearTimeout(b);b=0}z&&z([g],i)}function o(g){COG.info("caught location tracking error:",g)}i=COG.extend({name:"Geolocation Search",requiredAccuracy:null,searchTimeout:5E3,watch:false},
i);var p=0,b=0,d=null;return new T5.Geo.GeoSearchAgent(COG.extend({execute:function(g,z){if(navigator.geolocation&&!p){p=navigator.geolocation.watchPosition(function(H){var X=T.init(H.coords.latitude,H.coords.longitude);H=new Na({id:1,caption:"Current Location",pos:X,accuracy:H.coords.accuracy/1E3,matchWeight:100});if(!d||H.accuracy<d.accuracy)d=H;if(!i.requiredAccuracy||d.accuracy<i.requiredAccuracy)k(d,z)},o,{enableHighAccuracy:true,timeout:1E4,maximumAge:5E3});if(i.searchTimeout)b=setTimeout(function(){d&&
