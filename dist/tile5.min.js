...
j;p()},clear:function(j){if(j)for(var l=0;l<a.length;l++)j(a[l])&&a.splice(l,1);else a=[];p()},each:function(j){if(j)for(var l=a.length;l--;)j(a[l])},find:function(j){for(var l=[],q=a.length;q--;)if(!j||j(a[q]))l[l.length]=a[q];return l}});d.bind("tap",function(j,l,q,v){var n=[],r=v.x;v=v.y;for(var z=a.length;z--;)if(a[z].hitTest(r,v))n[n.length]=a[z];if(n.length>0)j.cancel=d.trigger("markerTap",l,q,n).cancel});d.bind("parentChange",h);d.bind("resync",h);d.bind("changed",h);return d},rb=function(c){function p(q,
v,n){q.fillStyle="#FFFFFF";q.strokeStyle="#222222";q.beginPath();q.arc(n.x,n.y,4,0,Math.PI*2,false);q.stroke();q.fill()}c=COG.extend({path:[],id:COG.objId("pathAni"),easing:COG.easing("sine.inout"),validStates:H("ACTIVE","PAN","ZOOM"),drawIndicator:null,duration:2E3},c);var h=N.edges(c.path),a,d=null,j=0;COG.tweenValue(0,h.total,c.easing,function(){l.remove()},c.duration).requestUpdates(function(q,v){j=q;v&&l.remove()});var l=COG.extend(new bb(c),{cycle:function(){for(var q=0;q<h.accrued.length&&
h.accrued[q]<j;)q++;d=null;if(q<c.path.length-1){var v=j-(q>0?h.accrued[q-1]:0),n=c.path[q];a=N.theta(n,c.path[q+1],h.edges[q]);d=N.extendBy(n,a,v)}return d},draw:function(q,v){if(d)(c.drawIndicator?c.drawIndicator:p)(q,v,N.init(d.x,d.y),a)}});return l},sb=function(c){c=COG.extend({style:null,properties:{}},c);return COG.extend(c,{rect:null,draw:function(){},resync:function(){}})},nb=function(c,p){p=COG.extend({fill:false,simplify:false},p);var h=false,a=p.fill,d=p.simplify,j=H("ZOOM"),l=[],q=COG.extend(new sb(p),
{draw:function(v,n,r,z,K,X){if(h){n=true;r=(X&j)!==0;v.beginPath();for(X=l.length;X--;){r=l[X].x;z=l[X].y;if(n){v.moveTo(r,z);n=false}else v.lineTo(r,z);r=true}if(r){a&&v.fill();v.stroke()}}},resync:function(v){q.xy=v.syncXY(c);l=N.floor(d?N.simplify(c):c)}});h=c&&c.length>=2;return q},tb=function(c){function p(j){for(var l=a.length;l--;)a[l].resync(j);a.sort(function(q,v){var n=v.xy.y-q.xy.y;if(n===0)n=v.xy.x-q.xy.y;return n});d.changed()}function h(j,l){l.syncXY&&p(l)}c=COG.extend({zindex:80},c);
var a=[],d=COG.extend(new bb(c),{add:function(j){a[a.length]=j},each:function(j){for(var l=a.length;l--;)j(a[l])},draw:function(j,l,q){var v=l.x1,n=l.y1,r=l.width;l=l.height;for(var z=a.length;z--;){var K=a[z].style;K=K?Ua.apply(j,K):null;a[z].draw(j,v,n,r,l,q);K&&Ua.apply(j,K)}}});d.bind("parentChange",h);d.bind("resync",h);return d},wb=function(){return{tileSize:256,init:function(c,p,h,a,d){return COG.extend({x:c,y:p,width:h,height:a},d)}}}(),ub=function(c){function p(V,u,O,$){function U(){if(X.initTileCreator){q=
true;X.initTileCreator(V,u,O,$)}}X.prepTileCreator?X.prepTileCreator(V,u,O,U):U()}function h(V,u){for(var O=~~((V.x1-j.x)/v),$=~~((V.y1-j.y)/n),U=[],wa=-l;wa<z;wa++)for(var fa=-l;fa<K;fa++){var aa=r(O+wa,$+fa);if(aa)U[U.length]=aa}u&&u(U);d=w.copy(V)}c=COG.extend({tileWidth:256,tileHeight:256,relative:false,padding:2},c);var a=null,d=null,j=N.init(),l=c.padding,q=false,v=c.tileWidth,n=c.tileHeight,r=null,z=0,K=0,X={bindToView:function(V){COG.info("initializing generator");a=V;X.trigger("bindView",
V)},getTileCreatorArgs:null,initTileCreator:null,prepTileCreator:null,requireRefresh:function(){return false},reset:function(){r=null;q=false;d=null},run:function(V,u){if(!d||Math.abs(V.x1-d.x1)>v||Math.abs(V.y1-d.y1)>n){if(!r&&!q||X.requireRefresh()){j=c.relative?N.init(V.x1,V.y1):N.init();z=Math.ceil(V.width/v)+l;K=Math.ceil(V.height/n)+l;p(v,n,X.getTileCreatorArgs?X.getTileCreatorArgs(a):{},function(O){r=O;q=false;h(V,u)})}r&&h(V,u)}}};COG.observable(X);X.bind("update",function(){COG.info("captured generator update");
d=null});return X},Na={ex:COG.extend,ticks:ia,getConfig:x,userMessage:function(c,p,h){Na.trigger("userMessage",c,p,h)},zoomable:B,XY:N,XYRect:w,Dimensions:Aa,Vector:oa,D:Aa,Images:Fa,Generator:Pa,tween:COG.tween,tweenValue:COG.tweenValue,easing:COG.easing,Tween:COG.Tween,Style:Ua,viewState:H,View:qb,ViewLayer:bb,ImageLayer:function(c,p){function h(n,r,z){for(r=j.length;r--;){var K=j[r],X=K.x,V=K.y,u=w.init(K.x,K.y,K.x+K.width,K.y+K.height);if(z&&w.intersect(n,u)){u=Fa.get(K.url,function(){v.changed()},
q);z(u,X,V,K.width,K.height)}}}function a(n){d&&d.run(n,function(r){j=[].concat(r);v.changed()})}p=COG.extend({imageLoadArgs:{}},p);var d=c?Pa.init(c,p):null,j=[],l=w.init(),q=p.imageLoadArgs,v=COG.extend(new bb(p),{changeGenerator:function(n,r){d=Pa.init(n,COG.extend({},p,r));d.bindToView(v.getParent());j=null;a(l)},clip:function(n,r,z){h(r,z,function(K,X,V,u,O){K&&n.rect(X,V,u,O)})},cycle:function(n,r){a(r)},draw:function(n,r,z){h(r,z,function(K,X,V,u,O){v.drawImage(n,K,X,V,u,O,r,z)});l=w.copy(r)},
drawImage:function(n,r,z,K){r&&n.drawImage(r,z,K,r.width,r.height)}});v.bind("idle",function(){a(l)});v.bind("parentChange",function(n,r){d&&d.bindToView(r)});v.bind("tap",function(n,r,z,K){n=[];var X=K.x,V=K.y,u,O;if(j)for(var $=j.length;$--;){u=j[$];if(O=X>=u.x&&X<=u.x+u.width&&V>=u.y&&V<=u.y+u.height)n[n.length]=u}n.length>0&&v.trigger("tapImage",n,r,z,K)});return v},Marker:mb,ImageMarker:function(c){c=COG.extend({image:null,imageUrl:null,animatingImage:null,animatingImageUrl:null,imageAnchor:null,
rotation:0,scale:1,opacity:1},c);var p=c.imageAnchor?T5.XY.invert(c.imageAnchor):null,h=COG.extend(new mb(c),{drawMarker:function(a,d,j,l){if((d=h.isAnimating()&&h.animatingImage?h.animatingImage:h.image)&&d.width>0){p||(p=N.init(-d.width>>1,-d.height>>1));var q=h.scale,v=j+~~(p.x*q),n=l+~~(p.y*q),r=~~(d.width*q),z=~~(d.height*q);h.updateBounds(v,n,r,r);if(h.rotation||h.opacity!==1){a.save();try{a.globalAlpha=h.opacity;a.translate(j,l);a.rotate(h.rotation);a.drawImage(d,p.x*q,p.y*q,r,z)}finally{a.restore()}}else a.drawImage(d,
v,n,r,z)}}});if(!h.image)h.image=Fa.get(c.imageUrl,function(a){h.image=a});if(!h.animatingImage)h.animatingImage=Fa.get(c.animatingImageUrl,function(a){h.animatingImage=a});return h},MarkerLayer:lb,PathLayer:function(c){c=COG.extend({style:"waypoints",pixelGeneralization:8,zindex:50},c);var p=false,h=[],a=null,d=[],j=null,l=0,q=[],v=COG.extend(new bb(c),{getAnimation:function(n,r,z,K){var X="pathAnimation"+l++;q.push(X);return new rb({id:X,path:h,zindex:c.zindex+1,easing:n?n:COG.easing("sine.inout"),
duration:r?r:5E3,drawIndicator:z,autoCenter:K?K:false})},cycle:function(n,r,z,K){return K},draw:function(n){var r,z=h.length;n.save();try{Ua.apply(n,c.style);if(z>0){n.beginPath();n.moveTo(h[z-1].x,h[z-1].y);for(r=z;r--;)n.lineTo(h[r].x,h[r].y);n.stroke();if(a){n.fillStyle=c.waypointFillStyle;for(r=a.length;r--;){n.beginPath();n.arc(a[r].x,a[r].y,2,0,Math.PI*2,false);n.stroke();n.fill()}}}}finally{n.restore()}p=false},updateCoordinates:function(n,r){d=n;j=r;var z=v.getParent();if(z&&z.syncXY){z.syncXY(d);
j&&z.syncXY(j);v.trigger("tidy")}}});v.bind("tidy",function(){h=N.simplify(d,c.pixelGeneralization);a=N.simplify(j,c.pixelGeneralization);p=true;v.changed()});return v},AnimatedPathLayer:rb,Shape:sb,Arc:function(c,p){p=COG.extend({size:4},p);var h=N.init(),a=COG.extend(p,{draw:function(d){d.beginPath();d.arc(h.x,h.y,a.size,0,Math.PI*2,false);d.fill();d.stroke()},resync:function(d){d.syncXY([c]);h=N.floor([c])[0]}});COG.info("created arc = ",c);return a},Poly:nb,ShapeLayer:tb,Tiling:wb,TileGenerator:ub};
COG.observable(Na);var Oa=Na.Geo=function(){function c(g){g=parseFloat(g)*V;g=qa(g);var e=O*g;return na((1+g)/(1-g)*P((1-e)/(1+e),O))/2}function p(g){return parseFloat(g)*V}function h(g){g=P(Math.E,-g);for(var e=f-2*va(g),k=j(e,g),o=0;o<U&&s(e-k)>$;){e=k;k=j(e,g);o++}return k*u}function a(g){return g%360*u}function d(g,e){var k=null;for(var o in engines)if(e){if(o==e&&engines[o][g]){k=engines[o];break}}else if(engines[o][g]){k=engines[o];break}return k}function j(g,e){var k=O*qa(g);return f-2*va(e*
P((1-k)/(1+k),O/2))}function l(g,e,k,o){e=v(e);g.add(o.line(e,k));return e.length}function q(g,e,k,o){e=v(e);g.add(o.poly(e,k));return e.length}function v(g){var e=g?g.length:0,k=Array(e);for(e=e;e--;)k[e]=Oa.Position.init(g[e][1],g[e][0]);return Oa.Position.vectorize(k,Sa)}function n(g,e,k){return new cb(g,e,k)}var r=[1.406245461070741,1.321415085624082,1.077179995861952,0.703119412486786,0.488332580888611],z=-f,K=f,X=-ca,V=Math.PI/180,u=180/Math.PI,O=0.08181919084262157,$=1.0E-7,U=12,wa=null,fa=
{RD:"ROAD",ST:"STREET",CR:"CRESCENT",CRES:"CRESCENT",CT:"COURT",LN:"LANE",HWY:"HIGHWAY",MWY:"MOTORWAY"},aa=function(){function g(b){return b?k(b.lat,b.lon):null}function e(b){return!b||b.lat===0&&b.lon===0}function k(b,i){return{lat:parseFloat(b?b:0),lon:parseFloat(i?i:0)}}function o(b){if(b)if(typeof b.lat!=="undefined")return g(b);else{if(b.split)for(var i=[" ",","],m=0;m<i.length;m++){var G=b.split(i[m]);if(G.length===2)return k(G[0],G[1])}}else return k();return null}return{calcDistance:function(b,
i){if(e(b)||e(i))return 0;var m=(i.lat-b.lat)*V>>1,G=(i.lon-b.lon)*V>>1;m=qa(m)*qa(m)+Ja(b.lat*V)*Ja(i.lat*V)*qa(G)*qa(G);return 6371*2*Ca(Y(m),Y(1-m))},copy:g,empty:e,equal:function(b,i){return b&&i&&b.lat==i.lat&&b.lon==i.lon},fromMercatorPixels:function(b,i){return k(h(i),a(b))},generalize:function(b,i,m){var G=b.length,I=[],ba=null;m||(m=250);m/=1E3;COG.info("generalizing positions, must include "+i.length+" positions");for(var la=G;la--;)if(la===0)I.unshift(b[la]);else{var za=!ba||aa.inArray(b[la],
i)?m:aa.calcDistance(ba,b[la]);if(b[la]&&za>=m){I.unshift(b[la]);ba=b[la]}}COG.info("generalized "+G+" positions into "+I.length+" positions");return I},inArray:function(b,i){for(var m=aa.equal,G=i.length;G--;)if(m(b,i[G]))return true;return false},inBounds:function(b,i){var m=!(aa.empty(b)||aa.empty(i));return m=(m=m&&b.lat>=i.min.lat&&b.lat<=i.max.lat)&&b.lon>=i.min.lon&&b.lon<=i.max.lon},init:k,offset:function(b,i,m){var G=b.lat*V;b=b.lon*V;i=G+i/6371;m=Ka(qa(m/6371)/Ja(G));m=b+m;i=(i+f)%Math.PI-
f;m%=ca;return k(i*u,m*u)},parse:o,parseArray:function(b){var i=b.length,m=Array(i);for(i=i;i--;)m[i]=o(b[i]);return m},toMercatorPixels:function(b){return T5.XY.init(p(b.lon),c(b.lat))},toString:function(b){return b?b.lat+" "+b.lon:""},vectorize:function(b,i){var m=b.length,G=Array(m);i=COG.extend({chunkSize:500,async:true},i);if(!i.async){for(var I=m;I--;)G[I]=T5.GeoXY.init(b[I]);return G}return COG.Loopage.join({frequency:10,execute:function(ba,la){for(var za=0,La=i.chunkSize,S=m;S--;){G[S]=T5.GeoXY.init(b[S]);
za+=1;if(za>La)break}m=S;m<=0&&la.trigger("complete",G)}})}}}(),ya=function(){function g(b,i,m){var G=T5.XY.init(0,i.lat-b.lat);if(typeof m==="undefined")m=true;G.x=m&&b.lon>i.lon?360-b.lon+i.lon:i.lon-b.lon;return G}function e(b,i){return ya.init(aa.init(b.min.lat-i,b.min.lon-i%360),aa.init(b.max.lat+i,b.max.lon+i%360))}function k(b){var i=g(b.min,b.max);return aa.init(b.min.lat+(i.y>>1),b.min.lon+(i.x>>1))}function o(b,i){return{min:aa.parse(b),max:aa.parse(i)}}return{calcSize:g,createBoundsFromCenter:function(b,
i){var m=i/6371,G=b.lat*V,I=b.lon*V,ba=G-m,la=G+m;if(ba>z&&la<K){G=Ka(qa(m)/Ja(G));m=(I-G)%ca;I=(I+G)%ca}else{ba=C(ba,z);la=t(la,K);m=X;I=ca}return ya.init(aa.init(ba*u,m*u),aa.init(la*u,I*u))},expand:e,forPositions:function(b,i){var m=null,G=T5.ticks();i||(i="auto");for(var I=b.length;I--;)if(m){var ba=g(m.min,b[I],false),la=g(b[I],m.max,false);if(ba.x<0)m.min.lon=b[I].lon;if(ba.y<0)m.min.lat=b[I].lat;if(la.x<0)m.max.lon=b[I].lon;if(la.y<0)m.max.lat=b[I].lat}else m=o(b[I],b[I]);if(i){if(i=="auto"){I=
g(m.min,m.max);i=C(I.x,I.y)*0.3}m=e(m,i)}COG.trace("calculated bounds for "+b.length+" positions",G);return m},getCenter:k,getGeoHash:function(b){var i=T5.Geo.GeoHash.encode(b.min.lat,b.min.lon);b=T5.Geo.GeoHash.encode(b.max.lat,b.max.lon);COG.info("min hash = "+i+", max hash = "+b)},getZoomLevel:function(b,i){var m=k(b);m=t(Ia(s(m.lat)*0.05),r.length);var G=r[m],I=g(b.min,b.max);m=ceil(na(r[3]*i.height/I.y)/na(2));G=ceil(na(G*i.width/I.x)/na(2));return t(isNaN(m)?1E3:m,isNaN(G)?1E3:G)},init:o,isEmpty:function(b){return!b||
aa.empty(b.min)||aa.empty(b.max)},toString:function(b){return"min: "+aa.toString(b.min)+", max: "+aa.toString(b.max)}}}(),pa=function(){var g=/^(\d+).*$/,e=/(\d+)\s?\-\s?(\d+)/;return{buildingMatch:function(k,o){g.lastIndex=-1;if(g.test(k))for(var b=k.replace(g,"$1"),i=o.split(","),m=0;m<i.length;m++){e.lastIndex=-1;if(e.test(i[m])){var G=e.exec(i[m]);if(b>=parseInt(G[1],10)&&b<=parseInt(G[2],10))return true}else if(b==i[m])return true}return false},normalize:function(k){if(!k)return"";k=k.toUpperCase();
if(!wa){var o=[];for(var b in fa)o.push(b);wa=RegExp("(\\s)("+o.join("|")+")(\\s|$)","i")}wa.lastIndex=-1;if(o=wa.exec(k))k=k.replace(wa,"$1"+fa[o[2]]);return k},toString:function(k){return k.streetDetails+" "+k.location}}}(),Qa=Na.GeoXY=function(){function g(k,o){if(k.length){for(var b,i,m,G,I=k.length;I--;){g(k[I],o);b=typeof b==="undefined"||k.x<b?k.x:b;i=typeof i==="undefined"||k.y<i?k.y:i;m=typeof m==="undefined"||k.x>m?k.x:m;G=typeof G==="undefined"||k.y>G?k.y:G}return w.init(b,i,G,G)}else if(k.mercXY){b=
k.mercXY;k.x=~~(b.x/o);k.y=~~((Math.PI-b.y)/o);k.rpp=o}else COG.warn("Attempted to sync an XY composite, not a GeoXY");return k}function e(k,o,b){k.pos=o;k.mercXY=aa.toMercatorPixels(o);(b=typeof b!=="undefined"?b:k.rpp)&&g(k,b)}return{init:function(k,o){var b=N.init();e(b,k,o);return b},sync:g,toPos:function(k,o){o=o?o:self.rpp;return aa.fromMercatorPixels(k.x*o,Math.PI-k.y*o)},updatePos:e}}();Na.GeoVector=function(g){COG.warn("The T5.Geo.GeoVector class has been deprecated, please use T5.GeoXY.init instead");
return Qa.init(g)};var Ga=function(){return{bestResults:function(g,e){e||(e=20);for(var k=g.length>0?g[0]:null,o=[],b=0;b<g.length;b++)if(k&&g[b]&&k.matchWeight-g[b].matchWeight<=e)o.push(g[b]);else break;return o}}}(),Ea=function(g){g=COG.extend({id:null,caption:"",resultType:"",data:null,pos:null,matchWeight:0},g);return COG.extend(g,{toString:function(){return g.caption+(g.matchWeight?" ("+g.matchWeight+")":"")}})},kb=function(){var g={calculate:function(e){e=COG.extend({engineId:"",waypoints:[],
map:null,error:null,autoFit:true,success:null,generalize:false},e);var k=T5.Geo.getEngine("route");k&&k.route(e,function(o){if(e.generalize)o.geometry=T5.Geo.Position.generalize(o.geometry,o.getInstructionPositions());if(e.map){g.createMapOverlay(e.map,o);e.autoFit&&e.map.gotoBounds(o.boundingBox)}e.success&&e.success(o)})},createMapOverlay:function(e,k){var o=e.getDimensions();o=new T5.Geo.UI.RouteOverlay({data:k,width:o.width,height:o.height});e.setLayer("route",o)},parseTurnType:function(e){for(var k=
g.TurnType.Unknown,o=T5.Geo.Routing.TurnTypeRules,b=0;b<o.length;b++){o[b].regex.lastIndex=-1;var i=o[b].regex.exec(e);if(i){k=o[b].customCheck?o[b].customCheck(e,i):o[b].turnType;break}}return k},TurnType:{Unknown:"turn-unknown",Start:"turn-none-start",Continue:"turn-none",Arrive:"turn-none-arrive",TurnLeft:"turn-left",TurnLeftSlight:"turn-left-slight",TurnLeftSharp:"turn-left-sharp",TurnRight:"turn-right",TurnRightSlight:"turn-right-slight",TurnRightSharp:"turn-right-sharp",Merge:"merge",UTurnLeft:"uturn-left",
UTurnRight:"uturn-right",EnterRoundabout:"roundabout-enter",Ramp:"ramp",RampExit:"ramp-exit"},Instruction:function(e){var k=e=COG.extend({position:null,description:"",distance:0,distanceTotal:0,time:0,timeTotal:0,turnType:null},e),o=e.description;o=o.replace(/(\w)(\/)(\w)/g,"$1 $2 $3");k.description=o;if(!e.turnType)e.turnType=g.parseTurnType(e.description);return e},RouteData:function(e){e=COG.extend({geometry:[],instructions:[],boundingBox:null},e);if(!e.boundingBox)e.boundingBox=T5.Geo.BoundingBox.forPositions(e.geometry);
return COG.extend({getInstructionPositions:function(){for(var k=[],o=0;o<e.instructions.length;o++)e.instructions[o].position&&k.push(e.instructions[o].position);return k}},e)}};return g}(),$a="featurecollection",ab="feature",Sa={async:false},Ya={processor:null,group:"shapes",layerClass:tb},ib={point:COG.extend({},Ya,{processor:function(g,e,k,o){e=v([e.coordinates],Sa);if(e.length>0)if(k=o.marker(e[0],k)){g.add(k);return e.length}},group:"markers",layerClass:lb}),linestring:COG.extend({},Ya,{processor:function(g,
e,k,o){e=v(e&&e.coordinates?e.coordinates:[]);return l(g,e,k,o)}}),multilinestring:COG.extend({},Ya,{processor:function(g,e,k,o){e=e&&e.coordinates?e.coordinates:[];for(var b=0,i=e.length;i--;)b+=l(g,e[i],k,o);return b}}),polygon:COG.extend({},Ya,{processor:function(g,e,k,o){e=e&&e.coordinates?e.coordinates:[];if(e.length>0)return q(g,e[0],k,o);return 0}}),multipolygon:COG.extend({},Ya,{processor:function(g,e,k,o){e=e&&e.coordinates?e.coordinates:[];for(var b=0,i=0;i<e.length;i++)b+=q(g,e[i][0],k,
o);return b}})},cb=function(g,e,k,o){function b(M,ha){var ka=M.processor,ga=I+M.group,sa=COG.extend({},M,k,{properties:ha.properties});if(ka){var ta=S[ga];if(!ta){ta=new M.layerClass({id:ga});S[ga]=ta}globalLayers=S;return ka(ta,ha.data,sa,o)}return 0}function i(M,ha){var ka=M&&M.type?M.type.toLowerCase():null;return ka&&ka===ab?i(M.geometry,M.properties):{type:ka,isCollection:ka?ka===$a:false,definition:ib[ka],data:M,properties:ha?ha:M.properties}}k=COG.extend({vectorsPerCycle:Oa.VECTORIZE_PER_CYCLE,
rowPreParse:null,simplify:false,layerPrefix:"geojson-"},k);o=COG.extend({marker:function(M){return new mb({xy:M})},line:function(M,ha){return new nb(M,ha)},poly:function(M,ha){return new nb(M,COG.extend({fill:true},ha))}},o);var m=k.vectorsPerCycle,G=k.rowPreParse,I=k.layerPrefix,ba=0,la=0,za=null,La=0,S={},Q;if(!g)return null;if(typeof g.length==="undefined")g=[g];la=g.length;Q=COG.Loopage.join({frequency:10,execute:function(M,ha){var ka=0,ga=ba;if(!za){for(;ga<la;ga++){var sa=i(G?G(g[ga]):g[ga]),
ta=null;if(sa.isCollection){La+=1;za=n(sa.data.features,function(gb){za=null;for(var hb in gb)S[hb]=gb[hb]},{layerPrefix:I+La+"-"});ta+=1}else if(sa.definition)ta=b(sa.definition,sa);ka+=ta?ta:1;if(ka>=m)break}ba=ga+1;!za&&ba>=la&&ha.trigger("complete")}}});Q.bind("complete",function(){e&&e(S)});return Q};Na.GeoJSON={parse:n};Na.Map=function(g){function e(Q){try{var M=Oa.Position.init(Q.coords.latitude,Q.coords.longitude),ha=Q.coords.accuracy/1E3;S.trigger("locationUpdate",Q,ha);if(la){if(!I){I=new Oa.UI.LocationOverlay({pos:M,
accuracy:ha});I.update(S.getTileLayer());S.setLayer("location",I)}var ka=Oa.BoundingBox.createBoundsFromCenter(M,Math.max(ha,1));S.gotoBounds(ka)}else{I.pos=M;I.accuracy=ha;I.update(S.getTileLayer());b(M,null,COG.easing("sine.out"))}la=false}catch(ga){COG.exception(ga)}}function k(Q){COG.info("caught location tracking error:",Q)}function o(Q,M,ha){S.setZoomLevel(M);Fa.cancelLoad();COG.endTweens();b(Q,ha)}function b(Q,M,ha,ka){Q=Qa.init(Q,Oa.radsPerPixel(S.getZoomLevel()));var ga=S.getDimensions();
S.updateOffset(Q.x-(ga.width>>1),Q.y-(ga.height>>1),ha,ka,M);S.trigger("wake");S.trigger("boundsChange",S.getBoundingBox());M&&typeof ha==="undefined"&&M(S)}g=COG.extend({tapExtent:10,crosshair:false,zoomLevel:0,boundsChangeThreshold:30},g);var i={NONE:0,SINGLE:1,WATCH:2},m=N.init(),G=i.NONE,I=null,ba=0,la=true,za=0,La=g.tapExtent;g.adjustScaleFactor=function(Q){return Math.pow(2,(Q<1?Math.floor:Math.ceil)(Math.log(Q)))};var S=COG.extend(new qb(g),{getBoundingBox:function(){var Q=S.getViewRect();
return Oa.BoundingBox.init(Qa.toPos(N.init(Q.x1,Q.y2),za),Qa.toPos(N.init(Q.x2,Q.y1),za))},getCenterPosition:function(){var Q=S.getViewRect();if(Q){Q=N.init(Q.x1+(Q.width>>1),Q.y1+(Q.height>>1));return Qa.toPos(Q,za)}return null},gotoBounds:function(Q,M){var ha=Oa.BoundingBox.getZoomLevel(Q,S.getDimensions());o(Oa.BoundingBox.getCenter(Q),ha,M)},gotoPosition:o,panToPosition:b,syncXY:function(Q){return Qa.sync(Q,za)},locate:function(){S.trackStart(i.SINGLE);setTimeout(S.trackCancel,1E4)},trackStart:function(Q){if(navigator.geolocation&&
!ba){G=Q?Q:i.WATCH;la=true;ba=navigator.geolocation.watchPosition(e,k,{enableHighAccuracy:true,timeout:1E4,maximumAge:5E3})}},trackCancel:function(){ba&&navigator.geolocation&&navigator.geolocation.clearWatch(ba);S.removeLayer("location");I=null;G=i.NONE;ba=0},animateRoute:function(Q,M,ha,ka){var ga=S.getLayer("route");if(ga)(Q=ga.getAnimation(Q,M,ha,ka))&&Q.addToView(S)}});S.bind("pan",function(){G===i.SINGLE&&S.trackCancel()});S.bind("tap",function(Q,M,ha,ka){var ga=Oa.radsPerPixel(S.getZoomLevel());
Q=Qa.toPos(ka,ga);var sa=Qa.toPos(N.offset(ka,-La,La),ga);ka=Qa.toPos(N.offset(ka,La,-La),ga);S.trigger("geotap",M,ha,Q,ya.init(sa,ka))});S.bind("idle",function(){var Q=N.absSize(N.diff(m,S.getOffset()));COG.info("idle detected, change delta = "+Q);if(Q>g.boundsChangeThreshold){m=N.copy(S.getOffset());S.trigger("boundsChange",S.getBoundingBox())}});B(S,g);S.bind("zoomLevelChange",function(Q,M){za=Oa.radsPerPixel(M);S.triggerAll("resync",S)});return S};Na.MapTileGenerator=function(g){function e(i,
m){var G=m>=b.minLevel&&(!b.maxLevel||m<=b.maxLevel);COG.info("new zoom level = "+m+", zoom ok = "+G);i.cancel=!G;if(G){k=m;b.reset()}}g=COG.extend({relative:true},g);var k=0,o=null,b=COG.extend(new ub(g),{minLevel:2,maxLevel:20,getTileCreatorArgs:function(i){o=i.getCenterPosition();return{zoomLevel:k,position:o}},requireRefresh:function(){return!o}});b.bind("bindView",function(i,m){if(m.getZoomLevel){k=m.getZoomLevel();m.bind("zoomLevelChange",e)}});return b};Na.GeoPoly=function(g,e){e=COG.extend({autoParse:true},
e);for(var k=Array(g.length),o=e.autoParse,b=T5.Geo.Position.parse,i=g.length;i--;)k[i]=T5.GeoXY.init(o?b(g[i]):g[i]);return new T5.Poly(k,e)};Na.RouteOverlay=function(g){g=COG.extend({data:null,pixelGeneralization:8,partialDraw:false,strokeStyle:"rgba(0, 51, 119, 0.9)",waypointFillStyle:"#FFFFFF",lineWidth:4,zindex:50},g);var e=[],k=[],o=new T5.PathLayer(g);(function(){if(g.data&&g.data.instructions){for(var b=g.data.instructions,i=Array(b.length),m=b.length;m--;)i[m]=b[m].position;T5.Geo.Position.vectorize(i).bind("complete",
function(G,I){k=I})}g.data&&g.data.geometry&&T5.Geo.Position.vectorize(g.data.geometry).bind("complete",function(G,I){e=I;o.updateCoordinates(e,k,true)})})();return o};Na.LocationOverlay=function(g){g=COG.extend({pos:null,accuracy:null,zindex:90},g);var e=new Image,k=T5.XY.init(),o=T5.XY.init(),b=null;e.src="data:image/png;base64,%3D%3D";
