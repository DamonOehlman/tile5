...
o,m,p))&&l.addToView(n)}},k);k=new TILE5.Mapping.AnnotationsOverlay({pois:n.pois,map:n,createAnnotationForPOI:a.createAnnotationForPOI});n.annotations=k;n.setLayer("annotations",k);a.crosshair&&n.setLayer("crosshair",new TILE5.Mapping.CrosshairOverlay);i&&n.setLayer("copyright",new TILE5.Graphics.ViewLayer({zindex:999,draw:function(l,o,m){l.lineWidth=2.5;l.fillStyle="rgb(50, 50, 50)";l.strokeStyle="rgba(255, 255, 255, 0.8)";l.font="bold 10px sans";l.textBaseline="bottom";l.strokeText(i,10,m.height-
...
q.success(e)})},createMapOverlay:function(q,a){var e=q.getDimensions();e=new TILE5.Mapping.RouteOverlay({data:a,width:e.width,height:e.height});q.setLayer("route",e)},Maneuver:{None:0,Continue:1,TurnLeft:100,TurnLeftSlight:101,TurnLeftSharp:102,TurnRight:110,TurnRightSlight:111,TurnRightSharp:112,TurnAround:190,EnterRoundabout:200,ExitRamp:300},Instruction:function(q){q=GRUNT.extend({position:null,description:"",manuever:s.Maneuver.None},q);return GRUNT.extend(q,{})},RouteData:function(q){q=GRUNT.extend({geometry:[],
