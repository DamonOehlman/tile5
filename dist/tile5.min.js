...
(function(){function p(q){return q<10?"0"+q:q}function f(q){d.lastIndex=0;return d.test(q)?'"'+q.replace(d,function(g){var o=h[g];return typeof o==="string"?o:"\\u"+("0000"+g.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+q+'"'}function a(q,g){var o,k,n,s,t=e,m,u=g[q];if(u&&typeof u==="object"&&typeof u.toJSON==="function")u=u.toJSON(q);if(typeof r==="function")u=r.call(g,q,u);switch(typeof u){case "string":return f(u);case "number":return isFinite(u)?String(u):"null";case "boolean":case "null":return String(u);
case "object":if(!u)return"null";e+=l;m=[];if(Object.prototype.toString.apply(u)==="[object Array]"){s=u.length;for(o=0;o<s;o+=1)m[o]=a(o,u)||"null";n=m.length===0?"[]":e?"[\n"+e+m.join(",\n"+e)+"\n"+t+"]":"["+m.join(",")+"]";e=t;return n}if(r&&typeof r==="object"){s=r.length;for(o=0;o<s;o+=1){k=r[o];if(typeof k==="string")if(n=a(k,u))m.push(f(k)+(e?": ":":")+n)}}else for(k in u)if(Object.hasOwnProperty.call(u,k))if(n=a(k,u))m.push(f(k)+(e?": ":":")+n);n=m.length===0?"{}":e?"{\n"+e+m.join(",\n"+e)+
...
d=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,e,l,h={"\u0008":"\\b","\t":"\\t","\n":"\\n","\u000c":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},r;if(typeof JSON.stringify!=="function")JSON.stringify=function(q,g,o){var k;l=e="";if(typeof o==="number")for(k=0;k<o;k+=1)l+=" ";else if(typeof o==="string")l=o;if((r=g)&&typeof g!=="function"&&(typeof g!=="object"||typeof g.length!=="number"))throw Error("JSON.stringify");return a("",
{"":q})};if(typeof JSON.parse!=="function")JSON.parse=function(q,g){function o(n,s){var t,m,u=n[s];if(u&&typeof u==="object")for(t in u)if(Object.hasOwnProperty.call(u,t)){m=o(u,t);if(m!==undefined)u[t]=m;else delete u[t]}return g.call(n,s,u)}var k;q=String(q);b.lastIndex=0;if(b.test(q))q=q.replace(b,function(n){return"\\u"+("0000"+n.charCodeAt(0).toString(16)).slice(-4)});if(/^[\],:{}\s]*$/.test(q.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
"]").replace(/(?:^|:|,)(?:\s*\[)+/g,""))){k=eval("("+q+")");return typeof g==="function"?o({"":k},""):k}throw new SyntaxError("JSON.parse");}})();if(!String.format)String.format=function(p){if(arguments.length<=1)return p;for(var f=arguments.length-2,a=0;a<=f;a++)p=p.replace(RegExp("\\{"+a+"\\}","gi"),arguments[a+1]);return p};
...
GRUNT=function(){var p=Object.prototype.hasOwnProperty,f=0,a={id:"GRUNT.core",extend:function(){var b=arguments[0]||{},d=1,e=arguments.length,l=false,h,r,q,g;if(typeof b==="boolean"){l=b;b=arguments[1]||{};d=2}if(typeof b!=="object"&&!a.isFunction(b))b={};if(e===d){b=this;--d}for(;d<e;d++)if((h=arguments[d])!=null)for(r in h){q=b[r];g=h[r];if(b!==g)if(l&&g&&(a.isPlainObject(g)||a.isArray(g))){q=q&&(a.isPlainObject(q)||a.isArray(q))?q:a.isArray(g)?[]:{};b[r]=a.extend(l,q,g)}else if(g!==undefined)b[r]=
...
"[object Document]"},contains:function(b,d){var e=b,l=arguments,h=1;if(d&&a.isArray(d)){l=d;h=0}for(h=h;h<l;h++)e=e&&typeof foo[l[h]]!=="undefined";return e},newModule:function(b){b=a.extend({id:null,requires:[],parent:null},b);if(b.parent)b=a.extend({},b.parent,b);return b},toID:function(b){return b.replace(/\s/g,"-")},generateObjectID:function(b){return(b?b:"obj")+f++}};return a}();
GRUNT.Log=function(){function p(e,l){var h,r=l&&l.length>0?l[0]:"";for(h=1;l&&h<l.length;h++)r+=" "+(a&&GRUNT.isPlainObject(l[h])?JSON.stringify(l[h]):l[h]);typeof console!=="undefined"&&console[e](r);for(h=0;h<f.length;h++)f[h].call(d,r,e)}var f=[],a=typeof JSON!=="undefined",b=window.console&&window.console.markTimeline,d={id:"GRUNT.log",getTraceTicks:function(){return b?(new Date).getTime():null},trace:function(e,l){if(b)console.markTimeline(e+(l?": "+(d.getTraceTicks()-l)+"ms":""))},debug:function(){p("debug",
arguments)},info:function(){p("info",arguments)},warn:function(){p("warn",arguments)},error:function(){p("error",arguments)},exception:function(e){d.error(arguments);for(var l in e)d.info("ERROR DETAIL: "+l+": "+e[l])},watch:function(e,l){try{l()}catch(h){d.exception(h,e)}},throwError:function(e){d.error(e);throw Error(e);},requestUpdates:function(e){f.push(e)}};return d}();
GRUNT.Data=function(){var p={determineObjectMapping:function(a){if(!a)return null;a=a.split("|");for(var b={},d=0;d<a.length;d++)b[a[d]]=d;return b},mapLineToObject:function(a,b){var d=a.split("|"),e={};for(var l in b){var h=b[l];e[l]=d.length>h?d[h]:null}return e},parse:function(a){var b=null,d=[];a=a.split("\n");for(var e=0;e<a.length;e++){var l=a[e];if(b)d.push(p.mapLineToObject(l,b));else b=p.determineObjectMapping(l)}return d}},f={supportedFormats:{JSON:{parse:function(a){return JSON.parse(a)}},
...
GRUNT.JSONP=function(){function p(d){var e=document.createElement("script"),l=false;e.src=d;e.async=true;e.onload=e.onreadystatechange=function(){if(!l&&(!this.readyState||this.readyState==="loaded"||this.readyState==="complete")){l=true;e.onload=e.onreadystatechange=null;e&&e.parentNode&&e.parentNode.removeChild(e)}};a||(a=document.getElementsByTagName("head")[0]);a.appendChild(e)}var f=0,a,b=this;return{get:function(d,e,l){d+=d.indexOf("?")>=0?"&":"?";var h="json"+ ++f;b[h]=function(r){e(r);b[h]=
null;try{delete b[h]}catch(q){}};p(d+(l?l:"callback")+"="+h);return h}}}();
...
e={CONTENT_TYPE:"Content-Type"},l=GRUNT.newModule({id:"GRUNT.xhr",ajaxSettings:{xhr:null},ajax:function(h){try{h=GRUNT.extend({method:"GET",data:null,url:null,async:true,success:null,handleResponse:null,error:null,contentType:"application/x-www-form-urlencoded"},l.ajaxSettings,h);var r=b.exec(h.url),q=r&&(r[1]&&r[1]!==location.protocol||r[2]!==location.host);if(h.data)h.method="POST";if(h.url){r=null;if(h.xhr)r=h.xhr(h);r||(r=new XMLHttpRequest);r.open(h.method,h.url,h.async);h.data&&r.setRequestHeader("Content-Type",
h.contentType);q||r.setRequestHeader("X-Requested-With","XMLHttpRequest");r.onreadystatechange=function(){if(this.readyState===4){var o=null,k=!this.status&&location.protocol==="file:"||this.status>=200&&this.status<300||this.status===304||this.status===1223||this.status===0;try{if(k)if(h.handleResponse)h.handleResponse(this);else{var n=h,s=this.getResponseHeader(e.CONTENT_TYPE),t,m=false;for(t in p)if(s&&s.indexOf(p[t])>=0){m=true;break}s=!m;for(m=0;m<a.length;m++)s=s||a[m]==t;if(s)b:{s=t;for(var u in f)for(m=
0;m<f[u].length;m++)if(RegExp(f[u][m]+"$","i").test(n.url)){t=u;break b}t=s?s:"DEFAULT"}try{o=d[t](this,n)}catch(v){GRUNT.Log.warn("error applying processor '"+t+"' to response type, falling back to default");o=d.DEFAULT(this,n)}}else h.error&&h.error(this)}catch(w){GRUNT.Log.exception(w,"PROCESSING AJAX RESPONSE")}k&&o&&h.success&&h.success.call(this,o)}};r.send(h.method=="POST"?l.param(h.data):null)}else GRUNT.Log.warn("ajax request issued with no url - that ain't going to work...")}catch(g){GRUNT.Log.exception(g)}},
param:function(h){var r=[],q=function(o,k){k=GRUNT.isFunction(k)?k():k;r[r.length]=encodeURIComponent(o)+"="+encodeURIComponent(k)};if(GRUNT.isArray(h))for(var g=0;g<h.length;g++)q(h[g].name,h[g].value);else for(g in h)q(g,h[g]);return r.join("&").replace(/%20/g,"+")}});return l}();
GRUNT.XPath=function(){function p(d){for(var e=null,l=0;l<f.length;l++)if(e=f[l](d))break;return e}var f=[],a=[null,function(d){return d.numberValue},function(d){return d.stringValue},function(d){return d.booleanValue},null,null,null,null,function(d){return d.singleNodeValue?d.singleNodeValue.textContent:null},function(d){return d.singleNodeValue?d.singleNodeValue.textContent:null}];typeof XPathResult!=="undefined"||GRUNT.Log.warn("No XPATH support, this is going to cause problems");var b={SearchResult:function(d){return{toString:function(){var e=
null;if(d){var l=null;if(d.resultType>=0&&d.resultType<a.length)l=a[d.resultType];if(l){GRUNT.Log.info("invoking match handler for result type: "+d.resultType);e=l(d)}}return e?e:""}}},first:function(d,e){var l=b.SearchResult,h;var r=XPathResult.FIRST_ORDERED_NODE_TYPE;if(!r)r=XPathResult.ANY_TYPE;try{if(GRUNT.isXmlDocument(e))h=e.evaluate(d,e,p,r,null);else{GRUNT.Log.warn("attempted xpath expression: "+d+" on a non-xml document");h=null}}catch(q){GRUNT.Log.warn("attempted to run invalid xpath expression: "+
d+" on node: "+e);h=null}return new l(h)},registerResolver:function(d){f.push(d)}};return b}();GRUNT.Observable=function(){var p={},f=0,a={bind:function(b,d){p[b]||(p[b]=[]);f+=1;p[b].push({callback:d,callbackId:f});return f},trigger:function(b){var d=p[b];if(d)for(var e=d.length;e--;)d[e].callback.apply(a,Array.prototype.slice.call(arguments,1))},unbind:function(b,d){for(var e=p[b],l=0;e&&l<e.length;l++)if(e[l].callbackId===d){e.splice(l,1);break}}};return a};
...
for(var b={edges:Array(a.length-1),accrued:Array(a.length-1),total:0},d=T5.V.diff,e=0;e<a.length-1;e++){var l=d(a[e],a[e+1]);b.edges[e]=Math.sqrt(l.x*l.x+l.y*l.y);b.accrued[e]=b.total+b.edges[e];b.total+=b.edges[e]}return b}return{create:function(a,b){return new p.Vector(a,b)},add:function(){for(var a=new p.Vector,b=arguments.length;b--;){a.x+=arguments[b].x;a.y+=arguments[b].y}return a},absSize:function(a){return Math.max(Math.abs(a.x),Math.abs(a.y))},diff:function(a,b){return new p.Vector(a.x-b.x,
...
T5.Device=function(){function p(){for(;g.length>0;){var k=g.shift();document.location=k}q=0}function f(k){for(var n=true,s=o.length;s--;)n=n&&k!=o[s];return n}function a(k,n){var s=[];for(var t in n)t&&s.push(t+"="+escape(n[t]));return"tile5://"+k+"/"+(s.length>0?"?"+s.join("&"):"")}function b(k,n){f(k)&&GRUNT.Log.info("would push url: "+a(k,n))}function d(k,n){if(f(k)){g.push(a(k,n));q||(q=setTimeout(p,100))}}function e(){l={base:{name:"Unknown",eventTarget:document,supportsTouch:"createTouch"in
...
supportsTouch:true,getScaling:function(){return 1/window.devicePixelRatio},bridgeNotify:d},froyo:{name:"Android OS >= 2.2",regex:/froyo/i,eventTarget:document.body,supportsTouch:true,bridgeNotify:d}};h=[l.froyo,l.android,l.ipod,l.iphone,l.ipad]}var l=null,h=[],r=null,q=0,g=[],o=["view.wake","tile.loaded"];return{getConfig:function(){l||e();if(!r){GRUNT.Log.info("ATTEMPTING TO DETECT PLATFORM: UserAgent = "+navigator.userAgent);for(var k=0;k<h.length;k++){var n=h[k];if(n.regex&&n.regex.test(navigator.userAgent)){r=
GRUNT.extend({},l.base,n);GRUNT.Log.info("PLATFORM DETECTED AS: "+r.name);break}}if(!r){GRUNT.Log.warn("UNABLE TO DETECT PLATFORM, REVERTING TO BASE CONFIGURATION");r=l.base}GRUNT.Log.info("CURRENT DEVICE PIXEL RATIO = "+window.devicePixelRatio)}return r}}}();
T5.Resources=function(){var p="",f={},a=function(){function d(){var v=q[this.id];if(v&&v.image.complete&&v.image.width>0){v.loaded=true;v.hitCount=1;for(var w=k.length;w--;)if(k[w].image.src==this.src){k.splice(w,1);break}v.loadCallback&&v.loadCallback(this,false);n.push({url:this.src,created:v.requested});delete q[this.id];e()}}function e(){for(var v=T5.Device.getConfig().maxImageLoads;o.length>0&&(!v||k.length<v);){var w=o.shift();if(w.imageLoader){k.push(w);w.imageLoader(w,d)}}}function l(v){for(var w=
null,x=s.length;x--&&!w;)w=s[x](v);return w?w:function(A,C){A.image.onload=C;A.image.src=b.getPath(A.url);A.requested=T5.time()}}function h(){m=true;try{var v=Math.floor(n.length/2);if(v>0){n.sort(function(x,A){return x.created-A.created});for(var w=v;w--;)delete r[n[w].url];n.splice(0,v)}}finally{m=false}GRUNT.WaterCooler.say("imagecache.cleared")}var r={},q={},g=0,o=[],k=[],n=[],s=[],t=0,m=false,u={loadingImages:k,queuedImages:o,addInterceptor:function(v){s.push(v)},getCacheFullness:function(){return t},
getImage:function(v){var w=null;m||(w=r[v]);return w?w.image:null},loadImage:function(v,w){var x=r[v];if(x){x.hitCount++;x.image.complete&&w&&w(x.image,true)}else{x={url:v,image:new Image,loaded:false,imageLoader:l(v),created:T5.time(),requested:null,hitCount:0,loadCallback:w};x.image.id="resourceLoaderImage"+g++;r[v]=x;q[x.image.id]=x;o.push(x);e()}return x},resetLoadingQueue:function(){k=[]}};setInterval(function(){for(var v=T5.time(),w=false,x=0,A=T5.Device.getConfig();x<k.length;)if(v-k[x].requested>
b.loadTimeout*1E3){k.splice(x,1);w=true}else x++;w&&e();if(A&&A.imageCacheMaxSize){t=n.length*b.avgImageSize/A.imageCacheMaxSize;t>=1&&h()}},1E3);return u}(),b={avgImageSize:25,loadTimeout:10,Cache:function(){return{read:function(){return null},write:function(){},getUrlCacheKey:function(d,e){for(var l=(d?d.replace(/^.*\?/,""):"").split("&"),h=d?d.replace(/\?.*$/,"?"):"",r=0;r<l.length;r++){var q=l[r].split("=");if(!e||!e.test(q[0]))h+=l[r]+"&"}return h.replace(/\W/g,"")},isValidCacheKey:function(d){GRUNT.Log.info("cache key = "+
...
callback:null},d);var e=function(l){d.callback&&GRUNT.Log.watch("CALLING RESOURCE CALLBACK",function(){d.callback(l)})};d.cacheable&&f[d.filename]?e(f[d.filename]):GRUNT.XHR.ajax({url:b.getPath(d.filename),dataType:d.dataType,success:function(l){if(d.cacheable)f[d.filename]=l;e(l)},error:function(l,h,r){GRUNT.Log.error("error loading resource ["+d.filename+"], error = "+r)}})},loadSnippet:function(d,e){/\.\w+$/.test(d)||(d+=".html");b.loadResource({filename:"snippets/"+d,callback:e,dataType:"html"})}};
return b}();
T5.Touch=function(){function p(n,s){var t=n&&n.length>0?n[0]:null;if(t&&s&&s.length>0)return T5.V.diff(t,s[0]);return null}function f(n){n.preventDefault();n.stopPropagation()}function a(n){for(var s=Array(n.length),t=n.length;t--;)s[t]=new T5.Vector(n[t].pageX,n[t].pageY);return s}function b(n){return[new T5.Vector(n.pageX,n.pageY)]}var d=120,e=100,l=250,h={TAP:0,MOVE:1,PINCHZOOM:2},r=7,q=0,g=0,o={TouchHelper:function(n){function s(z,D,G,J){var S=Math.asin((z.y-D.y)/G);G=Math.min(Math.floor(G*(W.duration/
J)),W.max);S=D.x>z.x?S:Math.PI-S;z=new T5.Vector(Math.cos(S)*-G,Math.sin(S)*G);u("inertiaPan",z.x,z.y)}function t(z,D){var G,J;if(F){G=D-X;if(G<l){J=T5.V.distance([M[0],z]);J>n.inertiaTrigger&&s(M[0],z,J,G)}}else{Z=z;var S=setInterval(function(){G=T5.time()-D;J=T5.V.distance([z,Z]);if(G<e&&J>n.inertiaTrigger){clearInterval(S);s(z,Z,J,G)}else G>e&&clearInterval(S)},5)}}function m(z){for(var D=[],G=n.element?-n.element.offsetLeft:0,J=n.element?-n.element.offsetTop:0,S=z.length;S--;)D.push(T5.V.offset(z[S],
...
max:D?Math.min(D.width,D.height):500}},inertiaDisable:function(){W=null}};Q.eventTarget.addEventListener(Q.supportsTouch?"touchstart":"mousedown",v,false);Q.eventTarget.addEventListener(Q.supportsTouch?"touchmove":"mousemove",w,false);Q.eventTarget.addEventListener(Q.supportsTouch?"touchend":"mouseup",x,false);if(!Q.supportsTouch){window.addEventListener("mousewheel",A,false);window.addEventListener("DOMMouseScroll",A,false)}return L}},k=[];return{captureTouch:function(n,s){if(!n)throw Error("Unable to capture touch of null element");
if(!n.id)n.id="touchable_"+q++;var t=k[n.id];if(!t){t=o.TouchHelper(GRUNT.extend({element:n},s));k[n.id]=t;GRUNT.Log.info("CREATED TOUCH HELPER. SUPPORTS TOUCH = "+t.supportsTouch)}s.listenerId&&t.decoupleListeners(s.listenerId);s.listenerId=++g;t.addListeners(s);return t},resetTouch:function(n){if(n&&n.id&&k[n.id]){k[n.id].release();delete k[n.id]}}}}();
...
getParam:function(e){return a[e]},getId:function(){return GRUNT.toID(d.getName())},run:function(e,l){if(a.execute){var h=b=T5.time(),r=a.translator?a.translator(e):e;a.execute.call(d,r,function(q,g){if(!a.trashOrphanedResults||h==b)l&&l(q,g,r)})}}};return d},runAgents:function(a,b,d){for(var e=0;e<a.length;e++)a[e].run(b,d)}};return f}();
...
2.75?b*(7.5625*(f-=2.25/2.75)*f+0.9375)+a:b*(7.5625*(f-=2.625/2.75)*f+0.984375)+a},InOut:function(f,a,b,d){return f<d/2?module.Easing.Bounce.In(f*2,0,b,d)/2+a:module.Easing.Bounce.Out(f*2-d,0,b,d)/2+b/2+a}},Cubic:{In:function(f,a,b,d){return b*(f/=d)*f*f+a},Out:function(f,a,b,d){return b*((f=f/d-1)*f*f+1)+a},InOut:function(f,a,b,d){if((f/=d/2)<1)return b/2*f*f*f+a;return b/2*((f-=2)*f*f+2)+a}},Elastic:{In:function(f,a,b,d,e,l){if(f==0)return a;if((f/=d)==1)return a+b;l||(l=d*0.3);if(!e||e<Math.abs(b)){e=
b;b=l/4}else b=l/(2*Math.PI)*Math.asin(b/e);return-(e*Math.pow(2,10*(f-=1))*Math.sin((f*d-b)*2*Math.PI/l))+a},Out:function(f,a,b,d,e,l){var h;if(f==0)return a;if((f/=d)==1)return a+b;l||(l=d*0.3);if(!e||e<Math.abs(b)){e=b;h=l/4}else h=l/(2*Math.PI)*Math.asin(b/e);return e*Math.pow(2,-10*f)*Math.sin((f*d-h)*2*Math.PI/l)+b+a},InOut:function(f,a,b,d,e,l){var h;if(f==0)return a;if((f/=d/2)==2)return a+b;l||(l=d*0.3*1.5);if(!e||e<Math.abs(b)){e=b;h=l/4}else h=l/(2*Math.PI)*Math.asin(b/e);if(f<1)return-0.5*
e*Math.pow(2,10*(f-=1))*Math.sin((f*d-h)*2*Math.PI/l)+a;return e*Math.pow(2,-10*(f-=1))*Math.sin((f*d-h)*2*Math.PI/l)*0.5+b+a}},Quad:{In:function(f,a,b,d){return b*(f/=d)*f+a},Out:function(f,a,b,d){return-b*(f/=d)*(f-2)+a},InOut:function(f,a,b,d){if((f/=d/2)<1)return b/2*f*f+a;return-b/2*(--f*(f-2)-1)+a}},Sine:{In:function(f,a,b,d){return-b*Math.cos(f/d*(Math.PI/2))+b+a},Out:function(f,a,b,d){return b*Math.sin(f/d*(Math.PI/2))+a},InOut:function(f,a,b,d){return-b/2*(Math.cos(Math.PI*f/d)-1)+a}}}}();
T5.Animation=function(){function p(){if(b===0)b=setInterval(function(){var e;e=T5.time();if(!a){a=true;try{for(var l=0;l<f.length;)if(f[l].isComplete()){f[l].triggerComplete(false);f.splice(l,1)}else{f[l].update(e);l++}}finally{a=false}}e=f.length;if(e===0){clearInterval(b);b=0}},20)}var f=[],a=false,b=0,d={DURATION:2E3,tweenValue:function(e,l,h,r,q){e=new d.Tween({startValue:e,endValue:l,tweenFn:h,complete:r,duration:q});f.push(e);return e},tween:function(e,l,h,r,q,g){e=new d.Tween({target:e,property:l,
endValue:h,tweenFn:r,duration:g,complete:q});f.push(e);return e},tweenVector:function(e,l,h,r,q,g){var o=[];if(e){var k=e.x==l,n=e.y==h;k||o.push(d.tween(e,"x",l,r,function(){(k=true)&&n&&q()},g));n||o.push(d.tween(e,"y",h,r,function(){n=true;k&&n&&q()},g))}return o},cancel:function(e){if(!a){a=true;try{for(var l=0;l<f.length;)if(!e||e(f[l])){f[l].triggerComplete(true);f.splice(l,1)}else l++}finally{a=false}}},isTweening:function(){return f.length>0},Tween:function(e){e=GRUNT.extend({target:null,
property:null,startValue:0,endValue:null,duration:d.DURATION,tweenFn:d.DEFAULT,complete:null,cancelOnInteract:false},e);var l=T5.time(),h=[],r=false,q=0,g=0,o={cancelOnInteract:e.cancelOnInteract,isComplete:function(){return r},triggerComplete:function(k){e.complete&&e.complete(k)},update:function(k){try{var n=e.tweenFn(k-l,q,g,e.duration);if(e.target)e.target[e.property]=n;for(var s=h.length;s--;)h[s](n,void 0);if(r=l+e.duration<=k){if(e.target)e.target[e.property]=e.tweenFn(e.duration,q,g,e.duration);
for(var t=h.length;t--;)h[t](n,true)}}catch(m){GRUNT.Log.exception(m)}},requestUpdates:function(k){h.push(k)}};q=e.target&&e.property&&e.target[e.property]?e.target[e.property]:e.startValue;if(typeof e.endValue!=="undefined")g=e.endValue-q;if(g==0)r=true;p();return o}};return GRUNT.extend(d,{DEFAULT:T5.Easing.Back.Out})}();
...
k.push(B);k.sort(function(E,I){var R=I.zindex-E.zindex;if(R===0)R=I.created-E.created;return R})}function l(y,B,E,I,R,ca,aa){function da(){ca&&ca();d();L=1;D=null}W=true;G=T5.V.copy(E);F=T5.V.copy(I);U=null;if(R)T5.Animation.tweenValue(0,B-y,R,da,aa?aa:1E3).requestUpdates(function(ba){D=ba/(B-y);L=y+ba;J=T5.ViewState.PINCHZOOM;o();H.trigger("animate")});else{L=targetScaleFactor;da()}}function h(){var y=T5.D.getCenter(x),B=T5.V.distance([F,y]),E=T5.V.theta(F,y,B),I=T5.V.diff(G,F);y=T5.V.pointOnEdge(F,
y,E,B/L);y.x+=I.x;y.y+=I.y;return y}function r(){H.trigger("idle");M=true;N=0}function q(y,B){var E=0,I=H.getDisplayState(),R=T5.time(),ca=(I&T5.ViewState.PINCHZOOM)!==0,aa=0;if(m||ca){y.clearRect(0,0,n.width,n.height);m=false}if(ca){T5.D.getCenter(x);var da=(D?D:1)/2,ba=T5.V.diff(G,F);if(Y=U?new T5.Vector(F.x+ba.x,F.y+ba.y):new T5.Vector(F.x-ba.x*da,F.y-ba.y*da))B=T5.V.offset(B,Y.x,Y.y)}y.save();try{z=L;if(w!==1)y.scale(w,w);else if(ca){y.translate(F.x,F.y);y.scale(L,L)}for(aa=k.length;aa--;)if(k[aa].shouldDraw(I)){var ea=
k[aa].draw(y,B,x,I,H);E+=ea?ea:0}}finally{y.restore()}GRUNT.Log.trace("draw complete",R);V=false;return E}function g(){var y=0,B=!P&&(J===T5.ViewState.PINCHZOOM||J===T5.ViewState.PAN);X=T5.time();t.x=Math.floor(t.x);t.y=Math.floor(t.y);K&&u&&K.delays.push(X-u);if(B){T5.Animation.cancel(function(I){return I.cancelOnInteract});M=false;if(N!==0){clearTimeout(N);N=0}}for(B=k.length;B--;){var E=k[B].cycle(X,t,J);y+=E?E:0}if(u+Z<X){y+=q(s,t);u=X}O=0;if(C+y>0)o();else if(!M&&N===0)N=setTimeout(r,500);GRUNT.Log.trace("Completed draw cycle",
X)}function o(){C++;if(!(v||O!==0)){C=0;O=setTimeout(g,0)}}p=GRUNT.extend({id:GRUNT.generateObjectID("view"),container:"",clearOnDraw:false,scaleDamping:false,fastDraw:false,fillStyle:"rgb(200, 200, 200)",initialDrawMode:"source-over",bufferRefresh:100,defaultFreezeDelay:500,inertialScroll:true,panAnimationEasing:T5.Easing.Sine.Out,panAnimationDuration:750,pinchZoomAnimateTrigger:400,adjustScaleFactor:null,autoSize:false},p);var k=[],n=document.getElementById(p.container),s=null,t=new T5.Vector,m=
...
}}var H=GRUNT.extend({},p,new GRUNT.Observable,{id:p.id,deviceScaling:w,fastDraw:p.fastDraw||T5.Device.getConfig().requireFastDraw,animate:function(y,B,E,I,R){l(L,y,B,E,I,R)},centerOn:function(y){H.setOffset(y.x-n.width/2,y.y-n.height/2)},getDimensions:function(){if(n)return new T5.Dimensions(n.width,n.height)},getZoomCenter:function(){return Y},getLayer:function(y){for(var B=0;B<k.length;B++)if(k[B].getId()==y)return k[B];return null},setLayer:function(y,B){for(var E=0;E<k.length;E++)if(k[E].getId()===
y){k.splice(E,1);break}B&&e(y,B);GRUNT.WaterCooler.say("layer.update",{id:y});o()},eachLayer:function(y){for(var B=0;B<k.length;B++)y(k[B])},clearBackground:function(){m=true},freeze:function(){v=true},unfreeze:function(){v=false;o()},needRepaint:function(){return V},snapshot:function(){},getDisplayState:function(){return v?T5.ViewState.FROZEN:J},scale:function(y,B,E,I,R){I||(I=T5.D.getCenter(x));R||(R=T5.D.getCenter(x));H.animate(y,I,R,B,E);return H},removeLayer:function(y){a:{for(var B=k.length;B--;)if(k[B].getId()==
y){y=B;break a}y=-1}if(y>=0&&y<k.length){GRUNT.WaterCooler.say("layer.removed",{layer:k[y]});k.splice(y,1)}},getOffset:function(){return T5.V.copy(t)},setOffset:function(y,B){t.x=y;t.y=B},updateOffset:function(y,B,E,I){function R(){a(0,0)}if(E){y=new T5.Vector(y,B);E=T5.Animation.tweenVector(t,y.x,y.y,E,R,I);for(I=E.length;I--;){E[I].cancelOnInteract=true;E[I].requestUpdates(function(){o();p.onAnimate&&p.onAnimate(t.x,t.y)})}}else H.setOffset(y,B)},zoom:function(y,B,E){P=false;L=B;W=L!==1;G=T5.D.getCenter(H.getDimensions());
...
function(y,B){b(y,B);if(W=L!==1){J=T5.ViewState.PINCHZOOM;o()}});H.bind("pinchZoomEnd",function(y,B,E){b(y,B);if(p.adjustScaleFactor){L=p.adjustScaleFactor(L);GRUNT.Log.info("scale factor adjusted to: "+L)}if(E<p.pinchZoomAnimateTrigger){l(z,L,G,h(),T5.Easing.Sine.Out,function(){d();L=1},300);L=z}else{d();L=1}});H.bind("wheelZoom",function(y,B){H.zoom(y,Math.min(Math.pow(2,Math.round(Math.log(B))),8),500)});p.inertialScroll&&A.inertiaEnable(p.panAnimationDuration,x);H.bind("inertiaPan",function(y,
B){p.inertialScroll&&f(y,B,p.panAnimationEasing,p.panAnimationDuration)});H.bind("inertiaCancel",function(){P=false;o()});o();return H};
T5.AnimatedPathLayer=function(p){function f(h,r,q){h.fillStyle="#FFFFFF";h.strokeStyle="#222222";h.beginPath();h.arc(q.x,q.y,4,0,Math.PI*2,false);h.stroke();h.fill()}p=GRUNT.extend({path:[],id:GRUNT.generateObjectID("pathAnimation"),easing:T5.Easing.Sine.InOut,validStates:T5.ViewState.get("ACTIVE","PAN","PINCHZOOM"),drawIndicator:null,duration:2E3,autoCenter:false},p);var a=T5.V.edges(p.path),b,d=null,e=0;T5.Animation.tweenValue(0,a.total,p.easing,function(){l.remove()},p.duration).requestUpdates(function(h,
r){e=h;r&&l.remove()});var l=GRUNT.extend(new T5.ViewLayer(p),{cycle:function(){for(var h=0;h<a.accrued.length&&a.accrued[h]<e;)h++;d=null;if(h<p.path.length-1){var r=e-(h>0?a.accrued[h-1]:0),q=p.path[h],g=p.path[h+1];b=T5.V.theta(q,g,a.edges[h]);d=T5.V.pointOnEdge(q,g,b,r);if(p.autoCenter)(h=l.getParent())&&h.centerOn(d)}return d?1:0},draw:function(h,r){if(d)(p.drawIndicator?p.drawIndicator:f)(h,r,new T5.Vector(d.x-r.x,d.y-r.y),b)}});return l};
T5.Tiling=function(){function p(){if(!a){a=T5.newCanvas(d.Config.TILESIZE,d.Config.TILESIZE);var e=a.getContext("2d");e.fillStyle="rgba(150, 150, 150, 0.01)";e.fillRect(0,0,a.width,a.height)}return a}function f(){function e(){var h=T5.newCanvas(32,32),r=h.getContext("2d");r.fillStyle="#BBBBBB";r.fillRect(0,0,32,32);r.fillStyle="#C3C3C3";r.fillRect(0,0,16,16);r.fillRect(16,16,16,16);return h}if(!b){b=T5.newCanvas(d.Config.TILESIZE,d.Config.TILESIZE);var l=b.getContext("2d");l.fillStyle=l.createPattern(e(),
"repeat");l.fillRect(0,0,b.width,b.height)}return b}TileStore=function(e){e=GRUNT.extend({tileSize:null,gridSize:25,center:new T5.Vector,onPopulate:null},e);if(!e.tileSize)throw Error("Cannot create TileStore with an empty tile size");var l=Array(Math.pow(e.gridSize,2)),h=T5.V.offset(e.center,-Math.ceil(e.gridSize>>1)),r=null,q=new T5.Vector,g=null,o={getGridSize:function(){return e.gridSize},getNormalizedPos:function(k,n){return T5.V.add(new T5.Vector(k,n),T5.V.invert(h),q)},getTileShift:function(){return T5.V.copy(q)},
getTile:function(k,n){return k>=0&&k<e.gridSize?l[n*e.gridSize+k]:null},setTile:function(k,n,s){l[n*e.gridSize+k]=s},populate:function(k,n){var s=GRUNT.Log.getTraceTicks(),t=0,m=e.gridSize,u=e.tileSize;new T5.Vector(m/2,m/2);if(k)for(var v=0;v<m;v++)for(var w=0;w<m;w++){if(!l[t]){var x=k(w,v,h,m);x.gridX=w*u-q.x;x.gridY=v*u-q.y;l[t]=x}t++}r=k;g=n;GRUNT.Log.trace("tile grid populated",s);e.onPopulate&&e.onPopulate()},getShiftDelta:function(k,n,s,t){var m=Math.floor(e.gridSize*0.2),u=new T5.Vector;
if(k<0||k+s>e.gridSize)u.x=k<0?-m:m;if(n<0||n+t>e.gridSize)u.y=n<0?-m:m;return u},shift:function(k,n){if(!(k.x===0&&k.y===0)){var s=GRUNT.Log.getTraceTicks(),t=Array(l.length);t.length=l.length;for(var m=0;m<e.gridSize;m++)for(var u=0;u<e.gridSize;u++)t[u*e.gridSize+m]=o.getTile(m+k.x,u+k.y);l=t;h=n?n(h,k):T5.V.add(h,k);q.x+=-k.x*e.tileSize;q.y+=-k.y*e.tileSize;GRUNT.Log.trace("tile storage shifted",s);o.populate(r,g)}},setOrigin:function(k,n){if(tileOrigin)shiftOrigin(k,n);else h=T5.V.offset(new T5.Vector(k,
n),-tileHalfWidth)}};GRUNT.WaterCooler.listen("imagecache.cleared",function(){for(var k=l.length;k--;)if(l[k])l[k].loaded=false});GRUNT.WaterCooler.listen("tiler.repaint",function(){for(var k=l.length;k--;)if(l[k]){l[k].x=null;l[k].y=null}});return o};var a=null,b=null,d={Config:{TILESIZE:256,TILEBUFFER:1,TILEBUFFER_LOADNEW:0.2},Tile:function(e){return e=GRUNT.extend({gridX:0,gridY:0,size:256,dirty:false},e)},ImageTile:function(e){e=GRUNT.extend({url:"",sessionParamRegex:null,loaded:false},e);return new d.Tile(e)},
TileGrid:function(e){function l(x,A){if(v){var C,K=[],F=new T5.Vector(Math.floor((x.x+s.x)*q),Math.floor((x.y+s.y)*q));tilesNeeded=false;for(var M=u;M--;)for(var P=m;P--;){C=h.getTile(P+F.x,M+F.y);var O=new T5.Vector(P-v.x,M-v.y);C||(n=h.getShiftDelta(F.x,F.y,m,u));K.push({tile:C,centerness:T5.V.absSize(O)})}K.sort(function(V,N){return N.centerness-V.centerness});o||(o=Array(K.length));for(C=K.length;C--;){o[C]=K[C].tile;w.prepTile(o[C],A)}}}e=GRUNT.extend({tileSize:T5.Tiling.Config.TILESIZE,drawGrid:false,
center:new T5.Vector,shiftOrigin:null,supportFastDraw:true},e);var h=new TileStore(GRUNT.extend({tileSize:e.tileSize,onPopulate:function(){w.dirty=true;w.wakeParent()}},e)),r=Math.round(e.tileSize/2),q=e.tileSize?1/e.tileSize:0,g=true,o=null,k=false;new T5.Vector;var n=new T5.Vector,s=new T5.Vector;T5.Device.getConfig();var t=h.getGridSize()*e.tileSize,m,u,v,w=GRUNT.extend(new T5.ViewLayer(e),{gridDimensions:new T5.Dimensions(t,t),dirty:false,cycle:function(x,A,C){x=0;if(n.x+n.y!==0){h.shift(n,e.shiftOrigin);
s=h.getTileShift();n=new T5.Vector;x++}C!==T5.ViewState.PINCHZOOM&&l(A,C);return x+w.dirty?1:0},deactivate:function(){g=false},prepTile:function(){},drawTile:function(){return false},draw:function(x,A,C,K,F){if(g){var M=T5.time(),P=A.x;A=A.y;var O=true,V=F.needRepaint()||K===T5.ViewState.PANNING||K===T5.ViewState.PINCHZOOM||T5.Animation.isTweening();if(!v){m=Math.ceil(C.width*q)+1;u=Math.ceil(C.height*q)+1;v=new T5.Vector(Math.floor((m-1)/2),Math.floor((u-1)/2))}if(o){if(e.drawGrid)x.strokeStyle=
"rgba(50, 50, 50, 0.3)";x.beginPath();for(C=o.length;C--;){var N=o[C];if(N){var T=N.gridX-P,Y=N.gridY-A;O=((V?false:!N.dirty)?true:w.drawTile(x,N,T,Y,K))&&O}else O=false;e.drawGrid&&x.rect(T,Y,e.tileSize,e.tileSize)}x.stroke();GRUNT.Log.trace("drawn tiles",M);O&&!k&&F.trigger("tileDrawComplete");k=O;w.dirty=false}}},getTileVirtualXY:function(x,A,C){x=h.getNormalizedPos(x,A);x=new T5.Vector(x.x*e.tileSize,x.y*e.tileSize);if(C){x.x+=r;x.y+=r}return x},populate:function(x){h.populate(x,function(){})}});
return w},ImageTileGrid:function(e){function l(){k.getParent().trigger("invalidate");k.dirty=true;k.wakeParent()}e=GRUNT.extend({},e);var h=p(),r=f(),q=T5.ViewState.ACTIVE,g=T5.ViewState.PAN,o=T5.Device.getConfig().requireFastDraw,k=GRUNT.extend(new d.TileGrid(e),{drawTile:function(n,s,t,m,u){var v=T5.Resources.getImage(s.url),w=false;if(v&&v.complete&&v.width>0){n.drawImage(v,t,m);s.dirty=false;w=true}else u===g?n.drawImage(r,t,m):n.drawImage(h,t,m);return w},prepTile:function(n,s){if(n)n.dirty=
true;if(n&&(!o||s===q))T5.Resources.getImage(n.url)||T5.Resources.loadImage(n.url,l)}});return k},Tiler:function(e){e=GRUNT.extend({container:"",drawCenter:false,datasources:{},tileLoadThreshold:"first"},e);var l=new T5.View(GRUNT.extend({},e,{pannable:true,scalable:true,scaleDamping:true}));GRUNT.extend(l,{getTileLayer:function(){return l.getLayer("grid0")},setTileLayer:function(h){l.setLayer("grid0",h);GRUNT.WaterCooler.say("grid.updated",{id:"grid0"})},viewPixToGridPix:function(h){var r=l.getOffset();
return new T5.Vector(h.x+r.x,h.y+r.y)},cleanup:function(){l.removeLayer("grid0")},repaint:function(){GRUNT.WaterCooler.say("tiler.repaint");l.trigger("wake")}});return l}};return d}();
T5.Geo=function(){function p(q,g){var o=null;for(var k in h)if(g){if(k==g&&h[k][q]){o=h[k];break}}else if(h[k][q]){o=h[k];break}return o}function f(q,g,o,k){var n=0;q=q.toUpperCase();for(var s in k){var t=g[s];if(t){var m=o[s];t=m?m(q,t):q.containsWord(t)?1:0;n+=t*k[s]}}return n}var a=[1.406245461070741,1.321415085624082,1.077179995861952,0.703119412486786,0.488332580888611],b=Math.PI/180,d=180/Math.PI,e=null,l={RD:"ROAD",ST:"STREET",CR:"CRESCENT",CRES:"CRESCENT",CT:"COURT",LN:"LANE",HWY:"HIGHWAY",
...
pos:null,boundingBox:null},q)},GeocodeFieldWeights:{streetDetails:50,location:50},AddressCompareFns:{},Utilities:function(){var q={dist2rad:function(g){return g/6371},lat2pix:function(g,o){var k=parseFloat(g)*2*Math.PI/360;k=Math.sin(k);var n=0.08181919084262157*k;return Math.log((1+k)/(1-k)*Math.pow((1-n)/(1+n),0.08181919084262157))/2/o},lon2pix:function(g,o){return parseFloat(g)/180*Math.PI/o},pix2lon:function(g,o){return q.normalizeLon(g*o*180/Math.PI)},pix2lat:function(g,o){for(var k=Math.pow(Math.E,
-g*o),n=q.mercatorUnproject(k),s=q.findRadPhi(n,k),t=0;t<12&&Math.abs(n-s)>1.0E-7;){n=s;s=q.findRadPhi(n,k);t++}return s*180/Math.PI},mercatorUnproject:function(g){return Math.PI/2-2*Math.atan(g)},findRadPhi:function(g,o){var k=0.08181919084262157*Math.sin(g);return Math.PI/2-2*Math.atan(o*Math.pow((1-k)/(1+k),0.040909595421310785))},normalizeLon:function(g){for(;g<-180;)g+=360;for(;g>180;)g-=360;return g}};return q}(),GeoSearchResult:function(q){q=GRUNT.extend({id:null,caption:"",resultType:"",data:null,
pos:null,matchWeight:0},q);return GRUNT.extend(q,{toString:function(){return q.caption+(q.matchWeight?" ("+q.matchWeight+")":"")}})},GeoSearchAgent:function(q){return T5.Dispatcher.createAgent(q)},GeocodingAgent:function(q){q=GRUNT.extend({name:"Geocoding Search Agent",paramTranslator:null,execute:function(g,o){try{if(!g.reverse&&!g.freeform)address=new r.Address(g);var k=r.getEngine("geocode");if(k)k.geocode({addresses:[g.freeform?g.freeform:address],complete:function(s,t){if(o){var m=t;if(g.freeform)m=
...
for(var v in n)for(var w=0;w<n[v].length;w++)if(!m||m(n[v][w]))u.push(n[v][w]);return u}function k(){GRUNT.WaterCooler.say("geo.pois-updated",{srcID:t.id,pois:t.getPOIs()})}q=GRUNT.extend({visibilityChange:null,onPOIDeleted:null,onPOIAdded:null},q);var n={},s=true,t={id:GRUNT.generateObjectID(),getPOIs:function(){return o()},getOldPOIs:function(m,u){return o(function(v){return v.group==m&&v.retrieved<u})},getVisible:function(){return s},setVisible:function(m){if(m!=s){s=m;q.visibilityChange&&q.visibilityChange()}},
findById:function(m){var u=o(function(v){return v.id==m});return u.length>0?u[0]:null},findByBounds:function(m){return o(function(u){return T5.Geo.P.inBounds(u.pos,m)})},addPOIs:function(m,u){if(u)n={};for(var v=0;m&&v<m.length;v++){m[v].retrieved=T5.time();var w=m[v];g(w.group).push(w)}},removeGroup:function(m){if(n[m]){delete n[m];k()}},update:function(m){var u=[],v=0,w=m.length>0?m[0].group:"",x=T5.time();for(v=0;v<m.length;v++){var A;a:{if(A=m[v])for(var C=g(A.group),K=0;K<C.length;K++)if(C[K].id==
A.id){A=C[K];break a}A=null}if(A){A.retrieved=x;A.isNew=false}else u.push(m[v])}m=t.getOldPOIs(w,x);t.addPOIs(u);for(v=0;q.onPOIAdded&&v<u.length;v++)q.onPOIAdded(u[v]);for(v=0;v<m.length;v++){q.onPOIDeleted&&q.onPOIDeleted(m[v]);w=m[v];x=g(w.group);for(A=0;A<x.length;A++)if(x[A].id==w.id){x.splice(A,1);break}}u.length+m.length>0&&k()}};return t},MapProvider:function(){var q=1,g=20;return{zoomLevel:0,checkZoomLevel:function(o){return Math.min(Math.max(o,q),g)},getCopyright:function(){},getLogoUrl:function(){},
getMapTiles:function(){},getPositionForXY:function(){return null},getZoomRange:function(){return{min:q,max:g}},setZoomRange:function(o,k){q=o;g=k}}},P:function(){var q={calcDistance:function(g,o){if(q.empty(g)||q.empty(o))return 0;var k=(o.lat-g.lat).toRad()/2,n=(o.lon-g.lon).toRad()/2;k=Math.sin(k)*Math.sin(k)+Math.cos(g.lat.toRad())*Math.cos(o.lat.toRad())*Math.sin(n)*Math.sin(n);return 6371*2*Math.atan2(Math.sqrt(k),Math.sqrt(1-k))},copy:function(g){return g?new r.Position(g.lat,g.lon):null},empty:function(g){return!g||
g.lat===0&&g.lon===0},equal:function(g,o){return g&&o&&g.lat==o.lat&&g.lon==o.lon},almostEqual:function(g,o){return g&&o&&Math.floor(g.lat*1E3)===Math.floor(o.lat*1E3)&&Math.floor(g.lon*1E3)===Math.floor(o.lon*1E3)},inArray:function(g,o){for(var k=r.P.equal,n=o.length;n--;)if(k(g,o[n]))return true;return false},inBounds:function(g,o){var k=!(r.P.empty(g)||r.P.empty(o));return k=(k=k&&g.lat>=o.min.lat&&g.lat<=o.max.lat)&&g.lon>=o.min.lon&&g.lon<=o.max.lon},parse:function(g){if(g)if(typeof g.lat!==
"undefined")return q.copy(g);else{if(g.split)for(var o=[" ",","],k=0;k<o.length;k++){var n=g.split(o[k]);if(n.length===2)return new r.Position(n[0],n[1])}}else return new r.Position;return null},parseArray:function(g){var o=g.length,k=Array(o);for(o=o;o--;)k[o]=q.parse(g[o]);GRUNT.Log.info("parsed "+k.length+" positions");return k},fromMercatorPixels:function(g,o,k){return new r.Position(T5.Geo.Utilities.pix2lat(o,k),T5.Geo.Utilities.normalizeLon(T5.Geo.Utilities.pix2lon(g,k)))},toMercatorPixels:function(g,
o){return new T5.Vector(T5.Geo.Utilities.lon2pix(g.lon,o),T5.Geo.Utilities.lat2pix(g.lat,o))},generalize:function(g,o,k){var n=g.length,s=[],t=null;k||(k=250);k/=1E3;GRUNT.Log.info("generalizing positions, must include "+o.length+" positions");for(var m=n;m--;)if(m===0)s.unshift(g[m]);else{var u=!t||r.P.inArray(g[m],o)?k:r.P.calcDistance(t,g[m]);if(g[m]&&u>=k){s.unshift(g[m]);t=g[m]}}GRUNT.Log.info("generalized "+n+" positions into "+s.length+" positions");return s},toString:function(g){return g?
g.lat+" "+g.lon:""}};return q}(),B:function(){var q=-(Math.PI/2),g=Math.PI/2,o=-Math.PI*2,k=Math.PI*2,n={calcSize:function(s,t,m){var u=new T5.Vector(0,t.lat-s.lat);if(typeof m==="undefined")m=true;u.x=m&&s.lon>t.lon?360-s.lon+t.lon:t.lon-s.lon;return u},createBoundsFromCenter:function(s,t){var m=t/6371,u=s.lat*b,v=s.lon*b,w=u-m,x=u+m;if(w>q&&x<g){u=Math.asin(Math.sin(m)/Math.cos(u));m=v-u;if(m<o)m+=2*Math.PI;v=v+u;if(v>k)v-=2*Math.PI}else{w=Math.max(w,q);x=Math.min(x,g);m=o;v=k}return new r.BoundingBox(new r.Position(w*
...
a[Math.min(Math.round(Math.abs(m.lat)*0.05),a.length)],v=n.calcSize(s.min,s.max);m=Math.ceil(Math.log(a[3]*t.height/v.y)/Math.log(2));u=Math.ceil(Math.log(u*t.width/v.x)/Math.log(2));return Math.min(isNaN(m)?1E3:m,isNaN(u)?1E3:u)},isEmpty:function(s){return!s||r.P.empty(s.min)||r.P.empty(s.max)},toString:function(s){return"min: "+r.P.toString(s.min)+", max: "+r.P.toString(s.max)}};return n}(),A:function(){var q=/^(\d+).*$/,g=/(\d+)\s?\-\s?(\d+)/;return{buildingMatch:function(o,k){q.lastIndex=-1;if(q.test(o))for(var n=
o.replace(q,"$1"),s=k.split(","),t=0;t<s.length;t++){g.lastIndex=-1;if(g.test(s[t])){var m=g.exec(s[t]);if(n>=parseInt(m[1],10)&&n<=parseInt(m[2],10))return true}else if(n==s[t])return true}return false},normalize:function(o){if(!o)return"";o=o.toUpperCase();if(!e){var k=[];for(var n in l)k.push(n);e=RegExp("(\\s)("+k.join("|")+")(\\s|$)","i")}e.lastIndex=-1;if(k=e.exec(o))o=o.replace(e,"$1"+l[k[2]]);return o},toString:function(o){return o.streetDetails+" "+o.location}}}(),getEngine:function(q){for(var g=
null,o=1;!g&&o<arguments.length;o++)g=p(q,arguments[o]);g=g?g:p(q);if(!g)throw Error("Unable to find GEO engine with "+q+" capability");return g},rankGeocodeResponses:function(q,g,o){var k=[],n=r.AddressCompareFns;if(o&&o.compareFns)n=GRUNT.extend({},n,o.compareFns);for(o=0;o<g.length;o++)k.push(new r.GeoSearchResult({caption:r.A.toString(g[o]),data:g[o],pos:g[o].pos,matchWeight:f(q,g[o],n,r.GeocodeFieldWeights)}));k.sort(function(s,t){return t.matchWeight-s.matchWeight});return k}};return r}();
...
b[1])/2;d[2]=(d[0]+d[1])/2;return{latitude:b,longitude:d}},encode:function(f,a,b){var d=1,e=[],l=[],h=0,r=0;b=b?b:12;geohash="";e[0]=-90;e[1]=90;l[0]=-180;for(l[1]=180;geohash.length<b;){if(d){mid=(l[0]+l[1])/2;if(a>mid){r|=BITS[h];l[0]=mid}else l[1]=mid}else{mid=(e[0]+e[1])/2;if(f>mid){r|=BITS[h];e[0]=mid}else e[1]=mid}d=!d;if(h<4)h++;else{geohash+=BASE32[r];r=h=0}}return geohash}}}();
...
T5.Geo.UI=function(){var p=0,f={AnnotationTween:null,GeoTileGrid:function(a){a=GRUNT.extend({grid:null,centerPos:new T5.Geo.Position,centerXY:new T5.Vector,radsPerPixel:0},a);var b=T5.Geo.P.toMercatorPixels(a.centerPos,a.radsPerPixel),d=b.x-a.centerXY.x,e=b.y-a.centerXY.y,l=GRUNT.extend({},a.grid,{getBoundingBox:function(h,r,q,g){return new T5.Geo.BoundingBox(l.pixelsToPos(new T5.Vector(h,r+g)),l.pixelsToPos(new T5.Vector(h+q,r)))},getGridXYForPosition:function(h){h=T5.Geo.P.toMercatorPixels(h,a.radsPerPixel);
return new T5.Vector(h.x-d,l.gridDimensions.height-(h.y-e))},getPixelDistance:function(h){h=T5.Geo.Utilities.dist2rad(h);return Math.floor(h/a.radsPerPixel)},pixelsToPos:function(h){return T5.Geo.P.fromMercatorPixels(d+h.x,e+l.gridDimensions.height-h.y,a.radsPerPixel)}});return l},RouteOverlay:function(a){a=GRUNT.extend({data:null,pixelGeneralization:8,calculationsPerCycle:250,partialDraw:false,strokeStyle:"rgba(0, 51, 119, 0.9)",waypointFillStyle:"#FFFFFF",lineWidth:4,zindex:50},a);var b=true,d=
null,e=[],l=0,h=[],r=[],q=GRUNT.extend(new T5.ViewLayer(a),{getAnimation:function(g,o,k,n){if(b)return null;var s="routeAnimation"+p++;r.push(s);return new T5.AnimatedPathLayer({id:s,path:e,zindex:a.zindex+1,easing:g?g:T5.Easing.Sine.InOut,duration:o?o:5E3,drawIndicator:k,autoCenter:n?n:false})},draw:function(g,o,k,n,s){k=0;n=a.data?a.data.geometry:null;if(b){b=false;d=null;e=[];l=0}if(n&&l<n.length){a:{s=s.getTileLayer();h=[];if(s){n=GRUNT.Log.getTraceTicks();var t,m,u,v=a.data?a.data.geometry:[],
w=v.length,x=a.data?a.data.instructions:[],A=x.length,C=a.calculationsPerCycle,K=0;for(t=l;t<w;t++){m=s.getGridXYForPosition(v[t]);if(u=!d||t===0||Math.abs(m.x-d.x)+Math.abs(m.y-d.y)>a.pixelGeneralization){e.push(m);d=m}K++;if(K>=C){l=t;break a}}l=w;GRUNT.Log.trace(w+" geometry points generalized to "+e.length+" coordinates",n);d=null;for(t=A;t--;)if(x[t].position){m=s.getGridXYForPosition(x[t].position);if(u=!d||t===0||Math.abs(m.x-d.x)+Math.abs(m.y-d.y)>a.pixelGeneralization){h.push(m);d=m}}}}k++}s=
e.length;if(s>0&&(!k||a.partialDraw)){g.strokeStyle=a.strokeStyle;g.lineWidth=a.lineWidth;g.beginPath();g.moveTo(e[s-1].x-o.x,e[s-1].y-o.y);for(s=s;s--;)g.lineTo(e[s].x-o.x,e[s].y-o.y);g.stroke();g.fillStyle=a.waypointFillStyle;for(s=h.length;s--;){g.beginPath();g.arc(h[s].x-o.x,h[s].y-o.y,2,0,Math.PI*2,false);g.stroke();g.fill()}}return k}});GRUNT.WaterCooler.listen("grid.updated",function(){for(var g=r.length;g--;)GRUNT.WaterCooler.say("layer.remove",{id:r[g]});r=[];b=true;q.wakeParent()});return q},
Annotation:function(a){a=GRUNT.extend({xy:null,pos:null,draw:null,calcXY:null,tweenIn:f.AnnotationTween,animationSpeed:null},a);var b=false,d={xy:a.xy,pos:a.pos,isNew:true,isAnimating:function(){return b},calcXY:function(e){d.xy=e.getGridXYForPosition(d.pos);a.calcXY&&a.calcXY(e)},draw:function(e,l,h,r,q){if(d.xy){if(d.isNew&&a.tweenIn){var g=d.xy.y;d.xy.y=l.y-20;b=true;T5.Animation.tween(d.xy,"y",g,a.tweenIn,function(){d.xy.y=g;b=false},a.animationSpeed?a.animationSpeed:250+Math.random()*500)}if(a.draw)a.draw(e,
l,new T5.Vector(d.xy.x-l.x,d.xy.y-l.y),h,r,q);else{e.beginPath();e.arc(d.xy.x-l.x,d.xy.y-l.y,4,0,Math.PI*2,false);e.fill()}d.isNew=false}}};return d},ImageAnnotation:function(a){a=GRUNT.extend({imageUrl:null,animatingImageUrl:null,imageAnchor:null},a);var b=a.imageAnchor?T5.V.invert(a.imageAnchor):null;a.draw=function(e,l,h,r,q){if(a.animatingImageUrl&&d.isAnimating()){T5.Resources.loadImage(a.imageUrl);r=a.animatingImageUrl}else r=a.imageUrl;if(l=T5.Resources.getImage(r)){if(l.complete&&l.width>
0){b||(b=new T5.Vector(-l.width>>1,-l.height>>1));h=T5.V.offset(h,b.x,b.y);e.drawImage(l,h.x,h.y,l.width,l.height)}}else T5.Resources.loadImage(r,function(){q.wakeParent()})};var d=new f.Annotation(a);return d},LocationAnnotation:function(a){a=GRUNT.extend({accuracy:null},a);var b=new Image,d=new T5.Vector,e=null;b.src="data:image/png;base64,%3D%3D";
b.onload=function(){d=new T5.Vector(b.width/2,b.height/2)};var l=new f.Annotation(GRUNT.extend({calcXY:function(h){e=Math.floor(h.getPixelDistance(l.accuracy)*0.5)},draw:function(h,r,q,g,o,k){r=q.x-d.x;g=q.y-d.y;if(e&&l.drawAccuracyIndicator){h.fillStyle="rgba(30, 30, 30, 0.2)";h.beginPath();h.arc(q.x,q.y,e,0,Math.PI*2,false);h.fill()}b.complete&&b.width>0&&h.drawImage(b,r,g,b.width,b.height);k.trigger("invalidate")}},a));l.accuracy=a.accuracy;l.drawAccuracyIndicator=false;return l},AnnotationsOverlay:function(a){function b(r){var q=
a.map?a.map.getTileLayer():null,g=r.length;if(q)for(g=g;g--;)r[g].calcXY(q);r.sort(function(o,k){var n=k.xy.y-o.xy.y;if(n===0)n=k.xy.x-o.xy.x;return n})}a=GRUNT.extend({pois:null,map:null,createAnnotationForPOI:null,zindex:100},a);var d=[],e=false,l=[],h=GRUNT.extend(new T5.ViewLayer(a),{cycle:function(){return e?1:0},draw:function(r,q,g,o,k){e=false;r.fillStyle="rgba(255, 0, 0, 0.75)";r.globalCompositeOperation="source-over";for(g=d.length;g--;){d[g].draw(r,q,o,h,k);e=e||d[g].isAnimating()}for(g=
l.length;g--;){l[g].draw(r,q,o,h,k);e=e||l[g].isAnimating()}return e?1:0},add:function(r){l.push(r);b(l);h.wakeParent()},clear:function(r){l=[];b(l);if(r){d=[];b(d)}h.wakeParent()}});GRUNT.WaterCooler.listen("geo.pois-updated",function(r){if(a.pois&&a.pois.id==r.srcID){r=r.pois;try{d=[];for(var q=0;q<r.length;q++)if(r[q].pos){var g;var o=r[q];if(o&&o.pos){var k=null;if(k=a.createAnnotationForPOI?a.createAnnotationForPOI(o):new f.Annotation({pos:o.pos})){k.isNew=o.isNew;o.isNew=false}g=k}else g=void 0;
g&&d.push(g)}b(d)}catch(n){GRUNT.Log.exception(n)}h.wakeParent()}});GRUNT.WaterCooler.listen("grid.updated",function(){b(d);b(l);h.wakeParent()});return h}};return f}();
T5.Map=function(p){function f(u){try{var v=new T5.Geo.Position(u.coords.latitude,u.coords.longitude),w=u.coords.accuracy/1E3;m.trigger("locationUpdate",u,w);if(s){if(!o){o=new T5.Geo.UI.LocationAnnotation({pos:v,accuracy:w});m.bind("tileDrawComplete",function(){o.drawAccuracyIndicator=true})}p.displayLocationAnnotation&&r.add(o);var x=T5.Geo.B.createBoundsFromCenter(v,Math.max(w,1));m.gotoBounds(x)}else{o.pos=v;o.accuracy=w;o.calcXY(m.getTileLayer());m.panToPosition(v,null,T5.Easing.Sine.Out)}s=false}catch(A){GRUNT.Log.exception(A)}}
function a(u){GRUNT.Log.info("caught location tracking error:",u)}p=GRUNT.extend({tapExtent:10,provider:null,crosshair:false,zoomLevel:0,boundsChange:null,tapPOI:null,boundsChangeThreshold:30,pois:new T5.Geo.POIStorage,createAnnotationForPOI:null,displayLocationAnnotation:true,zoomAnimation:T5.Easing.Quad.Out},p);var b={NONE:0,SINGLE:1,WATCH:2},d=new T5.Vector,e=b.NONE,l=false,h=[],r=null,q=null,g=null,o=null,k=0,n=false,s=true,t=p.zoomLevel;if(!p.provider)p.provider=new T5.Geo.MapProvider;p.adjustScaleFactor=
function(u){return Math.pow(2,(u<1?Math.floor:Math.ceil)(Math.log(u)))};var m=GRUNT.extend({},new T5.Tiling.Tiler(p),{pois:p.pois,annotations:null,getProvider:function(){return p.provider},setProvider:function(u){p.provider=u;l=false},getBoundingBox:function(){var u=m.getTileLayer(),v=m.getOffset(),w=m.getDimensions();if(u)return u.getBoundingBox(v.x,v.y,w.width,w.height);return null},getCenterPosition:function(){return m.getXYPosition(T5.D.getCenter(m.getDimensions()))},getXYPosition:function(u){return m.getTileLayer().pixelsToPos(m.viewPixToGridPix(u))},
gotoBounds:function(u,v){var w=T5.Geo.B.getZoomLevel(u,m.getDimensions());m.gotoPosition(T5.Geo.B.getCenter(u),w,v)},gotoPosition:function(u,v,w){function x(F){m.setTileLayer(F);g=F.getId();m.panToPosition(u,function(){m.unfreeze();m.trigger("zoomLevelChange",t);w&&w()});l=true;n=false}var A=t,C=!l,K=m.getBoundingBox();if(K)C=C||!T5.Geo.P.inBounds(u,K);t=v?v:t;if(!t)throw Error("Zoom level required to goto a position.");if(p.provider)t=p.provider.checkZoomLevel(t);if(C||t!==A)if(n)GRUNT.Log.warn("Tile request in progress, aborting");
else{T5.Resources.resetImageLoadQueue();if(o)o.drawAccuracyIndicator=false;(v=m.getTileLayer())&&v.deactivate();T5.Animation.cancel();l&&m.freeze();n=true;p.provider.zoomLevel=t;p.provider.getMapTiles(m,u,x)}else m.panToPosition(u,w)},panToPosition:function(u,v,w){var x=m.getTileLayer();if(x){u=x.getGridXYForPosition(u);x=m.getDimensions();u.x-=x.width/2;u.y-=x.height/2;if(q)q=null;m.updateOffset(u.x,u.y,w);m.trigger("wake");p.boundsChange&&p.boundsChange(m.getBoundingBox());v&&v(m)}},locate:function(){m.trackStart(b.SINGLE);
setTimeout(m.trackCancel,1E4)},trackStart:function(u){if(navigator.geolocation&&!k){e=u?u:b.WATCH;s=true;k=navigator.geolocation.watchPosition(f,a,{enableHighAccuracy:true,timeout:1E4,maximumAge:5E3})}},trackCancel:function(){k&&navigator.geolocation&&navigator.geolocation.clearWatch(k);e===b.WATCH&&r.clear();e=b.NONE;k=0},getZoomLevel:function(){return t},setZoomLevel:function(u){try{m.gotoPosition(m.getCenterPosition(),u)}catch(v){GRUNT.Log.exception(v)}},zoomIn:function(){m.scale(2,T5.Easing.Sine.Out)||
