...
x:f.x|0,y:f.y|0,elements:[],absXY:d,relXY:e}},initHit:function(b,d,e){return{type:b,target:d,drag:e}},triggerEvent:function(b,d,e,f){d.triggerCustom(b.type+(e?e:"Hit"),{hitType:b.type},f?f:b.elements,b.absXY,b.relXY,new r(b.x,b.y))}}}();var vb=function(b){function d(a,c){var g=e[a],h;g||(g=e[a]=[]);(h=g[c])||(h=g[c]=[]);return h}b=b||128;var e=[],f={};return{insert:function(a,c,g){var h=a.x/b|0,i=a.y/b|0,n=(a.x+a.w)/b|0;a=(a.y+a.h)/b|0;g=g||c.id||COG.objId("spatial");f[g]=c;for(c=h;c<=n;c++)for(h=
i;h<=a;h++)d(c,h).push(g)},remove:function(a,c,g){g=g||c.id;if(f[g]){var h=a.x/b|0;c=a.y/b|0;var i=(a.x+a.w)/b|0;a=(a.y+a.h)/b|0;delete f[g];for(h=h;h<=i;h++)for(var n=c;n<=a;n++){var o=d(h,n),F=P.call(o,g);F>=0&&o.splice(F,1)}}},search:function(a){var c=a.y/b|0,g=(a.x+a.w)/b|0,h=(a.y+a.h)/b|0,i=[],n=[];for(a=a.x/b|0;a<=g;a++)for(var o=c;o<=h;o++)i=i.concat(d(a,o));i.sort();for(c=i.length;c--;){g=i[c];if(h=f[g])n[n.length]=h;for(;c>0&&i[c-1]==g;)c--}return n}}},Wb=3E4,wb={},Xb=0;(new Date).getTime();
var Pa={},Ua=[];T.prototype={constructor:T,load:function(b){var d=this;z(this.url,function(e){d.loaded=true;d.image=e;b&&b()})}};var cc=function(){return COG.observable({applyStyle:function(){},applyTransform:function(b,d,e){return{restore:null,x:d,y:e}},checkSize:function(){},getDimensions:function(){return{width:0,height:0}},getOffset:function(){return new r},getViewport:function(){},hitTest:function(){return false},prepare:function(){},projectXY:null,render:function(){},reset:function(){}})},Bb=
{},Wa=E.registerRenderer=function(b,d){Bb[b]=d},dc=E.attachRenderer=function(b,d,e,f){b=b.split("/");for(var a=new cc(d,e,f),c=0;c<b.length;c++){var g=Bb[b[c]];if(g)a=new g(d,e,f,a)}return a};Wa("canvas",function(b,d,e,f){function a(A,ba,R){var ca,$;G[ba]=function(N){for(ca=ma.length;ca--;)if($=R[ma[ca]])N[ja[ca]]=$}}function c(A,ba,R,ca){var $=false;if(ba)$=o.isPointInPath(D?ba.x-F:ba.relXY.x,D?ba.y-I:ba.relXY.y);return{draw:ca||X,viewport:A,state:R,hit:$,vpX:F,vpY:I,context:o}}e=COG.extend({},e);
var g,h,i,n=false,o,F=0,I=0,G={},t=null,D=CANI.canvas.pipTransformed,C={},K=function(){},X=function(){this.fill&&o.fill();this.stroke&&o.stroke()},ma=["fill","stroke","lineWidth","opacity"],ja=["fillStyle","strokeStyle","lineWidth","globalAlpha"];(function(){if(d){var A=d.tagName=="CANVAS",ba=A?d.parentNode:d;g=b.width=ba.offsetWidth;h=b.height=ba.offsetHeight;if(A){i=d;i.width=g;i.height=h;cb&&FlashCanvas.initElement(i)}else{i=bc(g,h);i.style.cssText="position: absolute; z-index: 1;";n=true;d.appendChild(i)}o=
null}})();e=COG.extend(f,{applyStyle:function(A){var ba=G[A],R=o&&o.canvas?o.canvas.id:"default",ca;C[R]||(C[R]=[]);ca=C[R].pop()||"basic";if(ba){C[R].push(A);ba(o);return ca}},applyTransform:function(A){if(A.translateX!==0||A.translateY!==0||A.scaling!==1||A.rotation!==0){o.save();t={undo:function(){o.restore();t=null},x:A.xy.x,y:A.xy.y};o.translate(A.xy.x-F+A.translateX,A.xy.y-I+A.translateY);A.rotation!==0&&o.rotate(A.rotation);A.scaling!==1&&o.scale(A.scaling,A.scaling)}return t},drawTiles:function(A,
ba){for(var R,ca,$=F-256,N=I-256,Y=A.x2,ta=A.y2,wa=ba.length;wa--;){R=ba[wa];if(ca=R.x>=$&&R.x<=Y&&R.y>=N&&R.y<=ta)R.loaded?o.drawImage(R.image,R.x-F,R.y-I):R.load(b.invalidate)}},prepare:function(A,ba){var R,ca=false,$=ba.scaled||ba,N=ba.scaleFactor;if(o)o.restore();else o=i.getContext("2d");for(R=A.length;R--;)ca=ca||A[R].clip;F=$.x;I=$.y;if(o){ca||o.clearRect(0,0,g,h);o.save();o.scale(N,N)}o.globalCompositeOperation="source-over";return o},prepArc:function(A,ba,R,ca){o.beginPath();o.arc(A.xy.x-
(t?t.x:F),A.xy.y-(t?t.y:I),A.size>>1,A.startAngle,A.endAngle,false);return c(ba,R,ca)},prepImage:function(A,ba,R,ca,$){var N=($.x||A.xy.x)-(t?t.x:F),Y=($.y||A.xy.y)-(t?t.y:I),ta=$.image||A.image;if(ta){o.beginPath();o.rect(N,Y,$.width||ta.width,$.height||ta.height);return c(ba,R,ca,function(){o.drawImage(ta,N,Y,$.width||ta.width,$.height||ta.height)})}},prepMarker:function(A,ba,R,ca){var $=A.xy.x-(t?t.x:F),N=A.xy.y-(t?t.y:I),Y=A.size,ta=undefined;o.beginPath();switch(A.markerStyle.toLowerCase()){case "image":ta=
K;o.rect($-(Y>>1),N-(Y>>1),Y,Y);if(A.reset&&A.image){A.image=null;A.reset=false}A.image?o.drawImage(A.image,$-(Y>>1),N-(Y>>1),Y,Y):z(A.imageUrl,function(wa){A.image=wa;o.drawImage(A.image,$-(Y>>1),N-(Y>>1),Y,Y)});break;default:o.moveTo($,N);o.lineTo($-(Y>>1),N-Y);o.lineTo($+(Y>>1),N-Y);o.lineTo($,N);break}return c(ba,R,ca,ta)},prepPoly:function(A,ba,R,ca,$){var N=true;A=$.points||A.points;$=t?t.x:F;var Y=t?t.y:I;o.beginPath();for(var ta=A.length;ta--;){var wa=A[ta].x-$,eb=A[ta].y-Y;if(N){o.moveTo(wa,
eb);N=false}else o.lineTo(wa,eb)}return c(ba,R,ca)},getContext:function(){return o},getDimensions:function(){return{width:g,height:h}},getOffset:function(){return new r(F,I)}});(function(){for(var A in T5.styles)a(null,A,T5.styles[A]);T5.bind("styleDefined",a)})();e.bind("detach",function(){n&&d.removeChild(i)});return e});var jb=E.styles={},ec=E.defineStyle=function(b,d){jb[b]=d;E.trigger("styleDefined",b,jb[b]);return b},Cb=E.defineStyles=function(b){for(var d in b)ec(d,b[d])};E.getStyle=function(b){return jb[b]};
E.loadStyles=function(b){COG.jsonp(b,function(d){Cb(d)})};Cb({basic:{fill:"#ffffff"},highlight:{fill:"#ff0000"},waypoints:{lineWidth:4,stroke:"#003377",fill:"#ffffff"},waypointsHover:{lineWidth:4,stroke:"#ff0000",fill:"#ffffff"}});var Yb={NONE:0,ACTIVE:1,ANIMATING:4,PAN:8,ZOOM:16,FREEZE:128},Lb=function(b){function d(q,u,y){if(!wa){ca(pa-u,qa-y);aa.trigger("pan",pa,qa)}}function e(q,u,y,S){A(W(sa(va+za(2,S)-1,0.5),2))}function f(){var q=U(va)/Math.LN2|0;if(q!==0){va=za(2,q);ba($a+q,fc,gc)}redraw=
true}function a(q,u){var y=renderer&&renderer.projectXY?renderer.projectXY(q,u):null;if(!y){y=aa.getViewport();var S=1/va;y=new r(y?y.x+q*S:q,y?y.y+u*S:u)}return y}function c(q,u,y){R("doubleTap",u,y,a(y.x,y.y));b.scalable&&A(2,a(y.x,y.y),b.zoomEasing,null,b.zoomDuration)}function g(q,u,y){wa=null;K("down",u,y)}function h(q,u,y){K("hover",u,y)}function i(q,u,y){D(u,y,false)}function n(q,u,y){D(u,y,true)}function o(){clearTimeout(Db);Db=setTimeout(function(){renderer.checkSize()},250)}function F(q,
u,y){K("tap",u,y);R("tap",u,y,a(y.x,y.y,true))}function I(q){renderer=dc(q||b.renderer,aa,ta,b);Eb=!renderer.preventPartialScale;t()}function G(q,u){u.id=q;u.added=Z();u.view=aa;u.trigger("parentChange",aa,ta,hc);N.push(u);N.sort(function(y,S){var da=S.zindex-y.zindex;if(da===0)da=S.added-y.added;return da});Y=N.length;return u}function t(){Ea&&Ea.unbind();if(renderer){Ea=INTERACT.watch(renderer.interactTarget||ta);b.pannable&&Ea.pannable().bind("pan",d);if(b.scalable){Ea.bind("zoom",e);Ea.bind("doubleTap",
c)}Ea.bind("pointerDown",g);Ea.bind("pointerMove",i);Ea.bind("pointerUp",n);b.captureHover&&Ea.bind("pointerHover",h);Ea.bind("tap",F)}}function D(q,u,y){if(wa){q=a(u.x,u.y);wa.drag.call(wa.target,wa,q.x,q.y,y)&&Ia++;if(y)wa=null}}function C(q){var u,y,S=false;q=q||(new Date).getTime();if(S=q-Fb>ic){var da=x(pa-kb),Ba=x(qa-lb);u=pa!==mb||qa!==nb;y=va!==Gb;if(u||y)Ia++;if(da>=Hb||Ba>=Hb)ja();y={index:eb++,draw:Ia};aa.trigger("enterFrame",q,y);Fb=q}if(renderer&&S&&y.draw){Ka=Ib|(va!==1?Jb:0)|(u?ob:
0)|(pb?Kb:0);qb=(u=(Ka&(Jb|ob))!==0)&&(Ka&Kb)===0;u=ma();renderer.trigger("predraw",u,Ka);if(renderer.prepare(N,u,Ka,q,Fa)){Ia=0;for(ii=Y;ii--;){S=N[ii];if(S.visible&&(Ka&S.validStates)!==0){y=S.style?renderer.applyStyle(S.style,true):null;S.draw(renderer,u,Ka,aa,q,Fa);y&&renderer.applyStyle(y)}}renderer.render(u);aa.trigger("drawComplete",u,q);mb=pa;nb=qa;Gb=va}if(Fa){q=Fa?Fa.elements:[];if(ab&&ab.type==="hover"){u=Hits.diffHits(ab.elements,q);u.length>0&&Hits.triggerEvent(ab,aa,"Out",u)}if(q.length>
0){S=Fa.x;y=Fa.y;for(u=q.length;u--;){da=q[u];Ba=S;var La=y,Ja=da&&da.drag&&(!da.canDrag||da.canDrag(da,Ba,La));if(Ja){wa=da;wa.startX=Ba;wa.startY=La}if(Ja)break}Hits.triggerEvent(Fa,aa)}ab=q.length>0?COG.extend({},Fa):null;Fa=null}}animFrame(C)}function K(q,u,y){Fa=Hits.init(q,u,y,a(y.x,y.y,true));for(q=Y;q--;)rb=rb||(N[q].hitGuess?N[q].hitGuess(Fa.x,Fa.y,Ka,aa):false);rb&&Ia++}function X(){Ia++}function ma(){var q=new k(pa,qa,aa.width,aa.height);q.scaleFactor=va;if(va!==1)q.scaled=Va.fromCenter(pa+
(aa.width>>1),qa+(aa.height>>1),aa.width/va|0,aa.height/va|0);return q}function ja(){var q=ma();if(q){if(Xa||Ya)if(q){var u=fb?pa+(q.w>>1):pa,y=gb?qa+(q.h>>1):qa,S=q.w,da=q.h;if(Xa&&Xa>S)if(u+S>Xa)pa=fb?pa:Xa-S;else if(u<0)pa=fb?pa:0;if(Ya&&Ya>da)if(y+da>Ya)qa=gb?qa:Ya-da;else if(y<0)qa=gb?qa:0}kb=pa;lb=qa;R("refresh",aa,q);Ia++}}function A(q,u,y,S,da){var Ba;if(!Eb){y=false;Ba=V(U(q)/Math.LN2);q=za(2,Ba)}if(y)COG.tweenValue(va,q,y,da,function(La,Ja){va=La;if(Ja){Ba=V(U(va)/Math.LN2);va=za(2,Ba);
S&&S()}f()});else{va=q;f()}return aa}function ba(q,u,y){q=sa(b.minZoom,W(b.maxZoom,q));if(q!==$a){var S=za(2,q-$a),da=aa.width>>1,Ba=aa.height>>1,La=da/S|0,Ja=Ba/S|0;$a=q;ca(((u?u:pa+da)-La)*S,((y?y:qa+Ba)-Ja)*S);mb=pa;nb=qa;lb=kb=0;R("zoomLevelChange",q);va=1;renderer.reset();ja()}}function R(){for(var q=aa.trigger.apply(null,arguments).cancel,u=N.length;u--;)q=N[u].trigger.apply(null,arguments).cancel||q;return!q}function ca(q,u,y,S,da){function Ba(){La+=1;if(La>=2){pb=false;da&&da()}}var La=0;
if(y){if((Ka&ob)===0){COG.tweenValue(pa,q,y,S,function(Ja,sb){pa=Ja|0;(sb?Ba:X)();return!qb});COG.tweenValue(qa,u,y,S,function(Ja,sb){qa=Ja|0;(sb?Ba:X)();return!qb});pb=true}}else{pa=q|0;qa=u|0;da&&da()}}b=COG.extend({id:COG.objId("view"),container:"",captureHover:true,captureDrag:false,inertia:true,refreshDistance:256,pannable:false,clipping:true,scalable:false,panAnimationEasing:COG.easing("sine.out"),panAnimationDuration:750,pinchZoomAnimateTrigger:400,autoSize:true,tapExtent:10,guides:false,turbo:false,
fps:25,minZoom:1,maxZoom:1,renderer:"canvas",zoomEasing:COG.easing("quad.out"),zoomDuration:300,zoomLevel:1},b);var $={},N=[],Y=0,ta=document.getElementById(b.container),wa=null,eb=0,hc=null,jc=!v(window.attachEvent,ya),rb=false,Hb=b.refreshDistance,pa=0,qa=0,kb=0,lb=0,mb=0,nb=0,Xa=null,Ya=null,fb=false,gb=false,Fa=null,qb=false,ab=null,Db=0,va=1,Gb=1,Fb=0,Ea=null,Eb=true,pb=false,ic=1E3/b.fps|0,Ia=0,fc,gc,$a=b.zoomLevel,Ib=ka("ACTIVE"),ob=ka("PAN"),Jb=ka("ZOOM"),Kb=ka("ANIMATING"),Ka=Ib,aa={id:b.id,
detach:function(){renderer&&renderer.trigger("detach");Ea&&Ea.unbind()},eachLayer:function(q){for(var u=Y;u--;)q(N[u])},getLayer:function(q){for(var u=0;u<Y;u++)if(N[u].id===q)return N[u];return null},getZoomLevel:function(){return $a},setLayer:function(q,u){for(var y=0;y<Y;y++)if(N[y].id===q){N.splice(y,1);break}if(u){G(q,u);u.trigger("refresh",aa,ma());aa.trigger("layerChange",aa,u)}Ia++;return u},invalidate:X,refresh:ja,resetScale:function(){va=1},scale:A,setZoomLevel:ba,syncXY:function(){},triggerAll:R,
removeLayer:function(q){a:{for(var u=Y;u--;)if(N[u].id===q){q=u;break a}q=-1}if(q>=0&&q<Y){aa.trigger("layerRemove",aa,N[q]);N.splice(q,1);Ia++}Y=N.length},getOffset:function(){return new r(pa,qa)},getRenderer:function(){return renderer},getScaleFactor:function(){return va},setMaxOffset:function(q,u,y,S){Xa=q;Ya=u;fb=y;gb=S},getViewport:ma,updateOffset:ca,pan:function(q,u,y,S,da){ca(pa+q,qa+u,y,S,da)}};COG.observable(aa);aa.bind("resync",function(){});COG.configurable(aa,["container","captureHover",
"captureDrag","scalable","pannable","inertia","minZoom","maxZoom","renderer","zoom"],COG.paramTweaker(b,null,{container:function(q,u){ta=document.getElementById(u);I()},inertia:t,captureHover:t,scalable:t,pannable:t,renderer:function(q,u){if(renderer){renderer.trigger("detach");renderer=null}I(u);Ia++}}),true);CANI.init(function(q){aa.markers=G("markers",new hb({zindex:20}));$=q;I();jc?window.attachEvent("onresize",o):window.addEventListener("resize",o,false)});animFrame(C);return aa},Ga=function(b){b=
...
this.xy.y,this.size,this.size))}},rotate:function(b){this.rotation=b},scale:function(b){this.scaling=b},translate:function(b,d){this.translateX=b;this.translateY=d},updateBounds:function(b,d){b&&(!this.bounds||b.x!=this.bounds.x||b.y!=this.bounds.y)&&this.trigger("move",this,b,this.bounds);this.bounds=b;if(d)this.xy=Va.center(this.bounds)}};var Zb=1E3/60|0,Za=[],xb=0;m.prototype=COG.extend(Ga.prototype,{constructor:m});w.prototype=COG.extend({},Ga.prototype,{constructor:w});O.prototype=COG.extend({},
w.prototype);L.prototype=COG.extend({},Ga.prototype,{constructor:L});na.prototype=COG.extend({},L.prototype,{constructor:na});ra.prototype=COG.extend(Ga.prototype,{constructor:ra});J.prototype={constructor:J,clip:null,cycle:function(){},draw:function(){},hitGuess:null};Wa=function(b,d){function e(h,i){var n=i&&i.getZoomLevel?i.getZoomLevel():0;c[n]||(c[n]=l(n));a=c[n]}d=COG.extend({imageLoadArgs:{}},d);var f=b?Ab.init(b,d).run:null,a=null,c=[],g=COG.extend(new J(d),{draw:function(h,i){h.drawTiles(i,
a.search(Va.buffer(i,128)))}});g.bind("refresh",function(h,i,n){var o=(new Date).getTime();a&&f(i,n,a,function(){i.invalidate();COG.info("GEN COMPLETED IN "+((new Date).getTime()-o)+" ms")})});g.bind("parentChange",e);g.bind("resync",e);return g};var Mb=function(b){function d(n,o,F,I){var G=this.dragOffset;if(!G)G=this.dragOffset=new r(n.startX-this.xy.x,n.startY-this.xy.y);this.xy.x=o-G.x;this.xy.y=F-G.y;if(I){delete this.dragOffset;if(n=i.view){n.syncXY([this.xy],true);n.invalidate()}this.trigger("dragDrop")}return true}
function e(n){clearTimeout(h);h=setTimeout(function(){c.sort(function(o,F){if(F.xy&&o.xy){var I=F.xy.y-o.xy.y;return I!=0?I:F.xy.x-o.xy.x}});n&&n.invalidate()},50)}function f(n,o,F,I){I&&g.remove(I,o);g.insert(F,o)}function a(n,o){g=l(o.getZoomLevel());for(var F=c.length;F--;)c[F].resync(o)}b=COG.extend({zindex:10},b);var c=[],g,h=0,i=COG.extend(new J(b),{itemCount:0,add:function(n,o){if(n){n.layer=i;if(o)c.unshift(n);else c[c.length]=n;var F=i.view;if(F){n.resync(F);g&&n.bounds&&g.insert(n.bounds,
n);e(F)}n.bind("move",f)}i.itemCount=c.length},clear:function(){g=new vb;c=[];i.itemCount=0},draw:function(n,o,F,I,G,t){I={};G=g&&o?g.search(o):[];for(var D=G.length;D--;){var C=G[D],K=C.style||i.style,X,ma=n.applyTransform(C),ja=C.getProps?C.getProps(n,F):I;if(ja=(X=n["prep"+C.typeName])?X.call(n,C,o,t,F,ja):null){if(t&&ja.hit){t.elements.push(Hits.initHit(C.type,C,C.draggable?d:null));X=t.type+"Style";K=C[X]||i[X]||K}K=K?n.applyStyle(K,true):null;(X=C.draw||ja.draw)&&X.call(C,ja);K&&n.applyStyle(K)}ma&&
ma.undo&&ma.undo()}},find:function(){return[].concat(c)},hitGuess:function(n,o){return g&&g.search({x:n-10,y:o-10,w:20,h:20}).length>0}});i.bind("parentChange",a);i.bind("resync",a);return i},hb=function(b){return new Mb(b)};COG.extend(E,{ex:COG.extend,is:v,ticks:Z,userMessage:function(b,d,e){E.trigger("userMessage",b,d,e)},indexOf:P,Rect:k,XY:Qa,XYRect:Va,Vector:ib,Hits:Hits,Generator:Ab,tweenValue:COG.tweenValue,easing:COG.easing,Tile:T,TileLayer:Wa,getImage:z,viewState:ka,View:Lb,ViewLayer:J,ImageLayer:Wa,
Drawable:Ga,Marker:m,Poly:w,Line:O,Arc:ra,ImageDrawable:L,ImageMarker:na,DrawLayer:Mb,ShapeLayer:hb});var tb=[1.406245461070741,1.321415085624082,1.077179995861952,0.703119412486786,0.488332580888611],Ha=Math.PI/180,Oa=180/Math.PI,ub=ia,Nb=-ub,Ob=Q,kc=-Ob,db=0.08181919084262157,bb=null,Pb={RD:"ROAD",ST:"STREET",CR:"CRESCENT",CRES:"CRESCENT",CT:"COURT",LN:"LANE",HWY:"HIGHWAY",MWY:"MOTORWAY"},ha=function(){function b(a){return a?e(a.lat,a.lon):null}function d(a){return!a||a.lat===0&&a.lon===0}function e(a,
c){return{lat:parseFloat(a?a:0),lon:parseFloat(c?c:0)}}function f(a){if(a)if(v(a.lat,zb))return b(a);else{if(a.split)for(var c=[" ",","],g=0;g<c.length;g++){var h=a.split(c[g]);if(h.length===2)return e(h[0],h[1])}}else return e();return null}return{calcDistance:function(a,c){if(d(a)||d(c))return 0;var g=(c.lat-a.lat)*Ha>>1,h=(c.lon-a.lon)*Ha>>1;g=oa(g)*oa(g)+Aa(a.lat*Ha)*Aa(c.lat*Ha)*oa(h)*oa(h);return 6371*2*$b(H(g),H(1-g))},copy:b,empty:d,equal:function(a,c){return a&&c&&a.lat==c.lat&&a.lon==c.lon},
fromMercatorPixels:function(a,c){for(var g=za(Math.E,-c),h=ia-2*Ta(g),i=fa(h,g),n=0;n<12&&x(h-i)>1.0E-7;){h=i;i=fa(h,g);n++}return e(i*Oa,a%360*Oa)},generalize:function(a,c,g){var h=a.length,i=[],n=null;g||(g=250);g/=1E3;COG.info("generalizing positions, must include "+c.length+" positions");for(var o=h;o--;)if(o===0)i.unshift(a[o]);else{var F=!n||ha.inArray(a[o],c)?g:ha.calcDistance(n,a[o]);if(a[o]&&F>=g){i.unshift(a[o]);n=a[o]}}COG.info("generalized "+h+" positions into "+i.length+" positions");
return i},inArray:function(a,c){for(var g=ha.equal,h=c.length;h--;)if(g(a,c[h]))return true;return false},inBounds:function(a,c){var g=!(ha.empty(a)||ha.empty(c));return g=(g=g&&a.lat>=c.min.lat&&a.lat<=c.max.lat)&&a.lon>=c.min.lon&&a.lon<=c.max.lon},init:e,offset:function(a,c,g){var h=a.lat*Ha;a=a.lon*Ha;c=h+c/6371;g=Da(oa(g/6371)/Aa(h));g=a+g;c=(c+ia)%Math.PI-ia;g%=Q;return e(c*Oa,g*Oa)},parse:f,parseArray:function(a){var c=a.length,g=Array(c);for(c=c;c--;)g[c]=f(a[c]);return g},toMercatorPixels:function(a){return T5.XY.init(parseFloat(a.lon)*
Ha,xa(a.lat))},toString:function(a){return a?a.lat+" "+a.lon:""},vectorize:function(a,c){function g(){for(var o=0,F=c.chunkSize,I=h;I--;){i[I]=T5.GeoXY.init(a[I]);o+=1;if(o>F)break}h=I;if(h<=0)c.callback&&c.callback(i);else animFrame(g)}var h=a.length,i=Array(h);c=COG.extend({chunkSize:500,async:true,callback:null},c);if(!c.async){for(var n=h;n--;)i[n]=T5.GeoXY.init(a[n]);return i}animFrame(g);return null}}}(),Ma=function(){function b(a,c,g){var h=new r(0,c.lat-a.lat);h.x=(g||v(g,ya))&&a.lon>c.lon?
360-a.lon+c.lon:c.lon-a.lon;return h}function d(a,c){return Ma.init(ha.init(a.min.lat-c,a.min.lon-c%360),ha.init(a.max.lat+c,a.max.lon+c%360))}function e(a){var c=b(a.min,a.max);return ha.init(a.min.lat+(c.y>>1),a.min.lon+(c.x>>1))}function f(a,c){return{min:ha.parse(a),max:ha.parse(c)}}return{calcSize:b,createBoundsFromCenter:function(a,c){var g=c/6371,h=a.lat*Ha,i=a.lon*Ha,n=h-g,o=h+g;if(n>Nb&&o<ub){h=Da(oa(g)/Aa(h));g=(i-h)%Q;i=(i+h)%Q}else{n=sa(n,Nb);o=W(o,ub);g=kc;i=Ob}return Ma.init(ha.init(n*
Oa,g*Oa),ha.init(o*Oa,i*Oa))},expand:d,forPositions:function(a,c){var g=null,h=T5.ticks();c||(c="auto");for(var i=a.length;i--;)if(g){var n=b(g.min,a[i],false),o=b(a[i],g.max,false);if(n.x<0)g.min.lon=a[i].lon;if(n.y<0)g.min.lat=a[i].lat;if(o.x<0)g.max.lon=a[i].lon;if(o.y<0)g.max.lat=a[i].lat}else g=f(a[i],a[i]);if(c){if(c=="auto"){i=b(g.min,g.max);c=sa(i.x,i.y)*0.3}g=d(g,c)}COG.trace("calculated bounds for "+a.length+" positions",h);return g},getCenter:e,getGeoHash:function(a){var c=T5.Geo.GeoHash.encode(a.min.lat,
