...
(function(){function h(o){return o<10?"0"+o:o}function e(o){d.lastIndex=0;return d.test(o)?'"'+o.replace(d,function(g){var n=l[g];return typeof n==="string"?n:"\\u"+("0000"+g.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+o+'"'}function b(o,g){var n,q,p,t,v=f,k,u=g[o];if(u&&typeof u==="object"&&typeof u.toJSON==="function")u=u.toJSON(o);if(typeof r==="function")u=r.call(g,o,u);switch(typeof u){case "string":return e(u);case "number":return isFinite(u)?String(u):"null";case "boolean":case "null":return String(u);
case "object":if(!u)return"null";f+=m;k=[];if(Object.prototype.toString.apply(u)==="[object Array]"){t=u.length;for(n=0;n<t;n+=1)k[n]=b(n,u)||"null";p=k.length===0?"[]":f?"[\n"+f+k.join(",\n"+f)+"\n"+v+"]":"["+k.join(",")+"]";f=v;return p}if(r&&typeof r==="object"){t=r.length;for(n=0;n<t;n+=1){q=r[n];if(typeof q==="string")if(p=b(q,u))k.push(e(q)+(f?": ":":")+p)}}else for(q in u)if(Object.hasOwnProperty.call(u,q))if(p=b(q,u))k.push(e(q)+(f?": ":":")+p);p=k.length===0?"{}":f?"{\n"+f+k.join(",\n"+f)+
...
d=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,f,m,l={"\u0008":"\\b","\t":"\\t","\n":"\\n","\u000c":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},r;if(typeof JSON.stringify!=="function")JSON.stringify=function(o,g,n){var q;m=f="";if(typeof n==="number")for(q=0;q<n;q+=1)m+=" ";else if(typeof n==="string")m=n;if((r=g)&&typeof g!=="function"&&(typeof g!=="object"||typeof g.length!=="number"))throw Error("JSON.stringify");return b("",
...
GRUNT=function(){var h=Object.prototype.hasOwnProperty,e=0,b={id:"GRUNT.core",extend:function(){var a=arguments[0]||{},d=1,f=arguments.length,m=false,l,r,o,g;if(typeof a==="boolean"){m=a;a=arguments[1]||{};d=2}if(typeof a!=="object"&&!b.isFunction(a))a={};if(f===d){a=this;--d}for(;d<f;d++)if((l=arguments[d])!=null)for(r in l){o=a[r];g=l[r];if(a!==g)if(m&&g&&(b.isPlainObject(g)||b.isArray(g))){o=o&&(b.isPlainObject(o)||b.isArray(o))?o:b.isArray(g)?[]:{};a[r]=b.extend(m,o,g)}else if(g!==undefined)a[r]=
...
GRUNT.Log=function(){function h(f,m){var l,r=m&&m.length>0?m[0]:"";for(l=1;m&&l<m.length;l++)r+=" "+(b&&GRUNT.isPlainObject(m[l])?JSON.stringify(m[l]):m[l]);typeof console!=="undefined"&&console[f](r);for(l=0;l<e.length;l++)e[l].call(d,r,f)}var e=[],b=typeof JSON!=="undefined",a=window.console&&window.console.markTimeline,d={id:"GRUNT.log",getTraceTicks:function(){return a?(new Date).getTime():null},trace:function(f,m){if(a)console.markTimeline(f+(m?": "+(d.getTraceTicks()-m)+"ms":""))},debug:function(){h("debug",
...
l.length;r--;){var o=l[r](f,m);if(typeof o!=="undefined")return o}return GRUNT.configurables[h.configurableId]}return null}}};GRUNT.Template=function(){var h=/\$\{(.*?)\}/ig;return{parse:function(e,b){for(var a=e,d=h.exec(a);d;){a=a.replace(d[0],GRUNT.XPath.first(d[1],b));h.lastIndex=0;d=h.exec(a)}return a}}}();
GRUNT.JSONP=function(){function h(d){var f=document.createElement("script"),m=false;f.src=d;f.async=true;f.onload=f.onreadystatechange=function(){if(!m&&(!this.readyState||this.readyState==="loaded"||this.readyState==="complete")){m=true;f.onload=f.onreadystatechange=null;f&&f.parentNode&&f.parentNode.removeChild(f)}};b||(b=document.getElementsByTagName("head")[0]);b.appendChild(f)}var e=0,b,a=this;return{get:function(d,f,m){d+=d.indexOf("?")>=0?"&":"?";var l="json"+ ++e;a[l]=function(r){f(r);a[l]=
null;try{delete a[l]}catch(o){}};h(d+(m?m:"callback")+"="+l);return l}}}();
GRUNT.XHR=function(){var h={HTML:"text/html",XML:"text/xml",TEXT:"text/plain",STREAM:"application/octet-stream"},e={JSON:["json"],PDON:["pdon.txt"]},b=["TEXT","STREAM"],a=/^(\w+:)?\/\/([^\/?#]+)/,d={XML:function(l){return l.responseXML},JSON:function(l){try{return JSON.parse(l.responseText)}catch(r){GRUNT.Log.error("Error parsing JSON data: ",l.responseText);GRUNT.Log.exception(r)}return""},PDON:function(l){return GRUNT.Data.parse({data:l.responseText,format:"PDON"})},DEFAULT:function(l){return l.responseText}},
f={CONTENT_TYPE:"Content-Type"},m=GRUNT.newModule({id:"GRUNT.xhr",ajaxSettings:{xhr:null},ajax:function(l){try{l=GRUNT.extend({method:"GET",data:null,url:null,async:true,success:null,handleResponse:null,error:null,contentType:"application/x-www-form-urlencoded"},m.ajaxSettings,l);var r=a.exec(l.url),o=r&&(r[1]&&r[1]!==location.protocol||r[2]!==location.host);if(l.data)l.method="POST";if(l.url){r=null;if(l.xhr)r=l.xhr(l);r||(r=new XMLHttpRequest);r.open(l.method,l.url,l.async);l.data&&r.setRequestHeader("Content-Type",
l.contentType);o||r.setRequestHeader("X-Requested-With","XMLHttpRequest");r.onreadystatechange=function(){if(this.readyState===4){var n=null,q=!this.status&&location.protocol==="file:"||this.status>=200&&this.status<300||this.status===304||this.status===1223||this.status===0;try{if(q)if(l.handleResponse)l.handleResponse(this);else{var p=l,t=this.getResponseHeader(f.CONTENT_TYPE),v,k=false;for(v in h)if(t&&t.indexOf(h[v])>=0){k=true;break}t=!k;for(k=0;k<b.length;k++)t=t||b[k]==v;if(t)b:{t=v;for(var u in e)for(k=
0;k<e[u].length;k++)if(RegExp(e[u][k]+"$","i").test(p.url)){v=u;break b}v=t?t:"DEFAULT"}try{n=d[v](this,p)}catch(s){GRUNT.Log.warn("error applying processor '"+v+"' to response type, falling back to default");n=d.DEFAULT(this,p)}}else l.error&&l.error(this)}catch(w){GRUNT.Log.exception(w,"PROCESSING AJAX RESPONSE")}q&&n&&l.success&&l.success.call(this,n)}};r.send(l.method=="POST"?m.param(l.data):null)}else GRUNT.Log.warn("ajax request issued with no url - that ain't going to work...")}catch(g){GRUNT.Log.exception(g)}},
param:function(l){var r=[],o=function(n,q){q=GRUNT.isFunction(q)?q():q;r[r.length]=encodeURIComponent(n)+"="+encodeURIComponent(q)};if(GRUNT.isArray(l))for(var g=0;g<l.length;g++)o(l[g].name,l[g].value);else for(g in l)o(g,l[g]);return r.join("&").replace(/%20/g,"+")}});return m}();
...
supportsTouch:true,getScaling:function(){return 1/window.devicePixelRatio},bridgeNotify:d},froyo:{name:"Android OS >= 2.2",regex:/froyo/i,eventTarget:document.body,supportsTouch:true,bridgeNotify:d}};l=[m.froyo,m.android,m.ipod,m.iphone,m.ipad]}var m=null,l=[],r=null,o=0,g=[],n=["view.wake","tile.loaded"];return{getConfig:function(){m||f();if(!r){GRUNT.Log.info("ATTEMPTING TO DETECT PLATFORM: UserAgent = "+navigator.userAgent);for(var q=0;q<l.length;q++){var p=l[q];if(p.regex&&p.regex.test(navigator.userAgent)){r=
T5.ex({},m.base,p);GRUNT.Log.info("PLATFORM DETECTED AS: "+r.name);break}}if(!r){GRUNT.Log.warn("UNABLE TO DETECT PLATFORM, REVERTING TO BASE CONFIGURATION");r=m.base}GRUNT.Log.info("CURRENT DEVICE PIXEL RATIO = "+window.devicePixelRatio)}return r}}}();
T5.Resources=function(){var h="",e={},b=function(){function d(){var s=o[this.id];if(s&&s.image.complete&&s.image.width>0){s.loaded=true;s.hitCount=1;for(var w=q.length;w--;)if(q[w].image.src==this.src){q.splice(w,1);break}if(s.background||s.postProcess)if(s.image){w=T5.newCanvas(s.realSize?s.realSize.width:image.width,s.realSize?s.realSize.height:image.height);var x=w.getContext("2d"),z=s.offset?s.offset:new T5.Vector;s.background&&x.drawImage(s.background,0,0);x.drawImage(s.image,z.x,z.y);s.postProcess&&
s.postProcess(x,s);s.image=w}s.loadCallback&&s.loadCallback(this,false);p.push({url:this.src,created:s.requested});delete o[this.id];f()}}function f(){for(var s=T5.Device.getConfig().maxImageLoads;n.length>0&&(!s||q.length<s);){var w=n.shift();if(w.imageLoader){q.push(w);w.imageLoader(w,d)}}}function m(s){for(var w=null,x=t.length;x--&&!w;)w=t[x](s);return w?w:function(z,F){z.image.onload=F;z.image.src=a.getPath(z.url);z.requested=T5.time()}}function l(){k=true;try{var s=Math.floor(p.length/2);if(s>
0){p.sort(function(x,z){return x.created-z.created});for(var w=s;w--;)delete r[p[w].url];p.splice(0,s)}}finally{k=false}GRUNT.WaterCooler.say("imagecache.cleared")}var r={},o={},g=0,n=[],q=[],p=[],t=[],v=0,k=false,u={loadingImages:q,queuedImages:n,addInterceptor:function(s){t.push(s)},getCacheFullness:function(){return v},getImage:function(s){var w=null,x=null;k||(w=r[s]);if((x=w?w.image:null)&&(x.getContext||x.complete&&x.width>0))return x},loadImage:function(s,w,x){var z=r[s];if(z){z.hitCount++;
z.image.complete&&w&&w(z.image,true)}else{z=T5.ex({url:s,image:new Image,loaded:false,imageLoader:m(s),created:T5.time(),requested:null,hitCount:0,loadCallback:w},x);z.image.id="resourceLoaderImage"+g++;r[s]=z;o[z.image.id]=z;n.push(z);f()}return z},resetLoadingQueue:function(){q=[]}};setInterval(function(){for(var s=T5.time(),w=false,x=0,z=T5.Device.getConfig();x<q.length;)if(s-q[x].requested>a.loadTimeout*1E3){q.splice(x,1);w=true}else x++;w&&f();if(z&&z.imageCacheMaxSize){v=p.length*a.avgImageSize/
z.imageCacheMaxSize;v>=1&&l()}},1E3);return u}(),a={avgImageSize:25,loadTimeout:10,Cache:function(){return{read:function(){return null},write:function(){},getUrlCacheKey:function(d,f){for(var m=(d?d.replace(/^.*\?/,""):"").split("&"),l=d?d.replace(/\?.*$/,"?"):"",r=0;r<m.length;r++){var o=m[r].split("=");if(!f||!f.test(o[0]))l+=m[r]+"&"}return l.replace(/\W/g,"")},isValidCacheKey:function(d){GRUNT.Log.info("cache key = "+d);return false}}}(),addInterceptor:b.addInterceptor,getPath:function(d){return/^(file|https?|\/)/.test(d)?
...
function(){d.callback(m)})};d.cacheable&&e[d.filename]?f(e[d.filename]):GRUNT.XHR.ajax({url:a.getPath(d.filename),dataType:d.dataType,success:function(m){if(d.cacheable)e[d.filename]=m;f(m)},error:function(m,l,r){GRUNT.Log.error("error loading resource ["+d.filename+"], error = "+r)}})},loadSnippet:function(d,f){/\.\w+$/.test(d)||(d+=".html");a.loadResource({filename:"snippets/"+d,callback:f,dataType:"html"})}};return a}();
T5.Touch=function(){function h(p,t){var v=p&&p.length>0?p[0]:null;if(v&&t&&t.length>0)return T5.V.diff(v,t[0]);return null}function e(p){p.preventDefault();p.stopPropagation()}function b(p){for(var t=Array(p.length),v=p.length;v--;)t[v]=new T5.Vector(p[v].pageX,p[v].pageY);return t}function a(p){return[new T5.Vector(p.pageX,p.pageY)]}var d=120,f=100,m=250,l={TAP:0,MOVE:1,PINCHZOOM:2},r=7,o=0,g=0,n=function(p){function t(A,C,H,D){var P=Math.asin((A.y-C.y)/H);H=Math.min(Math.floor(H*(Z.duration/D)),
...
H,D));return C}function u(){p.observable&&p.observable.trigger.apply(null,arguments)}function s(A){if(A.target&&A.target===p.element){G=M?b(A.touches):a(A);O=new T5.Vector;T=new T5.Vector;X=true;F=false;$=T5.time();M&&e(A);u("inertiaCancel");V.current=$;if(A=G.length>0?G[0]:null){u("touchStart",A.x,A.y);if(V.current-V.last<fa.THRESHOLD_DOUBLETAP)if((A=U?T5.V.diff(G[0],U[0]):null)&&Math.abs(A.x)<p.maxDistDoubleTap&&Math.abs(A.y)<p.maxDistDoubleTap)F=true;S=l.TAP;U=[].concat(G)}else GRUNT.Log.warn("Touch start fired, but no touch vector found")}}
function w(A){if(A.target&&A.target===p.element){R=(M?b(A.touches):a(A))[0];if(X)try{M&&e(A);var C=M?b(A.touches):a(A);A=0;if(C.length>1){if(G.length===1)G=[].concat(C);A=T5.V.distance(G)-T5.V.distance(C)}if(S===l.TAP){var H=h(C,G);if(H&&(Math.abs(H.x)>=r||Math.abs(H.y)>=r))S=l.MOVE}if(S!==l.TAP)if(!A||Math.abs(A)<p.pinchZoomThreshold){if(O=h(C,U)){T.x-=O.x;T.y-=O.y;K.x-=O.x;K.y-=O.y}if(T5.V.absSize(K)>p.panEventThreshhold){u("pan",K.x,K.y);K=T5.V.create()}S=l.MOVE}else{u("pinchZoom",k(G),k(C));S=
...
b.id&&h.push(b)},Action:function(b){b=T5.ex({autoRegister:true,id:"",title:"",icon:"",execute:null},b);var a={id:b.id,execute:function(){b.execute&&b.execute.apply(this,arguments)},getParam:function(d){return b[d]?b[d]:""},toString:function(){return String.format("{0} [title = {1}, icon = {2}]",a.id,b.title,b.icon)}};b.autoRegister&&e.registerAction(a);return a},createAgent:function(b){b=T5.ex({name:"Untitled",trashOrphanedResults:true,translator:null,execute:null},b);var a=null,d={getName:function(){return b.name},
getParam:function(f){return b[f]},getId:function(){return GRUNT.toID(d.getName())},run:function(f,m){if(b.execute){var l=a=T5.time(),r=b.translator?b.translator(f):f;b.execute.call(d,r,function(o,g){if(!b.trashOrphanedResults||l==a)m&&m(o,g,r)})}}};return d},runAgents:function(b,a,d){for(var f=0;f<b.length;f++)b[f].run(a,d)}};return e}();
...
T5.Animation=function(){function h(){if(a===0)a=setInterval(function(){var f;f=T5.time();if(!b){b=true;try{for(var m=0;m<e.length;)if(e[m].isComplete()){e[m].triggerComplete(false);e.splice(m,1)}else{e[m].update(f);m++}}finally{b=false}}f=e.length;if(f===0){clearInterval(a);a=0}},20)}var e=[],b=false,a=0,d={DURATION:2E3,tweenValue:function(f,m,l,r,o){f=new d.Tween({startValue:f,endValue:m,tweenFn:l,complete:r,duration:o});e.push(f);return f},tween:function(f,m,l,r,o,g){f=new d.Tween({target:f,property:m,
endValue:l,tweenFn:r,duration:g,complete:o});e.push(f);return f},tweenVector:function(f,m,l,r,o,g){var n=[];if(f){var q=f.x==m,p=f.y==l;q||n.push(d.tween(f,"x",m,r,function(){(q=true)&&p&&o()},g));p||n.push(d.tween(f,"y",l,r,function(){p=true;q&&p&&o()},g))}return n},cancel:function(f){if(!b){b=true;try{for(var m=0;m<e.length;)if(!f||f(e[m])){e[m].triggerComplete(true);e.splice(m,1)}else m++}finally{b=false}}},isTweening:function(){return e.length>0},Tween:function(f){f=T5.ex({target:null,property:null,
startValue:0,endValue:null,duration:d.DURATION,tweenFn:d.DEFAULT,complete:null,cancelOnInteract:false},f);var m=T5.time(),l=[],r=false,o=0,g=0,n={cancelOnInteract:f.cancelOnInteract,isComplete:function(){return r},triggerComplete:function(q){f.complete&&f.complete(q)},update:function(q){try{var p=f.tweenFn(q-m,o,g,f.duration);if(f.target)f.target[f.property]=p;for(var t=l.length;t--;)l[t](p,void 0);if(r=m+f.duration<=q){if(f.target)f.target[f.property]=f.tweenFn(f.duration,o,g,f.duration);for(var v=
l.length;v--;)l[v](p,true)}}catch(k){GRUNT.Log.exception(k)}},requestUpdates:function(q){l.push(q)}};o=f.target&&f.property&&f.target[f.property]?f.target[f.property]:f.startValue;if(typeof f.endValue!=="undefined")g=f.endValue-o;if(g==0)r=true;h();return n}};return T5.ex(d,{DEFAULT:T5.Easing.Back.Out})}();T5.ViewState=function(){var h={NONE:0,ACTIVE:1,ANIMATING:4,PAN:8,PINCHZOOM:16,FREEZE:128,get:function(){for(var e=0,b=arguments.length;b--;){var a=h[arguments[b]];if(a)e|=a}return e}};return h}();
...
gridX:0,gridY:0,dirty:false},a)},ImageTile:function(a){a=T5.ex({url:"",sessionParamRegex:null,loaded:false},a);return new b.Tile(a)},TileGrid:function(a){function d(s,w){if(k){var x,z=[],F=new T5.Vector(Math.floor((s.x+q.x)*l),Math.floor((s.y+q.y)*l));tilesNeeded=false;for(var L=v;L--;)for(var M=t;M--;){x=f.getTile(M+F.x,L+F.y);var G=new T5.Vector(M-k.x,L-k.y);x||(n=f.getShiftDelta(F.x,F.y,t,v));z.push({tile:x,centerness:T5.V.absSize(G)})}z.sort(function(U,O){return O.centerness-U.centerness});o||
(o=Array(z.length));for(x=z.length;x--;){o[x]=z[x].tile;u.prepTile(o[x],w)}}}a=T5.ex({tileSize:T5.Tiling.Config.TILESIZE,drawGrid:false,center:new T5.Vector,gridSize:25,shiftOrigin:null,supportFastDraw:true},a);var f=new TileStore(T5.ex({tileSize:a.tileSize,gridSize:a.gridSize,onPopulate:function(){u.dirty=true;u.wakeParent()}},a)),m=Math.round(a.tileSize/2),l=a.tileSize?1/a.tileSize:0,r=true,o=null,g=false;new T5.Vector;var n=new T5.Vector,q=new T5.Vector;T5.Device.getConfig();var p=f.getGridSize()*
a.tileSize,t,v,k,u=T5.ex(new T5.ViewLayer(a),{gridDimensions:new T5.Dimensions(p,p),dirty:false,cycle:function(s,w,x){s=0;if(n.x+n.y!==0){f.shift(n,a.shiftOrigin);q=f.getTileShift();n=new T5.Vector;s++}x!==T5.ViewState.PINCHZOOM&&d(w,x);return s+u.dirty?1:0},deactivate:function(){r=false},find:function(){return f.find.apply(null,arguments)},prepTile:function(){},drawTile:function(){return false},getTileSize:function(){return a.tileSize},draw:function(s,w,x,z,F){if(r){var L=T5.time(),M=w.x;w=w.y;var G=
true,U=F.needRepaint()||z===T5.ViewState.PANNING||z===T5.ViewState.PINCHZOOM||T5.Animation.isTweening();if(!k){t=Math.ceil(x.width*l)+1;v=Math.ceil(x.height*l)+1;k=new T5.Vector(Math.floor((t-1)/2),Math.floor((v-1)/2))}if(o){if(a.drawGrid)s.strokeStyle="rgba(50, 50, 50, 0.3)";s.beginPath();for(x=o.length;x--;){var O=o[x];if(O){var T=O.gridX-M,K=O.gridY-w;if(!(U?false:!O.dirty)){G=u.drawTile(s,O,T,K,z)&&G;O.x=T;O.y=K}}else G=false;a.drawGrid&&s.rect(T,K,a.tileSize,a.tileSize)}s.stroke();GRUNT.Log.trace("drawn tiles",
L);G&&!g&&F.trigger("tileDrawComplete");g=G;u.dirty=false}}},getTileAtXY:function(s,w){for(var x=a.tileSize,z=o?o.length:0;z--;){var F=o[z];if(F&&s>=F.x&&w>=F.y)if(s<=F.x+x&&w<=F.y+x)return F}return null},getTileVirtualXY:function(s,w,x){s=f.getNormalizedPos(s,w);s=new T5.Vector(s.x*a.tileSize,s.y*a.tileSize);if(x){s.x+=m;s.y+=m}return s},populate:function(s){f.populate(s,function(){})}});return u},ImageTileGrid:function(a){function d(){q.getParent().trigger("invalidate");q.dirty=true;q.wakeParent()}
a=T5.ex({emptyTile:b.getEmptyTile(b.Config.TILESIZE),panningTile:b.getPanningTile(b.Config.TILESIZE),tileOffset:new T5.Vector,tileDrawArgs:{}},a);var f=a.emptyTile,m=a.panningTile,l=T5.ViewState.ACTIVE,r=T5.ViewState.PAN,o=T5.Device.getConfig().requireFastDraw,g=a.tileSize?a.tileSize:b.Config.TILESIZE,n=T5.ex({background:null,overlay:null,offset:new T5.Vector,realSize:new T5.Dimensions(g,g)},a.tileDrawArgs),q=T5.ex(new b.TileGrid(a),{drawTile:function(p,t,v,k,u){var s=T5.Resources.getImage(t.url),
w=false;if(s){p.drawImage(s,v,k);t.dirty=false;w=true}else if(u===r)m&&p.drawImage(m,v,k);else f&&p.drawImage(f,v,k);return w},prepTile:function(p,t){if(p)p.dirty=true;if(p&&(!o||t===l))T5.Resources.getImage(p.url)||T5.Resources.loadImage(p.url,d,n)}});return q}};return b}();
...
MWY:"MOTORWAY"},l={},r={Engine:function(o){if(!o.id)throw Error("A GEO.Engine cannot be registered without providing an id.");var g=T5.ex({remove:function(){delete l[g.id]}},o);return l[g.id]=g},Radius:function(o,g){return{distance:parseInt(o,10),uom:g}},Position:function(o,g){return{lat:parseFloat(o?o:0),lon:parseFloat(g?g:0)}},BoundingBox:function(o,g){return{min:r.P.parse(o),max:r.P.parse(g)}},Address:function(o){return o=T5.ex({streetDetails:"",location:"",country:"",postalCode:"",pos:null,boundingBox:null},
...
{toString:function(){return o.caption+(o.matchWeight?" ("+o.matchWeight+")":"")}})},GeoSearchAgent:function(o){return T5.Dispatcher.createAgent(o)},GeocodingAgent:function(o){o=T5.ex({name:"Geocoding Search Agent",paramTranslator:null,execute:function(g,n){try{if(!g.reverse&&!g.freeform)address=new r.Address(g);var q=r.getEngine("geocode");if(q)q.geocode({addresses:[g.freeform?g.freeform:address],complete:function(t,v){if(n){var k=v;if(g.freeform)k=r.rankGeocodeResponses(g.freeform,k,r.getEngine("geocode"));
n(k,o)}}})}catch(p){GRUNT.Log.exception(p)}}},o);return new r.GeoSearchAgent(o)},PointOfInterest:function(o){o=T5.ex({id:0,title:"",pos:null,lat:"",lon:"",group:"",retrieved:0,isNew:true},o);if(!o.pos&&o.lat&&o.lon)o.pos=new T5.Geo.Position(o.lat,o.lon);return T5.ex({toString:function(){return o.id+": '"+o.title+"'"}},o)},POIStorage:function(o){function g(k){k=k?k:"default";p[k]||(p[k]=[]);return p[k]}function n(k){var u=[];for(var s in p)for(var w=0;w<p[s].length;w++)if(!k||k(p[s][w]))u.push(p[s][w]);
return u}function q(){GRUNT.WaterCooler.say("geo.pois-updated",{srcID:v.id,pois:v.getPOIs()})}o=T5.ex({visibilityChange:null,onPOIDeleted:null,onPOIAdded:null},o);var p={},t=true,v={id:GRUNT.generateObjectID(),getPOIs:function(){return n()},getOldPOIs:function(k,u){return n(function(s){return s.group==k&&s.retrieved<u})},getVisible:function(){return t},setVisible:function(k){if(k!=t){t=k;o.visibilityChange&&o.visibilityChange()}},findById:function(k){var u=n(function(s){return s.id==k});return u.length>
0?u[0]:null},findByBounds:function(k){return n(function(u){return T5.Geo.P.inBounds(u.pos,k)})},addPOIs:function(k,u){if(u)p={};for(var s=0;k&&s<k.length;s++){k[s].retrieved=T5.time();var w=k[s];g(w.group).push(w)}},removeGroup:function(k){if(p[k]){delete p[k];q()}},update:function(k){var u=[],s=0,w=k.length>0?k[0].group:"",x=T5.time();for(s=0;s<k.length;s++){var z;a:{if(z=k[s])for(var F=g(z.group),L=0;L<F.length;L++)if(F[L].id==z.id){z=F[L];break a}z=null}if(z){z.retrieved=x;z.isNew=false}else u.push(k[s])}k=
v.getOldPOIs(w,x);v.addPOIs(u);for(s=0;o.onPOIAdded&&s<u.length;s++)o.onPOIAdded(u[s]);for(s=0;s<k.length;s++){o.onPOIDeleted&&o.onPOIDeleted(k[s]);w=k[s];x=g(w.group);for(z=0;z<x.length;z++)if(x[z].id==w.id){x.splice(z,1);break}}u.length+k.length>0&&q()}};return v},MapProvider:function(){var o=1,g=20;return{zoomLevel:0,checkZoomLevel:function(n){return Math.min(Math.max(n,o),g)},getCopyright:function(){},getLogoUrl:function(){},getMapTiles:function(){},getZoomRange:function(){return{min:o,max:g}},
...
n){return g&&n&&Math.floor(g.lat*1E3)===Math.floor(n.lat*1E3)&&Math.floor(g.lon*1E3)===Math.floor(n.lon*1E3)},inArray:function(g,n){for(var q=r.P.equal,p=n.length;p--;)if(q(g,n[p]))return true;return false},inBounds:function(g,n){var q=!(r.P.empty(g)||r.P.empty(n));return q=(q=q&&g.lat>=n.min.lat&&g.lat<=n.max.lat)&&g.lon>=n.min.lon&&g.lon<=n.max.lon},parse:function(g){if(g)if(typeof g.lat!=="undefined")return o.copy(g);else{if(g.split)for(var n=[" ",","],q=0;q<n.length;q++){var p=g.split(n[q]);if(p.length===
2)return new r.Position(p[0],p[1])}}else return new r.Position;return null},parseArray:function(g){var n=g.length,q=Array(n);for(n=n;n--;)q[n]=o.parse(g[n]);GRUNT.Log.info("parsed "+q.length+" positions");return q},fromMercatorPixels:function(g,n,q){return new r.Position(T5.Geo.Utilities.pix2lat(n,q),T5.Geo.Utilities.normalizeLon(T5.Geo.Utilities.pix2lon(g,q)))},toMercatorPixels:function(g,n){return new T5.Vector(T5.Geo.Utilities.lon2pix(g.lon,n),T5.Geo.Utilities.lat2pix(g.lat,n))},generalize:function(g,
n,q){var p=g.length,t=[],v=null;q||(q=250);q/=1E3;GRUNT.Log.info("generalizing positions, must include "+n.length+" positions");for(var k=p;k--;)if(k===0)t.unshift(g[k]);else{var u=!v||r.P.inArray(g[k],n)?q:r.P.calcDistance(v,g[k]);if(g[k]&&u>=q){t.unshift(g[k]);v=g[k]}}GRUNT.Log.info("generalized "+p+" positions into "+t.length+" positions");return t},toString:function(g){return g?g.lat+" "+g.lon:""}};return o}(),B:function(){var o=-(Math.PI/2),g=Math.PI/2,n=-Math.PI*2,q=Math.PI*2,p={calcSize:function(t,
v,k){var u=new T5.Vector(0,v.lat-t.lat);if(typeof k==="undefined")k=true;u.x=k&&t.lon>v.lon?360-t.lon+v.lon:v.lon-t.lon;return u},createBoundsFromCenter:function(t,v){var k=v/6371,u=t.lat*a,s=t.lon*a,w=u-k,x=u+k;if(w>o&&x<g){u=Math.asin(Math.sin(k)/Math.cos(u));k=s-u;if(k<n)k+=2*Math.PI;s=s+u;if(s>q)s-=2*Math.PI}else{w=Math.max(w,o);x=Math.min(x,g);k=n;s=q}return new r.BoundingBox(new r.Position(w*d,k*d),new r.Position(x*d,s*d))},expand:function(t,v){return new r.BoundingBox(new r.Position(t.min.lat-
v,t.min.lon-r.Utilities.normalizeLon(v)),new r.Position(t.max.lat+v,t.max.lon+r.Utilities.normalizeLon(v)))},forPositions:function(t,v){var k=null,u=T5.time();v||(v="auto");for(var s=t.length;s--;)if(k){var w=p.calcSize(k.min,t[s],false),x=p.calcSize(t[s],k.max,false);if(w.x<0)k.min.lon=t[s].lon;if(w.y<0)k.min.lat=t[s].lat;if(x.x<0)k.max.lon=t[s].lon;if(x.y<0)k.max.lat=t[s].lat}else k=new T5.Geo.BoundingBox(t[s],t[s]);if(v){if(v=="auto"){s=p.calcSize(k.min,k.max);v=Math.max(s.x,s.y)*0.3}k=p.expand(k,
v)}GRUNT.Log.trace("calculated bounds for "+t.length+" positions",u);return k},getCenter:function(t){var v=r.B.calcSize(t.min,t.max);return new T5.Geo.Position(t.min.lat+v.y/2,t.min.lon+v.x/2)},getGeoHash:function(t){var v=T5.Geo.GeoHash.encode(t.min.lat,t.min.lon);t=T5.Geo.GeoHash.encode(t.max.lat,t.max.lon);GRUNT.Log.info("min hash = "+v+", max hash = "+t)},getZoomLevel:function(t,v){var k=p.getCenter(t),u=b[Math.min(Math.round(Math.abs(k.lat)*0.05),b.length)],s=p.calcSize(t.min,t.max);k=Math.ceil(Math.log(b[3]*
v.height/s.y)/Math.log(2));u=Math.ceil(Math.log(u*v.width/s.x)/Math.log(2));return Math.min(isNaN(k)?1E3:k,isNaN(u)?1E3:u)},isEmpty:function(t){return!t||r.P.empty(t.min)||r.P.empty(t.max)},toString:function(t){return"min: "+r.P.toString(t.min)+", max: "+r.P.toString(t.max)}};return p}(),A:function(){var o=/^(\d+).*$/,g=/(\d+)\s?\-\s?(\d+)/;return{buildingMatch:function(n,q){o.lastIndex=-1;if(o.test(n))for(var p=n.replace(o,"$1"),t=q.split(","),v=0;v<t.length;v++){g.lastIndex=-1;if(g.test(t[v])){var k=
...
o+" capability");return g},rankGeocodeResponses:function(o,g,n){var q=[],p=r.AddressCompareFns;if(n&&n.compareFns)p=T5.ex({},p,n.compareFns);for(n=0;n<g.length;n++)q.push(new r.GeoSearchResult({caption:r.A.toString(g[n]),data:g[n],pos:g[n].pos,matchWeight:e(o,g[n],p,r.GeocodeFieldWeights)}));q.sort(function(t,v){return v.matchWeight-t.matchWeight});return q}};return r}();
...
a[1])/2;d[2]=(d[0]+d[1])/2;return{latitude:a,longitude:d}},encode:function(e,b,a){var d=1,f=[],m=[],l=0,r=0;a=a?a:12;geohash="";f[0]=-90;f[1]=90;m[0]=-180;for(m[1]=180;geohash.length<a;){if(d){mid=(m[0]+m[1])/2;if(b>mid){r|=BITS[l];m[0]=mid}else m[1]=mid}else{mid=(f[0]+f[1])/2;if(e>mid){r|=BITS[l];f[0]=mid}else f[1]=mid}d=!d;if(l<4)l++;else{geohash+=BASE32[r];r=l=0}}return geohash}}}();
...
T5.Geo.UI=function(){var h=0,e={AnnotationTween:null,GeoTileGrid:function(b){b=T5.ex({grid:null,centerPos:new T5.Geo.Position,centerXY:new T5.Vector,radsPerPixel:0},b);var a=T5.Geo.P.toMercatorPixels(b.centerPos,b.radsPerPixel),d=a.x-b.centerXY.x,f=a.y-b.centerXY.y,m=T5.ex({},b.grid,{getBoundingBox:function(l,r,o,g){return new T5.Geo.BoundingBox(m.pixelsToPos(new T5.Vector(l,r+g)),m.pixelsToPos(new T5.Vector(l+o,r)))},getGridXYForPosition:function(l){l=T5.Geo.P.toMercatorPixels(l,b.radsPerPixel);
...
[],m=0,l=[],r=[],o=T5.ex(new T5.ViewLayer(b),{getAnimation:function(g,n,q,p){if(a)return null;var t="routeAnimation"+h++;r.push(t);return new T5.AnimatedPathLayer({id:t,path:f,zindex:b.zindex+1,easing:g?g:T5.Easing.Sine.InOut,duration:n?n:5E3,drawIndicator:q,autoCenter:p?p:false})},draw:function(g,n,q,p,t){q=0;p=b.data?b.data.geometry:null;if(a){a=false;d=null;f=[];m=0}if(p&&m<p.length){a:{t=t.getTileLayer();l=[];if(t){p=GRUNT.Log.getTraceTicks();var v,k,u,s=b.data?b.data.geometry:[],w=s.length,x=
b.data?b.data.instructions:[],z=x.length,F=b.calculationsPerCycle,L=0;for(v=m;v<w;v++){k=t.getGridXYForPosition(s[v]);if(u=!d||v===0||Math.abs(k.x-d.x)+Math.abs(k.y-d.y)>b.pixelGeneralization){f.push(k);d=k}L++;if(L>=F){m=v;break a}}m=w;GRUNT.Log.trace(w+" geometry points generalized to "+f.length+" coordinates",p);d=null;for(v=z;v--;)if(x[v].position){k=t.getGridXYForPosition(x[v].position);if(u=!d||v===0||Math.abs(k.x-d.x)+Math.abs(k.y-d.y)>b.pixelGeneralization){l.push(k);d=k}}}}q++}t=f.length;
if(t>0&&(!q||b.partialDraw)){g.strokeStyle=b.strokeStyle;g.lineWidth=b.lineWidth;g.beginPath();g.moveTo(f[t-1].x-n.x,f[t-1].y-n.y);for(t=t;t--;)g.lineTo(f[t].x-n.x,f[t].y-n.y);g.stroke();g.fillStyle=b.waypointFillStyle;for(t=l.length;t--;){g.beginPath();g.arc(l[t].x-n.x,l[t].y-n.y,2,0,Math.PI*2,false);g.stroke();g.fill()}}return q}});GRUNT.WaterCooler.listen("grid.updated",function(){for(var g=r.length;g--;)GRUNT.WaterCooler.say("layer.remove",{id:r[g]});r=[];a=true;o.wakeParent()});return o},Annotation:function(b){b=
T5.ex({xy:null,pos:null,draw:null,calcXY:null,tweenIn:e.AnnotationTween,animationSpeed:null},b);var a=false,d={xy:b.xy,pos:b.pos,isNew:true,isAnimating:function(){return a},calcXY:function(f){d.xy=f.getGridXYForPosition(d.pos);b.calcXY&&b.calcXY(f)},draw:function(f,m,l,r,o){if(d.xy){if(d.isNew&&b.tweenIn){var g=d.xy.y;d.xy.y=m.y-20;a=true;T5.Animation.tween(d.xy,"y",g,b.tweenIn,function(){d.xy.y=g;a=false},b.animationSpeed?b.animationSpeed:250+Math.random()*500)}if(b.draw)b.draw(f,m,new T5.Vector(d.xy.x-
m.x,d.xy.y-m.y),l,r,o);else{f.beginPath();f.arc(d.xy.x-m.x,d.xy.y-m.y,4,0,Math.PI*2,false);f.fill()}d.isNew=false}}};return d},ImageAnnotation:function(b){b=T5.ex({imageUrl:null,animatingImageUrl:null,imageAnchor:null},b);var a=b.imageAnchor?T5.V.invert(b.imageAnchor):null;b.draw=function(f,m,l,r,o){if(b.animatingImageUrl&&d.isAnimating()){T5.Resources.loadImage(b.imageUrl);r=b.animatingImageUrl}else r=b.imageUrl;if(m=T5.Resources.getImage(r)){if(m.complete&&m.width>0){a||(a=new T5.Vector(-m.width>>
1,-m.height>>1));l=T5.V.offset(l,a.x,a.y);f.drawImage(m,l.x,l.y,m.width,m.height)}}else T5.Resources.loadImage(r,function(){o.wakeParent()})};var d=new e.Annotation(b);return d},LocationAnnotation:function(b){b=T5.ex({accuracy:null},b);var a=new Image,d=new T5.Vector,f=null;a.src="data:image/png;base64,%3D%3D";
a.onload=function(){d=new T5.Vector(a.width/2,a.height/2)};var m=new e.Annotation(T5.ex({calcXY:function(l){f=Math.floor(l.getPixelDistance(m.accuracy)*0.5)},draw:function(l,r,o,g,n,q){r=o.x-d.x;g=o.y-d.y;if(f&&m.drawAccuracyIndicator){l.fillStyle="rgba(30, 30, 30, 0.2)";l.beginPath();l.arc(o.x,o.y,f,0,Math.PI*2,false);l.fill()}a.complete&&a.width>0&&l.drawImage(a,r,g,a.width,a.height);q.trigger("invalidate")}},b));m.accuracy=b.accuracy;m.drawAccuracyIndicator=false;return m},AnnotationsOverlay:function(b){function a(r){var o=
b.map?b.map.getTileLayer():null,g=r.length;if(o)for(g=g;g--;)r[g].calcXY(o);r.sort(function(n,q){var p=q.xy.y-n.xy.y;if(p===0)p=q.xy.x-n.xy.x;return p})}b=T5.ex({pois:null,map:null,createAnnotationForPOI:null,zindex:100},b);var d=[],f=false,m=[],l=T5.ex(new T5.ViewLayer(b),{cycle:function(){return f?1:0},draw:function(r,o,g,n,q){f=false;r.fillStyle="rgba(255, 0, 0, 0.75)";r.globalCompositeOperation="source-over";for(g=d.length;g--;){d[g].draw(r,o,n,l,q);f=f||d[g].isAnimating()}for(g=m.length;g--;){m[g].draw(r,
o,n,l,q);f=f||m[g].isAnimating()}return f?1:0},add:function(r){m.push(r);a(m);l.wakeParent()},clear:function(r){m=[];a(m);if(r){d=[];a(d)}l.wakeParent()}});GRUNT.WaterCooler.listen("geo.pois-updated",function(r){if(b.pois&&b.pois.id==r.srcID){r=r.pois;try{d=[];for(var o=0;o<r.length;o++)if(r[o].pos){var g;var n=r[o];if(n&&n.pos){var q=null;if(q=b.createAnnotationForPOI?b.createAnnotationForPOI(n):new e.Annotation({pos:n.pos})){q.isNew=n.isNew;n.isNew=false}g=q}else g=void 0;g&&d.push(g)}a(d)}catch(p){GRUNT.Log.exception(p)}l.wakeParent()}});
GRUNT.WaterCooler.listen("grid.updated",function(){a(d);a(m);l.wakeParent()});return l}};return e}();
T5.Map=function(h){function e(u){try{var s=new T5.Geo.Position(u.coords.latitude,u.coords.longitude),w=u.coords.accuracy/1E3;k.trigger("locationUpdate",u,w);if(t){if(!n){n=new T5.Geo.UI.LocationAnnotation({pos:s,accuracy:w});k.bind("tileDrawComplete",function(){n.drawAccuracyIndicator=true})}h.displayLocationAnnotation&&r.add(n);var x=T5.Geo.B.createBoundsFromCenter(s,Math.max(w,1));k.gotoBounds(x)}else{n.pos=s;n.accuracy=w;n.calcXY(k.getTileLayer());k.panToPosition(s,null,T5.Easing.Sine.Out)}t=false}catch(z){GRUNT.Log.exception(z)}}
function b(u){GRUNT.Log.info("caught location tracking error:",u)}h=T5.ex({tapExtent:10,provider:null,crosshair:false,zoomLevel:0,boundsChange:null,tapPOI:null,boundsChangeThreshold:30,pois:new T5.Geo.POIStorage,createAnnotationForPOI:null,displayLocationAnnotation:true,zoomAnimation:T5.Easing.Quad.Out},h);var a={NONE:0,SINGLE:1,WATCH:2},d=new T5.Vector,f=a.NONE,m=false,l=[],r=null,o=null,g=null,n=null,q=0,p=false,t=true,v=h.zoomLevel;if(!h.provider)h.provider=new T5.Geo.MapProvider;h.adjustScaleFactor=
function(u){return Math.pow(2,(u<1?Math.floor:Math.ceil)(Math.log(u)))};var k=T5.ex({},new T5.Tiler(h),{pois:h.pois,annotations:null,getBoundingBox:function(){var u=k.getTileLayer(),s=k.getOffset(),w=k.getDimensions();if(u)return u.getBoundingBox(s.x,s.y,w.width,w.height);return null},getCenterPosition:function(){return k.getXYPosition(T5.D.getCenter(k.getDimensions()))},getXYPosition:function(u){return k.getTileLayer().pixelsToPos(k.viewPixToGridPix(u))},gotoBounds:function(u,s){var w=T5.Geo.B.getZoomLevel(u,
k.getDimensions());k.gotoPosition(T5.Geo.B.getCenter(u),w,s)},gotoPosition:function(u,s,w){function x(M){k.setTileLayer(M);g=M.getId();k.panToPosition(u,function(){k.unfreeze();k.trigger("zoomLevelChange",v);w&&w()});m=true;p=false}var z=v,F=!m,L=k.getBoundingBox();if(L)F=F||!T5.Geo.P.inBounds(u,L);v=s?s:v;if(!v)throw Error("Zoom level required to goto a position.");if(h.provider)v=h.provider.checkZoomLevel(v);if(F||v!==z)if(p)GRUNT.Log.warn("Tile request in progress, aborting");else{T5.Resources.resetImageLoadQueue();
if(n)n.drawAccuracyIndicator=false;(s=k.getTileLayer())&&s.deactivate();T5.Animation.cancel();m&&k.freeze();p=true;h.provider.zoomLevel=v;h.provider.getMapTiles(k,u,x)}else k.panToPosition(u,w)},panToPosition:function(u,s,w){var x=k.getTileLayer();if(x){u=x.getGridXYForPosition(u);x=k.getDimensions();u.x-=x.width/2;u.y-=x.height/2;if(o)o=null;k.updateOffset(u.x,u.y,w);k.trigger("wake");h.boundsChange&&h.boundsChange(k.getBoundingBox());s&&s(k)}},locate:function(){k.trackStart(a.SINGLE);setTimeout(k.trackCancel,
1E4)},trackStart:function(u){if(navigator.geolocation&&!q){f=u?u:a.WATCH;t=true;q=navigator.geolocation.watchPosition(e,b,{enableHighAccuracy:true,timeout:1E4,maximumAge:5E3})}},trackCancel:function(){q&&navigator.geolocation&&navigator.geolocation.clearWatch(q);f===a.WATCH&&r.clear();f=a.NONE;q=0},getZoomLevel:function(){return v},setZoomLevel:function(u){try{k.gotoPosition(k.getCenterPosition(),u)}catch(s){GRUNT.Log.exception(s)}},zoomIn:function(){k.scale(2,T5.Easing.Sine.Out)||k.setZoomLevel(v+
1)},zoomOut:function(){k.scale(0.5,T5.Easing.Sine.Out)||k.setZoomLevel(v-1)},animateRoute:function(u,s,w,x){var z=k.getLayer("route");if(z)(u=z.getAnimation(u,s,w,x))&&u.addToView(k)}});k.bind("pan",function(){f===a.SINGLE&&k.trackCancel()});k.bind("tap",function(u,s){var w=k.getTileLayer(),x=null;if(w){var z=k.viewPixToGridPix(new T5.Vector(s.x,s.y)),F=w.pixelsToPos(z);x=w.pixelsToPos(T5.V.offset(z,-h.tapExtent,h.tapExtent));w=w.pixelsToPos(T5.V.offset(z,h.tapExtent,-h.tapExtent));x=new T5.Geo.BoundingBox(x,
w);l=k.pois.findByBounds(x);k.trigger("geotap",u,s,F,x);h.tapPOI&&h.tapPOI(l)}});k.bind("doubleTap",function(u,s){k.animate(2,T5.D.getCenter(k.getDimensions()),new T5.Vector(s.x,s.y),h.zoomAnimation)});k.bind("scale",function(u,s){var w=0;u=Math.sqrt(u);if(u<1)w=-(0.5/u);else if(u>1)w=u;k.gotoPosition(k.getXYPosition(s),v+Math.floor(w))});r=new T5.Geo.UI.AnnotationsOverlay({pois:k.pois,map:k,createAnnotationForPOI:h.createAnnotationForPOI});k.annotations=r;k.setLayer("annotations",r);h.crosshair&&
