...
GRUNT.JSONP=function(){function t(k){var d=document.createElement("script"),e=false;d.src=k;d.async=true;d.onload=d.onreadystatechange=function(){if(!e&&(!this.readyState||this.readyState==="loaded"||this.readyState==="complete")){e=true;d.onload=d.onreadystatechange=null;d&&d.parentNode&&d.parentNode.removeChild(d)}};m||(m=document.getElementsByTagName("head")[0]);m.appendChild(d)}var q=0,m,a=this;return{get:function(k,d,e){k+=k.indexOf("?")>=0?"&":"?";var h="json"+ ++q;a[h]=function(l){d(l);a[h]=
null;try{delete a[h]}catch(f){}};t(k+(e?e:"callback")+"="+h);return h}}}();
