T5.Clusterer=function(d,m){function w(b,g){function c(){for(var i=0,j=arguments.length;j--;)i+=arguments[j];return i/arguments.length|0}for(var h=[],a=[],f=false,e=b.length;e--;){h[e]=b[e].xy.x;a[e]=b[e].xy.y;f=f||b[e].xy.mercXY}h=T5.XY.init(c.apply(null,h),c.apply(null,a));f&&g&&g.syncXY([h],true);return h}function x(){COG.info("checking for clusters");d.eachLayer(function(b){if(!T5.is(b.itemCount,"undefined")){var g=r(b,true);b.visible=!g}n[b.id]=b.itemCount})}function s(b){d.eachLayer(function(g){b=
