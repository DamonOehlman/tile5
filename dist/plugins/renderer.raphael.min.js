...
i,f=a.xy.y-j,e=a.size;switch(a.markerStyle.toLowerCase()){case "image":m(a.rObject=g.image(a.imageUrl,d-(e>>1),f-(e>>1),e,e),a);break;default:m(a.rObject=g.circle(d,f,e),a)}}return q(a,b,c)},prepPoly:function(a,b,c,d){if(!a.rObject){var f=d.points||a.points;a.path=function(e,A){for(var t="",p=f.length;p--;)t=(p>0?"L":"M")+(f[p].x-e)+" "+(f[p].y-A)+t;return t};a.removeOnReset=true;m(a.rObject=g.path("M0 0L0 0"),a)}return q(a,b,c)}});h.bind("predraw",function(){w(s,o);o={}});h.bind("detach",function(){k.removeChild(g.canvas)});
