...
f.y-(l>>1)),r);t(u-(i-n)/r*u|0)});k.bind("pointerDown",function(a){s(a.target,2)});k.bind("pointerUp",function(a){s(a.target,0)});k.bind("tap",function(a){(a=D[s(a.target,2)])&&a()});o=COG.extend(o,{reset:function(){}});o.bind("detach",function(){k.unbind();h.removeChild(c)});d.bind("zoomLevelChange",function(a,e){t(e)});t(d.getZoomLevel());return o});
