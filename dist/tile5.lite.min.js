...
i,e){Za.trigger("userMessage",b,i,e)},zoomable:function(b,i){function e(g,j){if(g&&a!==g){var p=g>=d&&g<=f&&b.triggerAll("zoomLevelChange",g,j);if(p)a=g;return p}}i=COG.extend({initial:1,minZoom:0,maxZoom:16},i);var a=i.initial,d=i.minZoom,f=i.maxZoom;COG.extend(b,{getZoomLevel:function(){return a},setZoomLevel:e});b.bind("scale",function(g,j,p){var l=Math.log(j)/Math.LN2;COG.endTweens(function(m){return m.cancelOnInteract});g.cancel=!e(a+l,p);g.cancel||b.updateOffset(p.x*j,p.y*j)})},XY:I,XYRect:ga,
