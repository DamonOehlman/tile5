...
T5.ImageMarker=function(i){i=T5.ex({image:null,imageUrl:null,animatingImage:null,animatingImageUrl:null,imageAnchor:null,rotation:0,scale:1,opacity:1},i);var m=i.imageAnchor?T5.XY.invert(i.imageAnchor):null,k=T5.ex(new T5.Marker(i),{drawMarker:function(e,a,c,f){if((a=k.isAnimating()&&k.animatingImage?k.animatingImage:k.image)&&a.width>0){m||(m=T5.XY.init(-a.width>>1,-a.height>>1));var d=k.scale,j=c+~~(m.x*d),b=f+~~(m.y*d),g=~~(a.width*d),h=~~(a.height*d);k.updateBounds(j,b,g,g);if(k.rotation||k.opacity!==
