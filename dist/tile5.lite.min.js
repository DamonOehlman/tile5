...
": "+g[n])}})})();
(function(){function G(B,s){var f=B.hasOwnProperty("obsHandlers")?B.obsHandlers:null;f[s]||(f[s]=[]);return f[s]}var Q=0;COG.observable=function(B){if(!B)return null;if(!(B.hasOwnProperty("obsHandlers")?B.obsHandlers:null))B.obsHandlers={};if(!B.hasOwnProperty("bind")){B.bind=function(s,f){var g="callback"+Q++;G(B,s).unshift({fn:f,id:g});return g};B.triggerCustom=function(s,f){var g=G(B,s),n={cancel:false,name:s,source:this},u;f&&COG.extend(n,f);if(!g)return null;u=Array.prototype.slice.call(arguments,2);
