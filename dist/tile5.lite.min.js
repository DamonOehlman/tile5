...
": "+g[n])}})})();
(function(){function G(B,s){var f=B.obsHandlers;f[s]||(f[s]=[]);return f[s]}var Q=0;COG.observable=function(B){if(!B)return null;if(!B.obsHandlers)B.obsHandlers={};if(!(B.bind||B.trigger||B.unbind)){B.bind=function(s,f){var g="callback"+Q++;G(B,s).unshift({fn:f,id:g});return g};B.triggerCustom=function(s,f){var g=G(B,s),n={cancel:false,name:s,source:this},u;f&&COG.extend(n,f);if(!g)return null;u=Array.prototype.slice.call(arguments,2);B.eventInterceptor&&B.eventInterceptor(s,n,u);u.unshift(n);for(var H=
g.length;H--&&!n.cancel;)g[H].fn.apply(this,u);return n};B.trigger=function(s){var f=Array.prototype.slice.call(arguments,1);f.splice(0,0,s,null);return B.triggerCustom.apply(this,f)};B.unbind=function(s,f){if(typeof s==="undefined")B.obsHandlers={};else for(var g=G(B,s),n=0;g&&n<g.length;n++)if(g[n].id===f){g.splice(n,1);break}return B}}return B}})();
