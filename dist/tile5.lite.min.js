...
T5.PolyLayer=function(f){f=T5.ex({zindex:80,style:null},f);var l=[],h=false,e=T5.ex(new T5.ViewLayer(f),{add:function(a){l.unshift(a)},cycle:function(){return h},draw:function(a,d,c,b){a.save();try{T5.applyStyle(a,f.style);for(var m=l.length;m--;)l[m].draw(a,void 0,void 0,b)}finally{a.restore()}h=false}});e.bind("gridUpdate",function(a,d){for(var c=l.length;c--;)l[c].resync(d);h=true;e.wakeParent(true)});e.bind("parentChange",function(a,d){var c=d?d.getTileLayer():null;if(c)for(var b=l.length;b--;)l[b].resync(c)});
