...
0.2;if(g&&i&&T5.wordExists(g,i))h+=0.8;return h},toString:function(){if(d)return(b?b+" ":"")+d;return""}}},z=function(){return{methodName:"",maxResponses:25,version:"1.0",requestID:q++,getRequestBody:function(){return""},parseResponse:function(a){return a}}},H=function(){return T5.ex(new z,{methodName:"RUOK",parseResponse:function(a){return{aliasCount:a.maxHostAliases,host:a.hostName}}})};T5.Registry.register("generator","decarta",function(a){function d(h,g,i,o){if(h=h.getZoomLevel?h.getZoomLevel():
0){var j=2<<h-1,k=j>>1,l=a.tileSize,m=(g.w/l|0)+1,p=(g.h/l|0)+1,r=(g.x/l|0)-k;g=j-(g.y/l|0)-k-p;var v=i.search({x:(k+r)*l,y:(k+g*-1-p)*l,w:m*l,h:p*l});j={};var w;for(w=v.length;w--;)j[v[w].id]=true;for(v=0;v<=m;v++)for(w=0;w<=p;w++){var y=r+v,A=g+w-1,B=y+"_"+A;if(!j[B]){y=new T5.Tile((k+r+v)*l,(k+g*-1-w)*l,c[v%c.length]+"/openls/image-cache/TILE?LLMIN=0.0,0.0&LLMAX="+b[h]+"&CACHEABLE=true&DS=navteq-world&WIDTH=256&HEIGHT=256&CLIENTNAME="+e.clientName+"&SESSIONID="+e.sessionID+"&FORMAT=PNG&CONFIG="+
e.configuration+"&N="+A+"&E="+y,l,l,B);i.insert(y,y)}}o&&o()}}a=T5.ex({tileSize:256},a);var b=["89.787438015348100000,360.00000000000000000","85.084059050110410000,180.00000000000000000","66.653475896509040000,90.00000000000000000","41.170427238429790000,45.000000000000000000","22.076741328793200000,22.500000000000000000","11.251819676168665000,11.250000000000000000","5.653589942659626000,5.625000000000000000","2.830287664051185000,2.812500000000000000","1.415581451872543800,1.406250000000000000",
"0.707845460801532700,0.703125000000000000","0.353929573271679340,0.351562500000000000","0.176965641673330230,0.175781250000000000","0.088482927761462040,0.087890625000000000","0.044241477246363230,0.043945312500000000","0.022120740293895182,0.021972656250000000","0.011060370355776452,0.010986328125000000","0.005530185203987857,0.005493164062500000","0.002765092605263539,0.002746582031250000","0.001382546303032519,0.001373291015625000","0.000691272945568983,0.000686645507812500","0.000345636472797214,0.000343322753906250"],
c=null;T5.userMessage("ack","decarta","&copy; deCarta, Inc. Map and Imagery Data &copy; NAVTEQ or Tele Atlas or DigitalGlobe");return{run:function(h,g,i,o){c?d(h,g,i,o):s(new H,function(j){c=[];if(j.aliasCount)for(var k=0;k<j.aliasCount;k++)c[k]="http://"+j.host.replace("^(.*?).(.*)$","\u0001-0"+(k+1)+".\u0002");else c=["http://"+j.host];d(h,g,i,o)})}}});T5.Service.register("geocoder",function(){var a=function(b){function c(i){var o=[],j=i?i.numberOfGeocodedAddresses:0,k=[];if(j>1)k=i.GeocodedAddress;
else if(j==1)k=[i.GeocodedAddress];try{for(i=0;k&&i<k.length;i++){var l,m=k[i],p=j=null;if(m&&m.GeocodeMatchCode&&m.GeocodeMatchCode.matchType!=="NO_MATCH"){if(m&&m.Point)p=new T5.Pos(m.Point.pos);if(m&&m.Address)j=f(m.Address,p)}(l=j)&&o.push(l)}}catch(r){_log(r,"error")}return o}b=T5.ex({addresses:[],parserReport:false,parseOnly:false,returnSpatialKeys:false},b);var h=_formatter('<xls:GeocodeRequest parserReport="{0}" parseOnly="{1}" returnSpatialKeys="{2}">'),g=new z;return T5.ex({},g,{methodName:"Geocode",
getRequestBody:function(){for(var i=h(b.parserReport,b.parseOnly,b.returnSpatialKeys),o=0;o<b.addresses.length;o++)i+=b.addresses[o].getXML();return i+"</xls:GeocodeRequest>"},parseResponse:function(i){if(b.addresses.length===1)return[c(i.GeocodeResponseList)];else{for(var o=[],j=0;j<b.addresses.length;j++)o.push(c(i.GeocodeResponseList[j]));return o}}})},d=function(b){b=T5.ex({position:null,geocodePreference:"StreetAddress"},b);return T5.ex(new z,{methodName:"ReverseGeocode",getRequestBody:function(){return"<xls:ReverseGeocodeRequest><xls:Position><gml:Point><gml:pos>"+
