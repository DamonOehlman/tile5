...
'<xls:RouteInstructionsRequest rules="maneuver-rules" providePoint="true" />';if(d.routeGeometry)g+="<xls:RouteGeometryRequest />";g+="</xls:DetermineRouteRequest>";return g},parseResponse:function(g){var i=T5.RouteTools.RouteData,o=T5.Geo.PosFns.parseArray(g.RouteGeometry.LineString.pos),j=g.RouteInstructionsList;g=[];j=j&&j.RouteInstruction?j.RouteInstruction:[];for(var k=0,l=new COG.Duration,m=0;m<j.length;m++){var p;p=j[m].distance;var r={M:1,KM:1E3}[p.uom?p.uom.toUpperCase():"M"];p=p.value&&
