...
(function(){function Q(){var a=arguments[0]||{},c=Array.prototype.slice.call(arguments,1),b=c.length,f,k;for(k=0;k<b;k++)if((f=c[k])!==null)for(var h in f){var e=f[h];if(a!==e)if(e!==undefined)a[h]=e}return a}function Ka(a,c){if(typeof console!=="undefined")console[c||"log"](a)}function Z(a){var c=a.match(ha),b=[],f=0,k;for(k=c?c.length:0;k--;){var h=c[k].slice(1);b[h]||(b[h]=RegExp("\\{"+h+"\\}","g"))}f=b.length;return function(){var e=a;for(k=0;k<f;k++){var l=arguments[k];if(typeof l=="undefined")l=
"";e=e.replace(b[k],l)}return e}}function Ta(a,c){var b=o*Va(a);return fb-2*yb(c*Y((1-b)/(1+b),o/2))}function aa(a,c){if($(a,Wa)){var b=a.split(zb);this.x=parseFloat(b[0]);this.y=parseFloat(b[1])}else if(a&&a.x){this.x=a.x;this.y=a.y}else{this.x=a||0;this.y=c||0}}function va(a){this.allowCull=a;this.points=[]}function na(a,c,b,f){this.mercX=b;this.mercY=f;if($(a,Wa))Q(this,Mb.parseXY(a));else a&&a.toBounds?Q(this,ib(a.lon,a.lat)):aa.call(this,a,c)}function oa(a,c,b,f){this.x=a||0;this.y=c||0;this.w=
b||0;this.h=f||0;this.x2=this.x+this.w;this.y2=this.y+this.h}function Ua(a,c){var b=new Nb(Math.sqrt(256<<a)|0);c&&c.zoomLevel===a&&c.copyInto(b);b.zoomLevel=a;return b}function La(a,c,b,f,k,h){this.x=a;this.y=c;this.w=f||256;this.h=f||256;this.x2=this.x+this.w;this.y2=this.y+this.h;this.url=b;this.id=h||a+"_"+c;this.loaded=false;this.image=null}function Ca(a,c,b,f){f=Q({id:"layer_"+Ob++,zindex:0,animated:false,style:null,minXY:null,maxXY:null,visible:true},f);this.visible=f.visible;this.view=a;sa(Q(this,
f))}function Ha(){sa(this)}var ha=/\{(\d+)(?=\})/g,wa=function(){var a=1.70158,c=Math.PI/2,b=Math.abs,f=Math.pow,k=Math.sin,h=Math.asin,e=Math.cos,l={linear:function(d,i,g,j){return g*d/j+i},backin:function(d,i,g,j){return g*(d/=j)*d*((a+1)*d-a)+i},backout:function(d,i,g,j){return g*((d=d/j-1)*d*((a+1)*d+a)+1)+i},backinout:function(d,i,g,j){return(d/=j/2)<1?g/2*d*d*(((a*=1.525)+1)*d-a)+i:g/2*((d-=2)*d*(((a*=1.525)+1)*d+a)+2)+i},bouncein:function(d,i,g,j){return g-l.bounceout(j-d,0,g,j)+i},bounceout:function(d,
...
n,p){if(d==0)return i;if((d/=j)==1)return i+g;p||(p=j*0.3);if(!n||n<b(g)){n=g;g=p/4}else g=p/la*h(g/n);return-(n*f(2,10*(d-=1))*k((d*j-g)*la/p))+i},elasticout:function(d,i,g,j,n,p){var w;if(d==0)return i;if((d/=j)==1)return i+g;p||(p=j*0.3);if(!n||n<b(g)){n=g;w=p/4}else w=p/la*h(g/n);return n*f(2,-10*d)*k((d*j-w)*la/p)+g+i},elasticinout:function(d,i,g,j,n,p){var w;if(d==0)return i;if((d/=j/2)==2)return i+g;p||(p=j*0.3*1.5);if(!n||n<b(g)){n=g;w=p/4}else w=p/la*h(g/n);if(d<1)return-0.5*n*f(2,10*(d-=
1))*k((d*j-w)*la/p)+i;return n*f(2,-10*(d-=1))*k((d*j-w)*la/p)*0.5+g+i},quadin:function(d,i,g,j){return g*(d/=j)*d+i},quadout:function(d,i,g,j){return-g*(d/=j)*(d-2)+i},quadinout:function(d,i,g,j){if((d/=j/2)<1)return g/2*d*d+i;return-g/2*(--d*(d-2)-1)+i},sinein:function(d,i,g,j){return-g*e(d/j*c)+g+i},sineout:function(d,i,g,j){return g*k(d/j*c)+i},sineinout:function(d,i,g,j){return-g/2*(e(Math.PI*d/j)-1)+i}};return function(d){d=d.replace(/[\-\_\s\.]/g,"").toLowerCase();return l[d]||l.linear}}(),
sa=function(){function a(b,f){var k=b.hasOwnProperty("obsHandlers")?b.obsHandlers:null;k[f]||(k[f]=[]);return k[f]}var c=0;return function(b){if(!b)return null;if(!(b.hasOwnProperty("obsHandlers")?b.obsHandlers:null))b.obsHandlers={};if(!b.hasOwnProperty("bind")){b.bind=function(f,k){var h="callback"+c++;a(b,f).unshift({fn:k,id:h});return h};b.triggerCustom=function(f,k){var h=a(b,f),e={cancel:false,name:f,source:this},l;for(l in k)e[l]=k[l];if(!h)return null;h=h.concat(a(b,"*"));l=Array.prototype.slice.call(arguments,
2);b.eventInterceptor&&b.eventInterceptor(f,e,l);l.unshift(e);for(var d=h.length;d--&&!e.cancel;)h[d].fn.apply(this,l);return e};b.trigger=function(f){var k=Array.prototype.slice.call(arguments,1);k.splice(0,0,f,null);return b.triggerCustom.apply(this,k)};b.unbind=function(f,k){if(typeof f==="undefined")b.obsHandlers={};else for(var h=a(b,f),e=0;h&&e<h.length;e++)if(h[e].id===k){h.splice(e,1);break}return b}}return b}}(),hb=function(){function a(c,b,f,k){if(typeof c[k]=="undefined")c[k]=function(h){if(typeof h!=
"undefined"){b[k]=h;f[k]&&f[k](h);return c}else return b[k]}}return function(c,b,f){b=b||c;for(var k in b)typeof b[k]!="function"&&a(c,b,f,k);return c}}(),Ga=Array.indexOf||function(a){for(var c=0;c<this.length;c++)if(this[c]===a)return c;return-1},$=function(){var a={NaN:1,Infinity:1,"-Infinity":1},c=String.prototype.toLowerCase,b=Object.prototype.toString;return function(f,k){k=c.call(k);if(k=="finite")return!a.hasOwnProperty(+f);return k=="null"&&f===null||k==typeof f||k=="object"&&f===Object(f)||
k=="array"&&Array.isArray&&Array.isArray(f)||b.call(f).slice(8,-1).toLowerCase()==k}}(),$a=function(){function a(h){var e=document.createElement("script"),l=false;e.src=h;e.async=true;e.onload=e.onreadystatechange=function(){if(!l&&(!this.readyState||this.readyState==="loaded"||this.readyState==="complete")){l=true;e.onload=e.onreadystatechange=null;e&&e.parentNode&&e.parentNode.removeChild(e)}};k||(k=document.getElementsByTagName("head")[0]);k.appendChild(e)}function c(h,e,l){h+=h.indexOf("?")>=
...
w){n.removeEventListener(p,w,false)}}function b(n){return function(p,w){n.attachEvent("on"+p,w)}}function f(n,p){return{x:n?n:0,y:p?p:0,count:1}}function k(n,p){g.push(Q({handler:null,checks:{},type:n},p))}function h(n){var p=0,w=0;if(n.offsetParent){do{p+=n.offsetLeft;w+=n.offsetTop;n=n.offsetParent}while(n)}return{left:p,top:w}}function e(n,p){return{source:n,target:p.target?p.target:p.srcElement}}function l(n,p){for(var w=n.target?n.target:n.srcElement;w&&w!==p;)w=w.parentNode;return w&&w===p}
function d(n,p){return{x:n.x-(p?p.left:0),y:n.y-(p?p.top:0)}}function i(n,p){if(n.preventDefault){n.preventDefault();n.stopPropagation()}else if(typeof n.cancelBubble!="undefined")n.cancelBubble=true;p&&n.stopImmediatePropagation&&n.stopImmediatePropagation()}var g=[],j=function(n,p,w){w=Q({binder:null,unbinder:null,observable:null},w);for(var A=w.observable,G=[],O,u,E={bind:function(){return A.bind.apply(null,arguments)},unbind:function(){A.unbind();for(z=0;z<G.length;z++)G[z].unbind();return E}},
z=0;z<p.length;z++)G.push(p[z](n,A,w));A.bind("pointerDown",function(){u=O=0});A.bind("pointerMove",function(m,t,r,q){O+=q.x||0;u+=q.y||0});A.bind("pointerUp",function(m,t,r){Math.max(Math.abs(O),Math.abs(u))<=20&&A.triggerCustom("tap",m,t,r)});return E};k("pointer",{handler:function(n,p,w){function A(I){if(I.pageX&&I.pageY)return f(I.pageX,I.pageY);else{var L=document.documentElement,S=document.body;return f(I.clientX+(L&&L.scrollLeft||S&&S.scrollLeft||0)-(L&&L.clientLeft||S&&S.clientLeft||0),I.clientY+
(L&&L.scrollTop||S&&S.scrollTop||0)-(L&&L.clientTop||S&&S.clientTop||0))}}function G(I){if(l(I,n))if(F=z(I)){var L=A(I);n.style.cursor="move";i(I,true);R=L.x;V=L.y;D=f(R,V);p.triggerCustom("pointerDown",e("mouse",I),D,d(D,h(n)))}}function O(I){var L=A(I);J=L.x;T=L.y;if(l(I,n))t(I,F?"pointerMove":"pointerHover")}function u(I){if(F&&z(I)){F=false;if(l(I,n)){n.style.cursor="default";t(I,"pointerUp")}}}function E(I){if(l(I,n)){var L;I=I||window.event;if(I.detail){if(typeof I.axis=="undefined"||I.axis===
2)L=-I.detail*r}else{L=I.wheelDeltaY?I.wheelDeltaY:I.wheelDelta;if(window.opera)L=-L}if(L){var S=f(J,T);p.triggerCustom("zoom",e("mouse",I),S,d(S,h(n)),L/q,"wheel");i(I);I.returnValue=false}}}function z(I){I=I||window.event;return(I.which||I.button)==1}function m(I){return!l(I,n)}function t(I,L,S,ea,H){S=typeof S!="undefined"?S:J;ea=typeof ea!="undefined"?ea:T;var N=S-R,P=ea-V,ba=f(S,ea);p.triggerCustom(L,e("mouse",I),ba,d(ba,h(n)),f(N,P));if(typeof H=="undefined"||H){R=S;V=ea}}w=Q({},w);var r=120,
q=r*8,F=false,D,J,T,R,V;w.binder("mousedown",G);w.binder("mousemove",O);w.binder("mouseup",u);w.binder("dblclick",function(I){if(l(I,n)){var L=A(I);p.triggerCustom("doubleTap",e("mouse",I),L,d(L,h(n)))}});w.binder("selectstart",m);w.binder("dragstart",m);w.binder("mousewheel",E);w.binder("DOMMouseScroll",E);return{unbind:function(){w.unbinder("mousedown",G);w.unbinder("mousemove",O);w.unbinder("mouseup",u);w.unbinder("mousewheel",E);w.unbinder("DOMMouseScroll",E)}}},checks:{touch:false}});k("pointer",
...
return ba}function u(H){if(l(H,n)){J=h(n);var N=O(H,"changedTouches"),P=G(N,J.left,J.top);if(!R){T=q;p.triggerCustom("pointerDown",e("touch",H),N,P)}S&&p.triggerCustom("pointerDownMulti",e("touch",H),N,P);R=O(H);if(R.count>1)I=A(R);ea=1;L=G(R)}}function E(H){if(l(H,n)){i(H);V=O(H);if(T==q)T=Math.abs(R.x-V.x)>t||Math.abs(R.y-V.y)>t?r:q;if(T!=q){T=V.count>1?D:F;if(T==D)if(R.count===1){R=G(V);I=A(R)}else{var N=A(V);if(Math.abs(I-N)<m)T=F;else{var P;P=V.x;var ba=V.next.x,pa=V.y,ka=V.next.y;P={x:(P<ba?
...
P)}}w=Q({detailed:false,inertia:false},w);var m=20,t=7,r=0,q=1,F=2,D=3,J,T,R,V,I,L,S=w.detailed,ea=1;w.binder("touchstart",u);w.binder("touchmove",E);w.binder("touchend",z);return{unbind:function(){w.unbinder("touchstart",u);w.unbinder("touchmove",E);w.unbinder("touchend",z)}}},checks:{touch:true}});return{register:k,watch:function(n,p,w){p=Q({bindTarget:null,observable:null,isIE:typeof window.attachEvent!="undefined",types:null},p);capabilities=Q({touch:"ontouchstart"in window},w);if(!p.observable){p.observable=
sa({});globalOpts=p}p.binder=(p.isIE?b:a)(p.bindTarget||document);p.unbinder=(p.isIE?b:c)(p.bindTarget||document);w=p.types;for(var A=capabilities,G=[],O=g.length;O--;){var u=g[O],E=!w||w.indexOf(u.type)>=0,z=true,m;for(m in u.checks){var t=u.checks[m];z=z&&t===A[m]}if(E&&z)G[G.length]=u.handler}return new j(n,G,p)}}}();var W=this.T5=sa({}),Ma=function(){var a={};return{create:function(c,b){if(a[c][b])return a[c][b].apply(null,Array.prototype.slice.call(arguments,2));throw gb(c,b);},get:function(c,
...
ya=Ma.register,Xa=Ma.create,Pb=Ma.get,Qb=0,Ob=0,zb=/[\,\s]+/,Pa=function(){function a(e){k++;e=X?window.mozAnimationStartTime||e||(new Date).getTime():(new Date).getTime();for(var l=f.length;l--;){var d=f[l];k%d.every===0&&d.cb(e)}h&&animFrame(a)}var c=1E3/60,b=["r","webkitR","mozR","oR","msR"],f=[],k=0,h=X&&function(){for(var e=0;e<b.length;e++)window.animFrame=window.animFrame||window[b[e]+"equestAnimationFrame"];return animFrame}();h?animFrame(a):setInterval(a,1E3/60);return{attach:function(e,
l){f[f.length]={cb:e,every:l?y(l/c):1}},detach:function(e){for(var l=f.length;l--;)if(f[l].cb===e){f.splice(l,1);break}}}}(),Mb=function(){var a=/^xy\((.*)\).*$/i;return{parseXY:function(c){if(!a.test(c)){c=c.split(zb);return ib(c[1],c[0])}}}}(),X=typeof window!="undefined"?function(){function a(h){if(!k)k=document.createElement("t5test").style;for(var e=0;e<h.length;e++){var l=h[e];if(typeof k[l]!="undefined")return l}}var c={"-webkit-user-select":"none",position:"absolute"},b,f,k;b=a(["-webkit-transform",
"MozTransform"]);css3DTransformProp=a(["WebkitPerspective","MozPerspective"]);f=a(["-webkit-transform-origin","MozTransformOrigin"]);return{transforms:$(b,Wa),create:function(h,e,l){h=document.createElement(h);var d=[];l=l||{};h.className=e||"";for(var i in l)d[d.length]=i+": "+l[i];h.style.cssText=d.join(";");return h},move:function(h,e,l,d,i){if(b){h.style[b]="translate("+e+"px, "+l+"px) "+(d||[]).join(" ");if(i&&f)h.style[f]=i.x+"px "+i.y+"px"}else{h.style.left=e+"px";h.style.top=l+"px"}},rect:function(h){return new oa(h.offsetLeft,
h.offsetTop,h.offsetWidth,h.offsetHeight)},styles:function(h){return Q({},c,h)}}}():null,Ab=function(){function a(){for(var k=f.length,h=k;h--;)try{f[h](k)}catch(e){Ka(e.toString(),"error")}}var c=20,b=50,f=[];return{process:function(k,h,e,l){function d(j){j=(i||b)/j;if(g<k.length){var n=k.slice(g,g+j);j=n.length;var p=i?0:(new Date).getTime();h(n,j);if(!i)i=(n=((new Date).getTime()-p)/j)?c/n|0:k.length;g+=j}else{for(j=f.length;j--;)if(f[j]===d){f.splice(j,1);break}f.length===0&&Pa.detach(a);e&&e()}}
var i,g=0;if(X&&k.length>(l||0))f.push(d)===1&&Pa.attach(a);else{h(k,k.length);e&&e()}}}}(),ib=ib||function(a,c){var b=parseFloat(c)*Na;b=Va(b);var f=o*b;b=rb((1+b)/(1-b)*Y((1-f)/(1+f),o))/2;return new na(0,0,parseFloat(a)*Na,b)},sb=sb||function(a,c){for(var b=Y(Math.E,-c),f=fb-2*yb(b),k=Ta(f,b),h=0;h<12&&x(f-k)>1.0E-7;){f=k;k=Ta(f,b);h++}return new GeoJS.Pos(k*Ba,a%360*Ba)};aa.prototype={constructor:aa,add:function(){for(var a=this.x,c=this.y,b=arguments.length;b--;){a+=arguments[b].x;c+=arguments[b].y}return this.copy(a,
...
"Hit"),{hitType:a.type},f?f:a.elements,a.absXY,a.relXY,new na(a.gridX,a.gridY))}}}();var Nb=function(a){function c(h,e){var l=b[h],d;l||(l=b[h]=[]);(d=l[e])||(d=l[e]=[]);return d}a=a||128;var b=[],f={},k=0;return{all:function(){var h=[],e;for(e in f)h[h.length]=f[e];return h},clear:function(){b=[];f={}},copyInto:function(h){for(var e in f){var l=f[e];h.insert(l.bounds||l,l,e)}},insert:function(h,e,l){var d=h.x/a|0,i=h.y/a|0,g=(h.x+h.w)/a|0;h=(h.y+h.h)/a|0;l=l||e.id||"obj_"+k++;f[l]=e;for(e=d;e<=g;e++)for(d=
i;d<=h;d++)c(e,d).push(l)},remove:function(h,e,l){l=l||e.id;if(f[l]){var d=h.x/a|0;e=h.y/a|0;var i=(h.x+h.w)/a|0;h=(h.y+h.h)/a|0;delete f[l];for(d=d;d<=i;d++)for(var g=e;g<=h;g++){var j=c(d,g),n=Ga.call(j,l);n>=0&&j.splice(n,1)}}},search:function(h){var e=h.y/a|0,l=(h.x+h.w)/a|0,d=(h.y+h.h)/a|0,i=[],g=[];for(h=h.x/a|0;h<=l;h++)for(var j=e;j<=d;j++)i=i.concat(c(h,j));i.sort();for(e=i.length;e--;){l=i[e];if(d=f[l])g[g.length]=d;for(;e>0&&i[e-1]==l;)e--}return g}}},kb=function(){var a={},c=0;(new Date).getTime();
...
e.src=k;f[f.length]=k}}}();La.prototype={constructor:La,load:function(a){var c=this;kb(this.url,function(b){c.loaded=true;c.image=b;a&&a()})}};var Rb=function(){return sa({fastpan:true,applyStyle:function(){},applyTransform:function(a,c,b){return{restore:null,x:c,y:b}},getDimensions:function(){return{width:0,height:0}},getViewport:function(){},hitTest:function(){return false},projectXY:null,reset:function(){}})};ya("renderer","canvas",function(a,c,b,f,k){function h(){function m(q,F){this.save();this.setTransform(1,
0,0,1,0,0);var D=this.isPointInPath_old(q,F);this.restore();return D}var t=CanvasRenderingContext2D.prototype,r=document.createElement("canvas").getContext("2d");r.translate(50,0);r.moveTo(125,50);r.arc(100,50,25,0,360,false);if(!r.isPointInPath(150,50)){t.isPointInPath_old=t.isPointInPath;t.isPointInPath=m}}function e(m,t,r){var q,F;w[t]=function(D){for(q=E.length;q--;)if(F=r[E[q]])D[z[q]]=F}}function l(m,t,r){return{draw:r||u,viewport:m,hit:t&&j.isPointInPath(t.x,t.y),vpX:n,vpY:p,context:j}}function d(m,
t,r,q,F){if(!g.full){if(m.bounds){m=m;q=m.bounds;t=m.xy;r=q.w*m.scaling*1.2|0;q=q.h*m.scaling*1.2|0;m=t.x-n-(r>>1);t=t.y-p-(q>>1)}r=m+r;q=t+q;g.x=m<g.x?m:g.x;g.y=t<g.y?t:g.y;g.x2=r>g.x2?r:g.x2;g.y2=q>g.y2?q:g.y2;g.w=g.x2-g.x;g.h=g.y2-g.y}g.full=g.full||F}f=Q({},f);var i,g=new W.Rect,j,n=0,p=0,w={},A=null,G={},O=function(){},u=function(){this.fill&&j.fill();this.stroke&&j.stroke()},E=["fill","stroke","lineWidth","opacity"],z=["fillStyle","strokeStyle","lineWidth","globalAlpha"];X&&h();if(c){b=c.offsetWidth;
f=c.offsetHeight;i=X?X.create("canvas",null,{position:"absolute","z-index":1}):new Canvas;i.width=b;i.height=f;a.attachFrame(i,true);j=null}k=Q(k,{applyStyle:function(m){var t=w[m],r=j&&j.canvas?j.canvas.id:"default",q;G[r]||(G[r]=[]);q=G[r].pop()||"reset";if(t){G[r].push(m);t(j);return q}},applyTransform:function(m){if(m.translateX!==0||m.translateY!==0||m.scaling!==1||m.rotation!==0){j.save();A={undo:function(){j.restore();A=null},x:m.xy.x,y:m.xy.y};j.translate(m.xy.x-n+m.translateX,m.xy.y-p+m.translateY);
m.rotation!==0&&j.rotate(m.rotation);m.scaling!==1&&j.scale(m.scaling,m.scaling)}return A},drawTiles:function(m,t,r){d(0,0,m.w,m.h,true);for(var q=t.length;q--;){m=t[q];if(!m.loaded&&r)m.load(a.invalidate);else m.image&&j.drawImage(m.image,m.x-n,m.y-p)}},prepArc:function(m,t,r){j.beginPath();d(m);j.arc(m.xy.x-(A?A.x:n),m.xy.y-(A?A.y:p),m.size>>1,m.startAngle,m.endAngle,false);return l(t,r)},prepImage:function(m,t,r,q){var F=(q.x||m.xy.x)-(A?A.x:n),D=(q.y||m.xy.y)-(A?A.y:p),J=q.image||m.image;if(J){j.beginPath();
j.rect(F,D,q.width||J.width,q.height||J.height);return l(t,r,function(){j.drawImage(J,F,D,q.width||J.width,q.height||J.height)})}},prepMarker:function(m,t,r){var q=m.xy.x-(A?A.x:n),F=m.xy.y-(A?A.y:p),D=m.size,J=q-(D>>1),T=F-(D>>1),R=undefined;j.beginPath();d(m);switch(m.markerType.toLowerCase()){case "image":R=O;j.rect(J,T,D,D);if(m.reset&&m.image){m.image=null;m.reset=false}m.image?j.drawImage(m.image,J,T,D,D):kb(m.imageUrl,function(V){m.image=V;j.drawImage(m.image,J,T,D,D)});break;default:j.moveTo(q,
F);j.lineTo(q-(D>>1),F-D);j.lineTo(q+(D>>1),F-D);j.lineTo(q,F)}return l(t,r,R)},prepPoly:function(m,t,r,q){var F=true;q=q.points||m.line().cull(t);var D=A?A.x:n,J=A?A.y:p;j.beginPath();d(m);for(m=q.length;m--;){var T=q[m].x-D,R=q[m].y-J;if(F){j.moveTo(T,R);F=false}else j.lineTo(T,R)}return l(t,r)},getCanvas:function(){return i},getContext:function(){return j}});(function(){Bb.each(function(m,t){e(null,m,t)});W.bind("styleDefined",e)})();k.bind("predraw",function(m,t,r){if(j)j.restore();else if(i)j=
i.getContext("2d");n=r.x;p=r.y;if(j){j.clearRect(g.x,g.y,g.w,g.h);g=new W.Rect;j.save();j.globalCompositeOperation="source-over"}});k.bind("detach",function(){c.removeChild(i)});k.bind("resize",function(){});return k});ya("renderer","dom",function(a,c,b,f,k){function h(g){var j=g.image=new Image;d[g.id]=g;j.onload=function(){if(i[g.id])l.appendChild(this);else g.image=null};j.src=g.url;j.style.cssText="-webkit-user-select: none; -webkit-box-shadow: none; -moz-box-shadow: none; box-shadow: none; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-style: initial; border-color: initial; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; position: absolute;";
return j}function e(g,j,n){var p=[],w;for(w in g){var A=g[w];if(n?A[n]:!j[w]){if(A.image&&A.image.parentNode){A.image.src="";l.removeChild(A.image);A.image=null}p[p.length]=w}}for(j=p.length;j--;)delete g[p[j]]}var l=null,d={},i={};l=X.create("div","t5-tiles",X.styles({width:c.offsetWidth+"px",height:c.offsetHeight+"px"}));c.childNodes.length>0?c.insertBefore(l,c.childNodes[0]):c.appendChild(l);a.attachFrame(l);b=Q(k,{drawTiles:function(g,j,n){for(var p,w=g.x,A=g.y,G=j.length;G--;){g=j[G];if(g.url){(p=
g.image||(n?h(g):null))&&X.move(p,g.x-w,g.y-A);i[g.id]=g}}}});b.bind("predraw",function(){e(d,i);i={}});b.bind("detach",function(){c.removeChild(l)});a.bind("reset",function(){for(e(d,i={});l.childNodes.length>0;)l.removeChild(l.childNodes[0])});return b});var Bb=function(){function a(b,f){if($(b,Wa)){W.trigger("styleDefined",b,c[b]=f);return b}else{var k=[],h;for(h in b)k[k.length]=a(h,b[h]);return k}}var c={};a({reset:{fill:"#ffffff",opacity:1},highlight:{fill:"#ff0000"},waypoints:{lineWidth:4,
stroke:"#003377",fill:"#ffffff"},waypointsHover:{lineWidth:4,stroke:"#ff0000",fill:"#ffffff"}});return{resetStyle:"reset",each:function(b){for(var f in c)b(f,c[f])},get:function(b){return c[b]},define:a}}(),Lb=function(a,c){function b(s,v,C,M){Ja&&Ja(true);s=T?K(ca+Y(2,M)-1,0.125):M>0?2:0.5;r(s,false,true)}function f(s,v){var C=fa&&fa.projectXY?fa.projectXY(s,v):null;if(!C){C=z();C=new U.XY(C?C.x+(s+C.padding.x)/ca:s,C?C.y+(v+C.padding.y)/ca:v)}return C.sync(U,true)}function k(s,v,C){s=f(C.x,C.y);
clearTimeout(tb);U.trigger("doubleTap",v,C,s);if(c.scalable){v=U.center();q(ia+s.x-v.x,ja+s.y-v.y,T?Cb:null);r(2,Cb,true)}}function h(s,v,C){P=null;ka=true;O("down",v,C)}function e(s,v,C){O("hover",v,C)}function l(s,v,C,M){p(v,C,false);if(!P){xa+=M.x;Da+=M.y}}function d(s,v,C){p(v,C,true);ka=false}function i(){clearTimeout(Db);Db=setTimeout(function(){if(N)if(N.offsetWidth!==ab*2||N.offsetHeight!==bb*2){var s=E();A(a);E(s.x,s.y)}},250)}function g(s,v,C){O("tap",v,C);tb=setTimeout(function(){U.trigger("tap",
v,C,f(C.x,C.y,true))},20)}function j(){ta&&ta.unbind();if(X&&fa){ta=INTERACT.watch(fa.interactTarget||N);if(c.scalable){ta.bind("zoom",b);ta.bind("doubleTap",k)}ta.bind("pointerDown",h);ta.bind("pointerMove",l);ta.bind("pointerUp",d);c.captureHover&&ta.bind("pointerHover",e);ta.bind("tap",g)}}function n(s){if(fa){fa.trigger("detach");fa=null}var v=U,C=ea,M=N,da=c;s=s.split("/");for(var qa=new Rb(v,C,M,da),ra=0;ra<s.length;ra++)qa=Xa("renderer",s[ra],v,C,M,da,qa);fa=qa;pa=X&&fa.fastpan&&X.transforms;
T=X&&X.transforms&&c.useTransforms;j();U.trigger("changeRenderer",fa);U.trigger("reset");t()}function p(s,v,C){if(P){s=f(v.x,v.y);P.drag.call(P.target,P,s.x,s.y,C)&&ma++;if(C)P=null}}function w(s){for(var v=S;v--;)if(L[v].id===s)return v;return S}function A(s){if(X)if(N=document.getElementById(s)){s=X.rect(N);H&&N.removeChild(H);N.appendChild(H=X.create("div","t5-panframe",X.styles({overflow:"hidden",width:s.w+"px",height:s.h+"px"})));var v=c.padding;if(v===J){v=N.offsetWidth;var C=N.offsetHeight,
M=ga(v*v+C*C);ua=new aa(M-v>>1,M-C>>1)}else ua=new aa(v,v);lb=H.offsetWidth+ua.x*2;mb=H.offsetHeight+ua.y*2;ub=lb/2;vb=mb/2;ab=s.w/2;bb=s.h/2;cb=new aa(ub,vb);H.appendChild(ea=X.create("div","t5-view",X.styles({width:lb+"px",height:mb+"px","z-index":2,margin:-ua.y+"px 0 0 "+-ua.x+"px"})));n(c.renderer);s=c.controls;for(v=0;v<V.length;v++)V[v].trigger("detach");V=[];for(v=0;v<s.length;v++)V[V.length]=Xa("control",s[v],U,H,N,c[s[v]])}else throw Error("Unable to find map container element with id: "+
s);else n("canvas")}function G(s){var v=[],C,M,da;if(!R){U.panSpeed=panSpeed=x(xa)+x(Da);(C=ca!==wb)&&U.trigger("scale");if(panSpeed>0||C||Ea||Ja||db){ma++;if(Ea&&panSpeed>0){Ea(true);Ea=null}}if(!ka&&panSpeed<=F&&(x(ia-Eb)>=Fb||x(ja-Gb)>=Fb))t();xb.index++;xb.draw=ma||panSpeed||Sb||Tb;if(fa&&xb.draw){if(Ja)ca=Ja()[0];if(db)Aa=db()[0];Qa+=xa;Ra+=Da;if(xa||Da)U.trigger("pan");if(T){if(ca!==1)v[v.length]="scale("+ca+")";if(Aa!==0)v[v.length]="rotate("+Aa+"deg)"}C=ba||!pa||!ka&&!(Ea&&Hb)&&!(Ja&&Hb)&&
(c.drawOnScale||ca===1)&&panSpeed<=D;if(Ea){M=Ea();da=1;if(nb)da=ca/nb;Qa=(ia-M[0]|0)*da;Ra=(ja-M[1]|0)*da}if(C){M=-Aa*Na;C=jb(M)*Qa+-Va(M)*Ra;M=Va(M)*Qa+jb(M)*Ra;ia=ia-C/ca|0;ja=ja-M/ca|0;da=z();fa.trigger("predraw",L,da,s,za);M=Ra=C=Qa=ma=0;for(ii=S;ii--;){var qa=L[ii];if(qa.visible){var ra=qa.style?fa.applyStyle(qa.style,true):null;qa.draw(fa,da,U,s,za[0]);ra&&fa.applyStyle(ra)}}fa.trigger("render",da);U.trigger("drawComplete",da,s);X.move(ea,C,M,v,cb)}else X.move(ea,Qa,Ra,v,cb);if(ka||!c.inertia)Da=
xa=0;else if(xa!=0||Da!=0){xa*=0.8;Da*=0.8;if(x(xa)<0.5)xa=0;if(x(Da)<0.5)Da=0}if(za.length){for(ii=0;ii<za.length;ii++){s=za[ii];v=true;C=s?s.elements:[];M=void 0;if(s&&eb&&s.type==="hover"&&eb.type==="hover"){diffElements=Hits.diffHits(eb.elements,C);if(diffElements.length>0)Hits.triggerEvent(eb,U,"Out",diffElements);else v=false}if(C.length>0){da=s.gridX;qa=s.gridY;for(M=C.length;ka&&M--;){ra=C[M];var Ib=da,Jb=qa,Kb=ra&&ra.drag&&(!ra.canDrag||ra.canDrag(ra,Ib,Jb));if(Kb){P=ra;P.startX=Ib;P.startY=
Jb}if(Kb)break}if(v){Hits.triggerEvent(s,U);s.type==="tap"&&clearTimeout(tb)}}eb=C.length>0?Q({},s):null}za=[]}if(wb!==ca){U.trigger("scaleChanged",ca);wb=ca}}}}function O(s,v,C){var M=(new aa(C.x-ab+ub,C.y-bb+vb)).rotate(-Aa*Na,cb).scale(1/ca,cb);if(za.length===0||!Hits.match(za[za.length-1],s,v)){za[za.length]=s=Hits.init(s,v,C,f(C.x,C.y,true),M);ba=false;for(v=S;v--;)if(L[v].visible)ba=ba||(L[v].hitGuess?L[v].hitGuess(s.gridX,s.gridY,U):false);ba&&ma++}}function u(s){I=I?I+" "+s:s;U.trigger("copyright",
I)}function E(s,v,C){if(typeof s!="undefined"&&($(s,Wa)||$(s,"object"))){v=new U.XY(s);v.sync(U);s=v.x;v=v.y}if($(s,Ia)){q(s-ab-ua.x,v-bb-ua.y,C);return U}else return q().offset(ab+ua.x|0,bb+ua.y|0).sync(U,true)}function z(){var s=new oa(ia,ja,lb,mb);s.scaleFactor=ca;s.padding=ua?ua.copy():new aa;return s}function m(s,v,C){var M=typeof s!="undefined";if(M&&$(v,Oa))for(v=0;v<S;v++){if(L[v].id===s)return L[v]}else if(M){v=Xa("layer",v,U,H,N,C);C=w(s);C!==S&&U.trigger("layerRemove",L[C]);v.added=(new Date).getTime();
v.id=s;L[C]=v;L.sort(function(da,qa){return qa.zindex-da.zindex||qa.added-da.added});S=L.length;U.trigger("resync");t();U.trigger("layerChange",U,v);ma++;return v}else return[].concat(L)}function t(){var s=z();if(s){if(Ya||Za)if(s){var v=ob?ia+(s.w>>1):ia,C=pb?ja+(s.h>>1):ja,M=s.w,da=s.h;if(Ya&&Ya>M)if(v+M>Ya)ia=ob?ia:Ya-M;else if(v<0)ia=ob?ia:0;if(Za&&Za>da)if(C+da>Za)ja=pb?ja:Za-da;else if(C<0)ja=pb?ja:0}Eb=ia;Gb=ja;U.trigger("refresh",U,s);ma++}}function r(s,v,C){if($(s,Ia)){var M=C?s:ca*s;if(!T){v=
undefined;s=y(rb(M)/Math.LN2);M=Y(2,s)}if(v){nb=ca;Ja=Fa.tween([ca],[M],v,function(){ca=M;nb=Ja=null;ma++})}else{ca=M;ma++}return U}else return ca}function q(s,v,C){if($(s,Ia)){if(C)Ea=Fa.tween([ia,ja],[s,v],C,function(){ia=s|0;ja=v|0;Qa=Ra=0;Ea=null;ma++});else{ia=s|0;ja=v|0;ma++}return U}else return(new U.XY(ia,ja)).sync(U,true)}c=Q({captureHover:true,controls:[],copyright:"",drawOnScale:true,padding:128,inertia:true,refreshDistance:128,noDrawOnTween:true,pannable:true,scalable:true,renderer:"canvas",
useTransforms:true},c);var F=0,D=2,J="auto",T=true,R=false,V=[],I="",L=[],S=0,ea=null,H=null,N,P=null,ba=false,pa,ka=false,xa=0,Da=0,Sb=0,Tb=0,Fb=c.refreshDistance,Hb=c.noDrawOnTween,ia=0,ja=0,Qa=0,Ra=0,Eb=0,Gb=0,Ya=null,Za=null,ob=false,pb=false,Ea=null,ua,za=[],eb=null,fa,Db=0,cb=new aa,Aa=0,db=null,ca=1,nb,Ja=null,wb=1,ta=null,xb={index:0,draw:false},Cb={easing:"sine.out",duration:500},ma=0,lb,mb,ub,vb,ab,bb,tb,U={XY:aa,id:c.id,panSpeed:0,addCopy:u,attachFrame:function(s,v){v&&ea.appendChild(s)},
center:E,detach:function(){Pa.detach(G);fa&&fa.trigger("detach");ta&&ta.unbind();if(H){N.removeChild(H);ea=H=null}},frozen:function(s){if($(s,Oa))return R;else{R=s;return U}},getCopy:function(){return I},getRenderer:function(){return fa},layer:m,invalidate:function(){ma++},pan:function(s,v,C){return q(ia+s,ja+v,C)},refresh:t,rotate:function(s,v,C){if($(s,Ia)){var M=C?s:Aa+s;if(v)db=Fa.tween([Aa],[M],v,function(){Aa=M%360;db=null;ma++});else{Aa=M%360;ma++}return U}else return Aa},scale:r,setMaxOffset:function(s,
v,C,M){Ya=s;Za=v;ob=C;pb=M},offset:q,viewport:z};sa(U);U.bind("resize",i);U.bind("layerRemove",function(s,v){var C=Ga(L,v.id);if(C>=0&&C<S){L.splice(C,1);ma++}S=L.length});hb(U,c,{container:A,captureHover:j,scalable:j,pannable:j,renderer:n});m("markers","draw",{zindex:20});A(a);if(X&&!$(window.attachEvent,Oa))window.attachEvent("onresize",i);else X&&window.addEventListener("resize",i,false);c.copyright&&u(c.copyright);Pa.attach(G);return U},Fa=function(){return{tween:function(a,c,b,f,k){function h(w){var A=
w-p;w=p+n<=w;for(var G=e;G--;)l[G]=i(A,a[G],g[G],n);k&&k.invalidate();if(w||j){Pa.detach(h);for(G=0;G<d.length;G++)d[G]&&d[G](l,A,j)}}b=Q({easing:"sine.out",duration:1E3,complete:null},b);var e=a.length,l=[].concat(a),d=[f,b.complete],i=wa(b.easing),g=[],j=false,n=b.duration,p=(new Date).getTime();for(b=e;b--;)g[b]=c[b]-a[b];Pa.attach(h);return function(w){j=w;return l}},tweenDrawable:function(a,c,b,f,k){var h=Fa.tween([b],[f],k,function(){a[c]=f;for(var l=a.tweens.length;l--;)if(a.tweens[l]===e){a.tweens.splice(l,
1);break}},a.view),e=function(){a[c]=h()[0]};return e}}}(),Sa=function(a,c,b){b=Q({style:null,xy:null,size:20,fill:false,stroke:true,draggable:false,properties:{},typeName:"Shape",zindex:0},b);Q(this,b);if($(this.xy,Wa))this.xy=new a.XY(this.xy);this.id="drawable_"+Qb++;this.bounds=null;this.view=a;this.layer=c;this.tweens=[];this.rotation=this.animations=0;this.scaling=1;this.translateY=this.translateX=0;this.visible=true;sa(this)};Sa.prototype={constructor:Sa,applyTweens:function(){for(var a=this.tweens.length;a--;)this.tweens[a]()},
...
c){a&&(!this.bounds||a.x!=this.bounds.x||a.y!=this.bounds.y)&&this.trigger("move",this,a,this.bounds);this.bounds=a;if(c)this.xy=this.bounds.center()}};ya("drawable","marker",function(a,c,b){b=Q({fill:true,stroke:false,markerType:"simple",hoverStyle:"highlight",typeName:"Marker"},b);return new Sa(a,c,b)});ya("drawable","poly",function(a,c,b){function f(){var g,j,n,p,w,A,G,O;d=b.simplify?l.simplify():l;O=d.points;for(g=O.length;g--;){j=O[g].x;n=O[g].y;A=$(A,Oa)||j<A?j:A;G=$(G,Oa)||n<G?n:G;p=$(p,Oa)||
j>p?j:p;w=$(w,Oa)||n>w?n:w}i.updateBounds(new oa(A,G,p-A,w-G),true);i.trigger("pointsUpdate",i,O);a.invalidate()}function k(g){if($(g,"array")){var j;l=new va(b.allowCull);j=l.points;Ab.process(g,function(n,p){for(var w=0;w<p;w++)j.push(new a.XY(n[w]))},h,e);return i}else return d}function h(){l.points.length&&Ab.process(l.points,function(g,j){for(var n=j;n--;)g[n].sync(a)},f,e)}b=Q({allowCull:false,simplify:false,fill:true,points:[],typeName:"Poly"},b);var e=500,l=new va(b.allowCull),d=new va(b.allowCull),
i=Q(new Sa(a,c,b),{line:k,resync:h});k(b.points);return i});ya("drawable","line",function(a,c,b){b.fill=false;b.allowCull=true;return Xa("drawable","poly",a,c,b)});ya("drawable","image",function(a,c,b){function f(){if(d&&d.width>0){if(!this.centerOffset)this.centerOffset=new aa(-d.width>>1,-d.height>>1);this.updateBounds(new oa(this.xy.x+this.centerOffset.x,this.xy.y+this.centerOffset.y,d.width,d.height),false)}}function k(g){if(this.imageUrl=g){var j=this;kb(this.imageUrl,function(n,p){d=n;if(p){var w=
i.layer?i.layer.view:null;w&&w.invalidate()}f.apply(j)})}}b=Q({image:null,imageUrl:null,centerOffset:null,typeName:"Image"},b);var h=Sa.prototype.resync,e=0,l=0,d=b.image,i=Q(new Sa(a,c,b),{changeImage:k,getProps:function(){this.bounds||f(this,d);return{image:d,x:this.xy.x+e,y:this.xy.y+l}},resync:function(g){h.call(this,g);f.call(this)}});d||k.call(this,this.imageUrl);if(this.centerOffset){e=this.centerOffset.x;l=this.centerOffset.y}return i});ya("drawable","arc",function(a,c,b){b=Q({startAngle:0,
endAngle:Math.PI*2,typeName:"Arc"},b);return new Sa(a,c,b)});Ca.prototype={constructor:Ca,clip:null,cycle:function(){},draw:function(){},hitGuess:null,remove:function(){this.view.trigger("layerRemove",this)}};ya("layer","tile",function(a,c,b,f){f=Q({generator:"osm",imageLoadArgs:{}},f);var k=Xa("generator",f.generator,a,f).run,h=null,e=[];c=Q(new Ca(a,c,b,f),{draw:function(l,d,i){l.drawTiles&&l.drawTiles(d,h.search(d.buffer(128)),i.panSpeed<2)}});a.bind("resync",function(){var l=a&&a.zoom?a.zoom():
0;e[l]||(e[l]=Ua(l));h=e[l]});a.bind("refresh",function(){h&&k(h,a.invalidate)});a.bind("reset",function(){h.clear()});return c});ya("layer","draw",function(a,c,b,f){function k(i,g,j,n){var p=this.dragOffset;if(!p)p=this.dragOffset=new a.XY(i.startX-this.xy.x,i.startY-this.xy.y);this.xy.x=g-p.x;this.xy.y=j-p.y;if(n){delete this.dragOffset;a.invalidate();this.xy.sync(a,true);this.trigger("dragDrop")}return true}function h(i,g,j,n){if(e){n&&e.remove(n,g);e.insert(j,g)}}f=Q({zindex:10},f);var e,l,d=
Q(new Ca(a,c,b,f),{clear:function(){if(e){e.clear();d.trigger("cleared");a.invalidate()}},create:function(i,g){var j=Xa("drawable",i,a,d,g);j.resync();e&&j.bounds&&e.insert(j.bounds,j);j.bind("move",h);j.trigger("created");d.trigger(i+"Added",j);return j},draw:function(i,g,j,n,p){j={};n=e&&g?e.search(g):[];for(var w=n.length;w--;){var A=n[w],G=A.style||d.style,O,u,E=A.getProps?A.getProps(i):j;O=i["prep"+A.typeName];A.tweens.length>0&&A.applyTweens();u=i.applyTransform(A);if(E=A.visible&&O?O.call(i,
A,g,p,E):null){if(p&&E.hit){p.elements.push(Hits.initHit(A.type,A,A.draggable?k:null));O=p.type+"Style";G=A[O]||d[O]||G}G=G?i.applyStyle(G,true):null;(O=A.draw||E.draw)&&O.call(A,E);G&&i.applyStyle(G)}u&&u.undo&&u.undo()}},find:function(){return e.all()},hitGuess:function(i,g){return e&&e.search({x:i-5,y:g-5,w:10,h:10}).length>0}});l=a.bind("resync",function(){var i=e?e.all():[];e=Ua(a.zoom(),e);for(var g=i.length;g--;)i[g].resync()});a.bind("layerRemove",function(i,g){if(g===d){e=null;a.unbind("resync",
l)}});return d});Ha.prototype={constructor:Ha};ya("control","zoombar",function(a,c,b,f){function k(r,q){var F=E[r]=X.create("div","t5-zoombar-button",{position:"absolute",background:h(r),"z-index":51,width:f.width+"px",height:f.buttonHeight+"px","margin-top":(q||0)+"px"});z.appendChild(F)}function h(r,q){return"url("+f.images+") 0 -"+(j+p*3+(r||0)*i*3+(q||0)*i)+"px"}function e(r){return"url("+f.images+") 0 -"+(j+(r||0)*p)+"px"}function l(r,q){var F;if(r===n){n.style.background=e(q);F="thumb"}else for(var D=
0;D<E.length;D++)if(r===E[D]){F="button"+D;E[D].style.background=h(D,q);break}return F}function d(r){if(r!==O){O=r;G=A-O/u*(A-w)|0;X.move(n,0,G-w);clearTimeout(m);m=setTimeout(function(){a.zoom(O)},500)}}f=Q({width:24,height:200,images:"img/zoom.png",align:"right",marginTop:10,spacing:10,thumbHeight:16,buttonHeight:16},f);var i=f.buttonHeight,g,j=f.height,n,p=f.thumbHeight,w=f.spacing+i-(p>>1),A=f.height-i-(p>>1),G=w,O=-1;c=a.minZoom();var u=a.maxZoom()-c+1,E=[],z,m=0,t={button0:function(){a.zoom(a.zoom()+
...
width:f.width+"px",height:f.thumbHeight+"px",margin:"10px 0 0 0",top:G-w+"px"}));k(0);k(1,f.height-f.buttonHeight);g=INTERACT.watch(z,{bindTarget:z});g.bind("pointerMove",function(r,q,F){G=Math.min(Math.max(w,F.y-(p>>1)),A);d(u-(G-w)/A*u|0)});g.bind("pointerDown",function(r){l(r.target,2)});g.bind("pointerUp",function(r){l(r.target,0)});g.bind("tap",function(r){(r=t[l(r.target,2)])&&r()});c=new Ha(a);c.bind("detach",function(){g.unbind();b.removeChild(z)});a.bind("zoom",function(r,q){d(q)});d(a.zoom());
return c});ya("control","copyright",function(a,c,b,f){function k(){h(a.getCopy())}function h(l){if(e){e.innerHTML=l;l=e.style;var d;a.viewport();d=X.rect(b);var i=f.spacing,g=d.h-e.offsetHeight-f.spacing,j=Z("{0}px 0 0 {1}px");if(f.align==="right")i=d.w-e.offsetWidth-f.spacing;d=j(g,i);l.margin=d}}f=Q({align:"right",text:null,spacing:5},f);var e;(function(){var l=X.rect(b),d=f.text||a.getCopy();e=X.create("div","t5-copyright",{position:"absolute",overflow:"hidden","max-width":Math.max(l.w>>1,Math.min(400,
l.w-f.spacing*2))+"px","z-index":49});b.childNodes[0]?b.insertBefore(e,b.childNodes[0]):b.appendChild(e);d&&h(d)})();c=Q(new Ha(a),{getText:function(){return e?e.innerHTML:""},setText:h});c.bind("detach",function(){e&&b.removeChild(e)});f.text||a.bind("copyright",k);return c});Q(W,{ex:Q,log:Ka,observable:sa,configurable:hb,formatter:Z,wordExists:function(a,c){for(var b=a.split(/\s|\,/).length;b--;)if(a.toLowerCase()==c.toLowerCase())return true;return false},is:$,indexOf:Ga,fn:function(a){return Pb("fn",
a)},project:ib,unproject:sb,getImage:kb,Registry:Ma,Style:Bb,DOM:X,Rect:oa,XY:aa,GeoXY:na,Line:va,Hits:Hits,Control:Ha,Tile:La,Tweener:Fa,ViewLayer:Ca,View:Lb,Map:function(a,c){function b(g,j){var n=i.viewport();if(g){n=K(g.bestZoomLevel(n.w,n.h)-1,j||0);return f(n).center(g.center())}else return new GeoJS.BBox((new na(n.x,n.y2)).sync(i,true).pos(),(new na(n.x2,n.y)).sync(i,true).pos())}function f(g,j,n){if($(g,Ia)){g=K(c.minZoom,B(c.maxZoom,g|0));if(g!==e){var p=i.viewport(),w=i.offset(),A=p.w/2;
p=p.h/2;var G=Y(2,g-e),O=A/G|0,u=p/G|0;e=g;i.offset(((j||w.x+A)-O)*G,((n||w.y+p)-u)*G);i.trigger("zoom",g);i.trigger("reset");h=i.rpp=la/(256<<e);i.setMaxOffset(la/h|0,la/h|0,true,false);i.scale(1+l,false,true);l=0;i.trigger("resync");i.refresh()}return i}else return e}c=Q({controls:["zoombar","copyright"],minZoom:1,maxZoom:18,renderer:"canvas/dom",zoom:1,zoombar:{}},c);var k=new na,h,e=c.zoom||c.zoomLevel,l=0,d=0,i=Q(new Lb(a,c),{XY:na,bounds:b,zoom:f});h=i.rpp=la/(256<<e);i.bind("refresh",function(){var g=
i.viewport();if(k.x!=g.x||k.y!=g.y){i.trigger("boundsChange",b());k.x=g.x;k.y=g.y}});i.bind("scaleChanged",function(g,j){var n=rb(j)/Math.LN2|0;if(n!==0){l=j-Y(2,n);clearTimeout(d);d=setTimeout(function(){f(e+n)},500)}});return i}});if(typeof module!="undefined"&&module.exports)module.exports=W;W.Decarta=function(){function a(u){return n(e.clientName,e.clientPassword,e.sessionID,e.configuration,e.release,u)}function c(u,E){return p(u.maxResponses,u.version,u.requestID,u.methodName,E)}function b(u,
E){e.server||W.log("No server configured for deCarta - we are going to have issues","warn");return w(e.server,u.requestID,escape(E))}function f(u,E,z){Ka("making request: "+a(c(u,u.getRequestBody())));$a(b(u,a(c(u,u.getRequestBody()))),function(m){console.log(m.response);var t=m.response.XLS.Response;if(t.numberOfResponses>0&&t[u.methodName+"Response"]){m=[];if(u.parseResponse)m=u.parseResponse(t[u.methodName+"Response"]);E&&E.apply(null,m)}else z&&z("Server returned no responses",m.response)})}function k(u,
E){var z=new A({json:u.StreetAddress}),m=[];if(u.Place){if(!u.Place.length)u.Place=[u.Place];for(var t=u.Place.length;t--;)m[m.length]=u.Place[t].content}return{building:z.building,street:z.street,regions:m,countryCode:u.countryCode||"",postalCode:u.PostalCode||"",pos:E}}function h(u){if(!u)return"";u=u.toUpperCase();if(!i){var E=[],z;for(z in g)E.push(z);i=RegExp("(\\s)("+E.join("|")+")(\\s|$)","i")}i.lastIndex=-1;if(E=i.exec(u))u=u.replace(i,"$1"+g[E[2]]);return u}var e={sessionID:(new Date).getTime(),
...
j=1,n=Z("<xls:XLS version='1' xls:lang='en' xmlns:xls='http://www.opengis.net/xls' rel='{4}' xmlns:gml='http://www.opengis.net/gml'><xls:RequestHeader clientName='{0}' clientPassword='{1}' sessionID='{2}' configuration='{3}' />{5}</xls:XLS>"),p=Z("<xls:Request maximumResponses='{0}' version='{1}' requestID='{2}' methodName='{3}Request'>{4}</xls:Request>"),w=Z("{0}/JSON?reqID={1}&chunkNo=1&numChunks=1&data={2}&responseFormat=JSON"),A=function(u){u=W.ex({json:{}},u);var E="",z="";if(u.json.Street)E=
u.json.Street.content?u.json.Street.content:u.json.Street;E=E&&E.replace?E.replace(/\/\d+$/,""):"";if(u.json.Building)if(u.json.Building.number)z=u.json.Building.number;return{building:z,street:E,calcMatchPercentage:function(m){var t=0,r=h(m),q=h(E);if(u.json.Building){a:{var F=u.json.Building.number.toString();l.lastIndex=-1;if(l.test(m)){m=m.replace(l,"$1");F=F.split(",");for(var D=0;D<F.length;D++){d.lastIndex=-1;if(d.test(F[D])){var J=d.exec(F[D]);if(m>=parseInt(J[1],10)&&m<=parseInt(J[2],10)){m=
true;break a}}else if(m==F[D]){m=true;break a}}}m=false}if(m)t+=0.2}if(r&&q&&W.wordExists(r,q))t+=0.8;return t},toString:function(){if(E)return(z?z+" ":"")+E;return""}}},G=function(){return{methodName:"",maxResponses:25,version:"1.0",requestID:j++,getRequestBody:function(){return""},parseResponse:function(u){return[u]}}},O=function(){return W.ex(new G,{methodName:"RUOK",parseResponse:function(u){return[{aliasCount:u.maxHostAliases,host:u.hostName}]}})};W.Registry.register("generator","decarta",function(u,
...
0,T=[];if(J>1)T=D.GeocodedAddress;else if(J==1)T=[D.GeocodedAddress];for(D=0;T&&D<T.length;D++){J=T[D];var R=null,V=null;if(J&&J.GeocodeMatchCode&&J.GeocodeMatchCode.matchType!=="NO_MATCH"){if(J&&J.Point)V=new GeoJS.Pos(J.Point.pos);if(J&&J.Address)R=k(J.Address,V)}(J=R)&&F.push(J)}return[F]}})},m=function(t){t=W.ex({position:null,geocodePreference:"StreetAddress"},t);return W.ex(new G,{methodName:"ReverseGeocode",getRequestBody:function(){return"<xls:ReverseGeocodeRequest><xls:Position><gml:Point><gml:pos>"+
t.position.toString()+"</gml:pos></gml:Point></xls:Position><xls:ReverseGeocodePreference>"+t.geocodePreference+"</xls:ReverseGeocodePreference></xls:ReverseGeocodeRequest>"},parseResponse:function(r){var q=null;if(r&&r.Point)q=new GeoJS.Pos(match.Point.pos);if(r&&r.ReverseGeocodedLocation&&r.ReverseGeocodedLocation.Address)return[k(r.ReverseGeocodedLocation.Address,q)];return[]}})};typeof ADDR==="undefined"&&W.log("Sidelab addressing module not found, geocoder will not function","warn");return{forward:function(t,
